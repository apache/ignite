 ...
 */
public class DenseDoubleVectorStorage implements VectorStorage {
     ...
     */
    public DenseDoubleVectorStorage() {
        // No-op.
    }
     ...
     */
    public DenseDoubleVectorStorage(int size) {
        assert size >= 0;
     ...
     */
    public DenseDoubleVectorStorage(double[] data) {
        assert data != null;
    ...
    @Override public <T extends Serializable> T getRaw(int i) {        
        return (T) Double.valueOf(data[i]);
    }
    ...
    @Override public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        DenseDoubleVectorStorage storage = (DenseDoubleVectorStorage)o;
