...
public enum MLSandboxDatasets {
    ...
    MOVIELENS("datasets/ratings.csv", true, ","),
    ...
    WHOLESALE_CUSTOMERS("datasets/wholesale_customers.csv", true, ","),

    /**
     * Fraud detection problem [part of whole dataset]. Could be found <a href="https://www.kaggle.com/mlg-ulb/creditcardfraud/">here</a>.
     */
    FRAUD_DETECTION("datasets/fraud_detection.csv", false, ","),

    /** A dataset with discrete and continuous features. */
    MIXED_DATASET("datasets/mixed_dataset.csv", true, ","),

    /** A dataset with categorical features and labels. */
    MUSHROOMS("datasets/mushrooms.csv", true, ","),

    /** A dataset with categorical features and labels. */
    AMAZON_EMPLOYEE_ACCESS("datasets/amazon-employee-access-challenge_train.csv", true, ",");
