...
import org.hawkore.ignite.lucene.schema.mapping.FloatMapper;
...
public class FloatMapperBuilder extends SingleColumnMapperBuilder<FloatMapper, FloatMapperBuilder> {
    ...
    public FloatMapper build(String field) {
        return new FloatMapper(field, column, validated, boost);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        FloatMapperBuilder other = (FloatMapperBuilder) obj;
        if (boost == null) {
            if (other.boost != null)
                return false;
