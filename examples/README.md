...
To set up local IDE to easier access to examples, it is possible to add the following options as default for all applications
...
*Notice* When updating classpath of examples and in case of any modifications required in [pom.xml](pom.xml)
