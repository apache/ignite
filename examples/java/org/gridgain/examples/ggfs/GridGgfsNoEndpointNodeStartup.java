...
/**
 * Starts up an empty node with GGFS configuration and no Hadoop endpoint.
...
public class GridGgfsNoEndpointNodeStartup {
    /**
    ...
    public static void main(String[] args) throws GridException {
        try (Grid g = GridGain.start("examples/config/example-ggfs-no-endpoint.xml")) {
