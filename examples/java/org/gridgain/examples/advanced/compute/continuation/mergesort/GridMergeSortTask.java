...
package org.gridgain.examples.advanced.compute.continuation.mergesort;
 ...
 */
public class GridMergeSortTask extends GridComputeTaskSplitAdapter<int[], int[]> {
     ...
     * ({@link org.gridgain.grid.compute.GridComputeJobContext} methods {@code holdcc()} and {@code callcc()})
    ...
    @Override protected Collection<GridComputeJob> split(int gridSize, int[] initArr) {
        Collection<GridComputeJob> jobs = new ArrayList<>(2);
    ...
    private Iterable<int[]> splitArray(int[] arr) {
        ...
        System.out.println("Split array [len1=" + a1.length + ", len2=" + a2.length + ']');
    ...
    private int[] mergeArrays(int[] arr1, int[] arr2) {
        ...
        System.out.println("Merged arrays [resLen=" + ret.length + ", len1=" + arr1.length + ", len2=" + arr2.length + ']');
