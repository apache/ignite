...
package org.gridgain.examples.advanced.datagrid.store.hibernate;
...
public class GridCacheHibernatePersonStore extends GridCacheStoreAdapter<UUID, Person> {
    ...
    private static final String DFLT_HIBERNATE_CFG = "/org/gridgain/examples/advanced/datagrid/store/hibernate/hibernate.cfg.xml";
    ...
    /** {@inheritDoc} */
    @Override public Person load(@Nullable GridCacheTx tx, UUID key) throws GridException {
    ...
    /** {@inheritDoc} */
    @Override public void put(@Nullable GridCacheTx tx, UUID key, @Nullable Person val)
