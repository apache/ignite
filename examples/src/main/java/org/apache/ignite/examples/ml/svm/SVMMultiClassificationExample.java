...
/**
 * <p>
 * Example of using {@link org.apache.ignite.ml.svm.SVMLinearMultiClassClassificationModel} with Iris dataset.</p>
 * <p>
...
public class SVMMultiClassificationExample {
    ...
    private static final String IRIS_DATASET = "examples/src/main/resources/datasets/iris.txt";
        ...
        try (Ignite ignite = Ignition.start("examples/config/example-ignite.xml")) {
            ...
            IgniteThread igniteThread = new IgniteThread(ignite.configuration().getIgniteInstanceName(),
                ...
                try {
                    ...
                    if (file == null)
                        throw new RuntimeException("Can't find file: " + IRIS_DATASET);
                    ...
                    SVMLinearMultiClassClassificationModel mdl = trainer.train(train);
                    ...
                    System.out.println("\n>>> SVM Multi-Class classification example completed.");
                }
            });
