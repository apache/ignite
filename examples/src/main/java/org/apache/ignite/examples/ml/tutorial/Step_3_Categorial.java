        ...
        try (Ignite ignite = Ignition.start("examples/config/example-ignite.xml")) {
            IgniteThread igniteThread = new IgniteThread(ignite.configuration().getIgniteInstanceName(),
                ...
                try {
                    ...
                    StringEncoderPreprocessor<Integer, Object[]> stringEncoder =  new StringEncoderTrainer<Integer, Object[]>().fit(
                        ignite,
                        dataCache,
                        (k, v) -> new Object[]{(double)v[0], (String)v[3], (double)v[5], (double)v[6], (String)v[10]}
                    );

                    IgniteBiFunction<Integer, Object[], double[]> imputingPreprocessor = new ImputerTrainer<Integer, Object[]>()
                        .fit(ignite,
                            dataCache,
                            (k, v) -> new double[]{(double)v[0], (double)v[5], (double)v[6]} // "pclass", "sibsp", "parch", "sex", "embarked"
                        );
