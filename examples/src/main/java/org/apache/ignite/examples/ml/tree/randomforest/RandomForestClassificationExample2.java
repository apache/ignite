...
import org.apache.ignite.ml.tree.randomforest.RandomForestClassifier;
import org.apache.ignite.thread.IgniteThread;

/**
 * Example represents a solution for the task of wine classification based on RandomForest implementation for
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try (Ignite ignite = Ignition.start("examples/config/example-ignite.xml")) {
            ...
            IgniteThread igniteThread = new IgniteThread(ignite.configuration().getIgniteInstanceName(),
                ...
                RandomForestClassifier classifier = new RandomForestClassifier(IntStream.range(0, 13)
                    .mapToObj(x -> new FeatureMeta(indx.getAndIncrement(), false))
