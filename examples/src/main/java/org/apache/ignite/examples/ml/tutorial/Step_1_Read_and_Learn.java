...
public class Step_1_Read_and_Learn {
        ...
        try (Ignite ignite = Ignition.start("examples/config/example-ignite.xml")) {
            IgniteThread igniteThread = new IgniteThread(ignite.configuration().getIgniteInstanceName(),
                ...
                try {
                    ...
                    final IgniteBiFunction<Integer, Object[], double[]> featureExtractor = (k, v) -> new double[]{(double) v[0], (double) v[5], (double) v[6]};
                    final IgniteBiFunction<Integer, Object[], Double> lbExtractor = (k, v) -> (double) v[1];
                    ...
                    double accuracy = Evaluator.evaluate(dataCache, mdl, featureExtractor, lbExtractor, new Accuracy<Double>());
    ...
    private static class Evaluator {
        public static double evaluate(IgniteCache<Integer, Object[]> dataCache, Model<Vector, Double> mdl, IgniteBiFunction<Integer, Object[], double[]> featureExtractor, IgniteBiFunction<Integer, Object[], Double> labelExtractor, Accuracy<Double> doubleAccuracy) {
