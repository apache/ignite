 ...
 * <p>
 * Alternatively you can run {@link org.apache.ignite.examples8.igfs.IgfsNodeStartup} in another JVM which will start
...
public final class IgfsExample {
     ...
     * @throws org.apache.ignite.IgniteException In case of error.
     */
     ...
     * @param data Data.
     * @throws org.apache.ignite.IgniteException If file can't be created.
     * @throws java.io.IOException If data can't be written.
     */
     ...
     * @param fs IgniteFs.
     * @param path File path.
     * @throws org.apache.ignite.IgniteException If file can't be opened.
