...
package org.apache.ignite.examples8.events;
 ...
 * <p>
 * Alternatively you can run {@link org.apache.ignite.examples8.ComputeNodeStartup} in another JVM which will start
...
public class EventsExample {
    ...
    private static void localListen() throws IgniteException {
        ...
        ignite.compute().withName("example-event-task").run(() -> {
