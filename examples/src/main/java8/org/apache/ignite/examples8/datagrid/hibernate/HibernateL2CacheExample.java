 ...
 * <p>
 * This example defines 2 entity classes: {@link org.apache.ignite.examples8.datagrid.hibernate.User} and {@link org.apache.ignite.examples.datagrid.hibernate.Post}, with
 ...
 * data from L2 cache.
 * <p>
 * Note: this example uses {@link org.hibernate.cache.spi.access.AccessType#READ_ONLY} L2 cache access type, but you
...
public class HibernateL2CacheExample {
    ...
    /**
     * Creates a new Hibernate {@link org.hibernate.SessionFactory} using a programmatic
     * configuration.
     *
     * @param hibernateCfg Hibernate configuration file.
     * @return New Hibernate {@link org.hibernate.SessionFactory}.
     */
     ...
     *
     * @param sesFactory Hibernate {@link org.hibernate.SessionFactory}, for which to print
     *                   statistics.
     */
