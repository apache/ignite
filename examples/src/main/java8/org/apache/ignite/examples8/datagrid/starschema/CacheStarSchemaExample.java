...
package org.apache.ignite.examples8.datagrid.starschema;
 ...
 * <p>
 * In this example we have two <i>dimensions</i>, {@link DimProduct} and {@link org.apache.ignite.examples8.datagrid.starschema.DimStore} and
 * one <i>fact</i> - {@link org.apache.ignite.examples8.datagrid.starschema.FactPurchase}. Queries are executed by joining dimensions and facts
 * in various ways.
 * <p>
...
public class CacheStarSchemaExample {
     ...
     * {@link org.apache.ignite.examples8.datagrid.starschema.DimStore} and {@link DimProduct} instances.
     *
    ...
    /**
     * Populate cache with {@code 'facts'}, which in our case are {@link org.apache.ignite.examples8.datagrid.starschema.FactPurchase} objects.
     *
     * @throws org.apache.ignite.IgniteException If failed.
     */
     ...
     * between {@link org.apache.ignite.examples8.datagrid.starschema.DimStore} objects stored in {@code 'replicated'} cache and
     * {@link org.apache.ignite.examples8.datagrid.starschema.FactPurchase} objects stored in {@code 'partitioned'} cache.
     */
     ...
     * This query uses cross-cache joins between {@link org.apache.ignite.examples8.datagrid.starschema.DimStore}, {@link DimProduct}
     * objects stored in {@code 'replicated'} cache and {@link org.apache.ignite.examples8.datagrid.starschema.FactPurchase} objects
