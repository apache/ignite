...
public class HibernateL2CacheExampleNodeStartup {
    ...
    public static IgniteConfiguration configuration() throws IgniteException {
        ...
        cfg.setCacheConfiguration(
            ...
            cacheConfiguration("org.apache.ignite.examples8.datagrid.hibernate.User", TRANSACTIONAL),
            cacheConfiguration("org.apache.ignite.examples8.datagrid.hibernate.User.posts", TRANSACTIONAL),
            cacheConfiguration("org.apache.ignite.examples8.datagrid.hibernate.Post", TRANSACTIONAL)
        );
