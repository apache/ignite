...
public class ComputeBroadcastExample {
     ...
     */
    private static void hello(GridProjection g) throws GridException {
        // Print out hello message on all nodes.
        g.compute().broadcast((GridRunnable)() -> {
            System.out.println();
     ...
     * @throws GridException if failed.
     */
    private static void gatherSystemInfo(GridProjection g) throws GridException {
        // Gather system info from all nodes.
