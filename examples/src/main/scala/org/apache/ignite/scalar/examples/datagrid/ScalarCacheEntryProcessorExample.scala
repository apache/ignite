...
object ScalarCacheEntryProcessorExample extends App {
    ...
    /**
     * Runs jobs on primary nodes with [[IgniteCache#invoke(Object, CacheEntryProcessor, Object...)]] to create
    ...
    /**
     * Runs jobs on primary nodes with [[IgniteCache#invoke(Object, CacheEntryProcessor, Object...)]] to increment
     * entries values.
     *
     * @param cache Cache to populate.
     */
