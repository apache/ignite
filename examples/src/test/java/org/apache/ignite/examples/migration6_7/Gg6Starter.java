...
public class Gg6Starter {
    ...
    public static void main(String[] args) throws Exception {
        try(Grid ignore = GridGain.start(configuration())) {
...
//        discoSpi.setLocalAddress("127.0.0.1");
        ...
        GridCacheConfiguration ccPerson = new GridCacheConfiguration();
        ccPerson.setName("personCache");

        c.setCacheConfiguration(cc, ccPerson);
