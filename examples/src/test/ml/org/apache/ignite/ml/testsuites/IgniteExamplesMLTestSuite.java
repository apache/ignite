...
import org.apache.ignite.ml.examples.DistributedLinearRegressionExampleWithQRTrainerSelfTest;
import org.apache.ignite.ml.examples.DistributedLinearRegressionExampleWithSGDTrainerTest;
...
public class IgniteExamplesMLTestSuite extends TestSuite {
    ...
    public static TestSuite suite() {
        ...
        suite.addTest(new TestSuite(DistributedLinearRegressionExampleWithQRTrainerSelfTest.class));
        suite.addTest(new TestSuite(DistributedLinearRegressionExampleWithSGDTrainerTest.class));
