...
import org.apache.ignite.scalar.examples.binary.computegrid.ScalarComputeClientBinaryTaskExecutionExample
import org.apache.ignite.scalar.examples.binary.datagrid.auto.ScalarCacheBinaryAutoStoreExample
import org.apache.ignite.scalar.examples.binary.datagrid.{ScalarCacheClientBinaryPutGetExample, ScalarCacheClientBinaryQueryExample}
...
import org.apache.ignite.scalar.examples.datagrid.store.auto.ScalarCacheAutoStoreExample
import org.apache.ignite.scalar.examples.datagrid.store.spring.ScalarCacheSpringStoreExample
...
class ScalarExamplesSelfTest extends GridAbstractExamplesTest with JUnitSuiteLike {
    ...
    /** */
    def testScalarComputeClientBinaryTaskExecutionExample() {
        runWithNode(CONFIG, () => ScalarComputeClientBinaryTaskExecutionExample.main(EMPTY_ARGS))
    }

    /** */
    def testScalarCacheClientBinaryQueryExample() {
        runWithNode(CONFIG, () => ScalarCacheClientBinaryQueryExample.main(EMPTY_ARGS))
    }

    /** */
    def testScalarCacheClientBinaryPutGetExample() {
        runWithNode(CONFIG, () => ScalarCacheClientBinaryPutGetExample.main(EMPTY_ARGS))
    }
    ...
    /** */
    def testScalarIgniteExecutorServiceExample() {
        ScalarIgniteExecutorServiceExample.main(EMPTY_ARGS)
    }

    /** */
    def testScalarIgniteAtomicLongExample() {
        ScalarIgniteAtomicLongExample.main(EMPTY_ARGS)
    }

    /** */
    def testScalarIgniteAtomicReferenceExample() {
        ScalarIgniteAtomicReferenceExample.main(EMPTY_ARGS)
    }
    ...
    /** */
    def testScalarIgniteSemaphoreExample() {
        ScalarIgniteSemaphoreExampleStartup.main(EMPTY_ARGS)
    }
    ...
    def testScalarServicesExample() {
        runWithNode(CONFIG, () => ScalarServicesExample.main(EMPTY_ARGS))
    }
