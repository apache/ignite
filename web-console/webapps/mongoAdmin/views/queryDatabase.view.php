...
<head>
    ...
    <script src="./source/js/queryDatabase.js"></script>
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <h2 class="float-left">Command</h2>

                        <h2 class="float-right">Pipeline</h2>

                        <textarea id="mpg-filter-or-doc-textarea" rows="8" >[{"$match":{}}]</textarea>

                        <button id="mpg-run-command-button" class="btn btn-primary float-left">
                            Run Command
                        </button>
                        ...
                        <button id="mpg-stats-button" class="btn btn-info float-right">
                            Database Stats
                        </button>
                ...
                <div class="row">
                	<div class="col-md-12 stats" id="dbStats" >           	  
						<?php echo $dbStats; ?>					  
