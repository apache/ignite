...
export default class ConfigEffects {
     ...
     */
    constructor(ConfigureState, Caches, Models, ConfigSelectors, Clusters, $state, IgniteMessages, IgniteConfirm, Confirm) {
        ...
        this.basicSaveRedirectEffect$ = this.ConfigureState.actions$.pipe(
            ...
            tap((a) => this.$state.go('base.console.edit.basic', {clusterID: a.changedItems.cluster.id}, {location: 'replace', custom: {justIDUpdate: true}})),
            ignoreElements()
        );
        ...
        this.advancedSaveRedirectEffect$ = this.ConfigureState.actions$.pipe(
            ...
            tap(([type, value, cluster]) => {
                ...
                switch (type) {
                    case 'models': {
                        const state = 'base.console.edit.advanced.models.model';
                    ...
                    case 'caches': {
                        const state = 'base.console.edit.advanced.caches.cache';
                    ...
                    case 'cluster': {
                        const state = 'base.console.edit.advanced.cluster';
