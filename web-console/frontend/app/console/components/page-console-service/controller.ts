...
export default class ServiceController {
    ...
    $onInit() {
        ...
        this.subscription = merge(
            ...
            this.selectionManager.editLeaves$.pipe(tap((options) => this.$state.go('base.console.edit.service.cache', null, options)))
        ).subscribe();
    ...
    edit(cacheID: string) {
        this.$state.go('base.console.edit.service.cache', {cacheID});
    }
