...
public class CLIArgumentParser {
    ...
    public void parse(ListIterator<String> argsIter) {
        ...
        while (argsIter.hasNext()) {
            ...
            String argVal = getArgumentValue(cliArg, argsIter);
    ...
    /** */
    private String getArgumentValue(CLIArgument<?> arg, ListIterator<String> argsIter) {
        if (arg.isFlag())
            return "true";
        ...
        if (argVal == null) {
            if (console != null && arg.isInteractive())
