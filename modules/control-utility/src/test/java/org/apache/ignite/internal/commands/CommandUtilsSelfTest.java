...
public class CommandUtilsSelfTest {
    ...
    public void testToCommand() {
        assertEquals("my-command", commandName("myCommand"));
        assertEquals("node-ids", commandName("nodeIDs"));
        assertEquals("node-id", commandName("nodeID"));
        assertEquals("system-view", commandName("SystemView"));
    }
}
