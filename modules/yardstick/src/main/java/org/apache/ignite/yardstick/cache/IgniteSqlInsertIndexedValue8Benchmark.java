...
public class IgniteSqlInsertIndexedValue8Benchmark extends IgniteCacheAbstractBenchmark<Integer, Object> {
    ...
    @Override public boolean test(Map<Object, Object> ctx) throws Exception {
        ...
        int res = (Integer) cache.query(new SqlFieldsQuery("insert into Person8(_key, _val) values (?, ?)")
            .setArgs(key, new Person8(key)).setSkipDuplicateKeys(true)).getAll().get(0).get(0);
