...
public class IgniteSqlInsertIndexedValue2Benchmark extends IgniteCacheAbstractBenchmark<Integer, Object> {
    ...
    @Override public boolean test(Map<Object, Object> ctx) throws Exception {
        ...
        int res = (Integer) cache.query(new SqlFieldsQuery("insert into Person2(_key, _val) values (?, ?)")
            .setArgs(key, new Person2(key)).setSkipDuplicateKeys(true)).getAll().get(0).get(0);
