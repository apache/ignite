...
public class TeraSort extends Configured implements Tool {
  ...
  public static String SIMPLE_PARTITIONER = "mapreduce.terasort.simplepartitioner";
  public static String OUTPUT_REPLICATION = "mapreduce.terasort.output.replication";
  ...
  public static class TotalOrderPartitioner extends Partitioner<Text,Text>
    ...
    public void setConf(Configuration conf) {
      try {
        ...
        Path partFile = new Path(HadoopTeraSortTest.SORT_OUT_DIR + "/" + TeraInputFormat.PARTITION_FILENAME);
