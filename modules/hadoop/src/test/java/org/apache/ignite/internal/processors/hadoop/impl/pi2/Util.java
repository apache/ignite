 ...
 */
package org.apache.ignite.internal.processors.hadoop.impl.pi2;
...
public class Util {
  ...
  /** Run a job. */
  static void runJob(String name, Job job, DistSum.Machine machine, String startmessage, Util.Timer timer) {
