...
import org.apache.ignite.internal.processors.hadoop.impl.pi2.math.Bellard;
import org.apache.ignite.internal.processors.hadoop.impl.pi2.math.Bellard.Parameter;
...
//      LOG.info("line = " + line);
  ...
  private Map<Bellard.Parameter, List<TaskResult>> parse(String f) throws IOException {
    final Map<Bellard.Parameter, List<TaskResult>> m = new TreeMap<Bellard.Parameter, List<TaskResult>>();
  ...
  Map<Bellard.Parameter, List<TaskResult>> parse(String inputpath, String outputdir
      ) throws IOException {
    //parse input
    Util.out.print("\nParsing " + inputpath + " ... ");
    Util.out.flush();
    final Map<Bellard.Parameter, List<TaskResult>> parsed = parse(inputpath);
