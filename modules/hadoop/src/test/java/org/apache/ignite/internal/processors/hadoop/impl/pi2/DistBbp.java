...
import org.apache.ignite.internal.processors.hadoop.impl.pi2.DistSum.Parameters;
import org.apache.ignite.internal.processors.hadoop.impl.pi2.DistSum.Computation;
 ...
 */
public class DistBbp extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    final Map<Bellard.Parameter, List<TaskResult>> existings = new Parser(isVerbose).parse(parameters.localDir.getPath(), null);
     ...
     */
    protected void verify(String res) {
    }
