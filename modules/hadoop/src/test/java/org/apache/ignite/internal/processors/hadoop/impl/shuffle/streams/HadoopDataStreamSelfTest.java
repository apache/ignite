...
public class HadoopDataStreamSelfTest extends GridCommonAbstractTest {
    ...
    public void testStreams() throws IOException {
        ...
        MemoryManager memoryMgr = new OffheapMemoryManager(mem, 32 * 1024);

        try {

            HadoopDataOutStream out = new HadoopDataOutStream(memoryMgr);
            ...
            HadoopDataInStream in = new HadoopDataInStream(memoryMgr);
