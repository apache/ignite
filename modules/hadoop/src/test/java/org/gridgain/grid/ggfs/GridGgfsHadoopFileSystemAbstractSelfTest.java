...
public abstract class GridGgfsHadoopFileSystemAbstractSelfTest extends GridCommonAbstractTest {
    ...
    private void startNodes() throws Exception {
        if (mode != PRIMARY) {
            ...
            ggfsCfg.setIpcEndpointConfiguration(GridTestUtils.jsonToMap(SECONDARY_ENDPOINT_CFG));
    ...
    protected GridGgfsConfiguration ggfsConfiguration(String gridName) throws GridException {
        ...
        cfg.setIpcEndpointConfiguration(GridTestUtils.jsonToMap(primaryIpcEndpointConfiguration(gridName)));
