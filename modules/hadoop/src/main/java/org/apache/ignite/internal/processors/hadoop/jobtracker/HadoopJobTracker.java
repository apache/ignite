...
public class HadoopJobTracker extends HadoopComponent {
    ...
    /** */
    private volatile InternalCache<HadoopJobId, HadoopJobMetadata> jobMetaPrj;

    /** Projection with expiry policy for finished job updates. */
    private volatile InternalCache<HadoopJobId, HadoopJobMetadata> finishedJobMetaPrj;
    ...
    private InternalCache<HadoopJobId, HadoopJobMetadata> jobMetaCache() {
        InternalCache<HadoopJobId, HadoopJobMetadata> prj = jobMetaPrj;
     ...
     */
    private InternalCache<HadoopJobId, HadoopJobMetadata> finishedJobMetaCache() {
        InternalCache<HadoopJobId, HadoopJobMetadata> prj = finishedJobMetaPrj;
    ...
    public void onTaskFinished(HadoopTaskInfo info, HadoopTaskStatus status) {
        ...
        try {
            ...
            switch (info.type()) {
                ...
                case COMMIT:
                case ABORT: {
                    InternalCache<HadoopJobId, HadoopJobMetadata> cache = finishedJobMetaCache();
