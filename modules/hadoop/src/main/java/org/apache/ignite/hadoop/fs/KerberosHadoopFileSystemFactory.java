...
public class KerberosHadoopFileSystemFactory extends BasicHadoopFileSystemFactory {
    ...
    /** Logger */
    private static final Logger LOG = LoggerFactory.getLogger(KerberosHadoopFileSystemFactory.class);
    ...
    /** {@inheritDoc} */
    @Override protected FileSystem create1(String usrName) throws IOException, InterruptedException {
    ...
    protected void validateValues() {
        ...
        A.ensure(reloginInterval >= 0, "reloginInterval property should not be negative.");
    }
