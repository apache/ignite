...
public class HadoopMarshallerFilter extends GridNioFilterAdapter {
    ...
    @Override public GridNioFuture<?> onSessionWrite(GridNioSession ses, Object msg) throws IgniteCheckedException {
        ...
        return proceedSessionWrite(ses, MarshallerUtils.marshal(marshaller, msg, ses.igniteConfig()));
    }
    ...
    @Override public void onMessageReceived(GridNioSession ses, Object msg) throws IgniteCheckedException {
        ...
        proceedMessageReceived(ses, MarshallerUtils.unmarshal(marshaller, (byte[])msg, null, ses.igniteConfig()));
    }
