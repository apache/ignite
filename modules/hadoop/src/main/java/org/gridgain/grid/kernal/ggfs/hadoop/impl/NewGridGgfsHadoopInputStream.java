...
public final class NewGridGgfsHadoopInputStream extends InputStream implements Seekable, PositionedReadable,
    GridGgfsHadoopStreamEventListener {
    /** Minimum buffer size. */
    private static final int MIN_BUF_SIZE = 4 * 1024;

    /** Server stream delegate. */
    private NewGridGgfsHadoopStreamDelegate delegate;
     ...
     */
    public NewGridGgfsHadoopInputStream(NewGridGgfsHadoopStreamDelegate delegate, long limit, int bufSize, Log log,
    ...
    private static class FetchBufferPart {
         ...
         * @throws org.gridgain.grid.GridException If read future failed.
         */
    ...
    private class DoubleFetchBuffer {
         ...
         * @param len Maximum number of bytes to copy.
         * @return Number of bytes copied.
         * @throws org.gridgain.grid.GridException If any read operation failed.
         */
        public int flatten(byte[] dst, long pos, int dstOff, int len) throws GridException {
            assert dstOff >= 0;
         ...
         * @return Read byte.
         * @throws org.gridgain.grid.GridException If read failed.
         */
