 ...
 */
public class GridGgfsHadoopFileSystem1 extends AbstractFileSystem implements Closeable {
     ...
     */
    public GridGgfsHadoopFileSystem1(URI name, Configuration cfg) throws URISyntaxException, IOException {
