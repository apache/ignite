...
set CP=%IGNITE_LIBS%
set CP=%CP%;target\lib\*;target\ignite-web-console-2.8.0-SNAPSHOT.jar

"%JAVA_HOME%\bin\java.exe" %JVM_OPTS% -cp "%CP%" de.bwaldvogel.mongo.H2MongoServer work\database.mv %*
