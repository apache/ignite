...
const startEnv = (webConsoleRootDirectoryPath = '../../') => {
    return new Promise(async(resolve) => {
        ...
        const backendInstanceLaunch = exec(command, 'Start listening', `${webConsoleRootDirectoryPath}backend`, {server_port: BACKEND_PORT, mongodb_url: mongoUrl}); // Todo: refactor cwd for backend when it's linked
