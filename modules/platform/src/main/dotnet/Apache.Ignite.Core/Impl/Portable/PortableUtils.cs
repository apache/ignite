...
namespace GridGain.Impl.Portable
{
    ...
    static class PortableUtils
    {
        ...
        private static readonly CopyOnWriteConcurrentDictionary<Type, Func<PortableReaderImpl, bool, object>>
            ARRAY_READERS = new CopyOnWriteConcurrentDictionary<Type, Func<PortableReaderImpl, bool, object>>();
         ...
         * <param name="ctx">Write context.</param>
         */
        public static void WriteGenericDictionary<K, V>(IDictionary<K, V> val, PortableWriterImpl ctx)
        {
            Type type = val.GetType().GetGenericTypeDefinition();
         ...
         * <returns>Collection.</returns>
         */
        public static IDictionary<K, V> ReadGenericDictionary<K, V>(PortableReaderImpl ctx,
