...
namespace Apache.Ignite.Core.Impl.Portable
{
    ...
    internal class PortableBuilderImpl : IPortableBuilder
    {
        ...
        public IPortableObject Build()
        {
            ...
            PortableWriterImpl writer = portables.Marshaller.StartMarshal(outStream);
            ...
            IDictionary<string, PortableBuilderField> vals)
        {
            ...
            PortableBuilderImpl oldBuilder = parent.ctx.Writer.Builder(parent);
            ...
            finally
            {
                ...
                parent.ctx.Writer.Builder(oldBuilder);
        ...
        private class Context
        {
            ...
            /** Portable writer. */
            private readonly PortableWriterImpl writer;
