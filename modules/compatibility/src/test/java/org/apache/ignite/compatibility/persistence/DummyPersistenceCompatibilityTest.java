...
/**
 * Simple example to demonstrate the main functional of Compatibility Testing Framework.
 */
public class DummyPersistenceCompatibilityTest extends IgnitePersistenceCompatibilityAbstractTest {
    ...
    /**
     * Closure that contains actions over an Ignite instance which will be applied to a node of a specified version
     * in separate JVM process after its startup.
     */
    private static class PostStartupClosure implements IgniteInClosure<Ignite> {
        ...
        @Override public void apply(Ignite ignite) {
            ...
            CacheConfiguration<Integer, String> cacheCfg = new CacheConfiguration<>(TEST_CACHE_NAME);
    ...
    /**
     * Configuration closure which will be applied to configure a node of a specified version in separate JVM process.
     */
