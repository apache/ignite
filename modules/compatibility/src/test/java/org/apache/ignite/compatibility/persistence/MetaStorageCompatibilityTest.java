...
public class MetaStorageCompatibilityTest extends IgnitePersistenceCompatibilityAbstractTest {
     ...
     * @param cfg Ignite configuration to be updated.
     * @param consistentId Consistent id.
     * @param failOnFileRemove Indicates that an exception should be trown when partition/index file is going to be removed.
     * @return Updated configuration.
     */
    private static IgniteConfiguration prepareConfig(
        IgniteConfiguration cfg,
        @Nullable String consistentId,
        @Nullable String failOnFileRemove
    ) {
        ...
        if (failOnFileRemove != null)
            cfg.getDataStorageConfiguration().setFileIOFactory(new FailingFileIOFactory(failOnFileRemove));
    ...
    private static class FailingFileIOFactory implements FileIOFactory {
        ...
        private final String failOnFileRemove;
        ...
        public FailingFileIOFactory() {
            failOnFileRemove = null;
        }

        /**
         * Creates a new instance of IO factory.
         *
         * @param failOnFileRemove Indicates that an exception should be trown when the given file is removed.
         */
        public FailingFileIOFactory(String failOnFileRemove) {
            this.failOnFileRemove = failOnFileRemove;
        }
        ...
        @Override public FileIO create(File file, OpenOption... modes) throws IOException {
            ...
            return new FileIODecorator(delegate) {
                @Override public void clear() throws IOException {
                    if (failOnFileRemove != null && failOnFileRemove.equals(file.getName()))
