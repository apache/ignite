...
public abstract class HibernateAccessStrategyAdapter {
     ...
     * @param cache Cache.
     */
    protected HibernateAccessStrategyAdapter(Ignite ignite, InternalCache<Object, Object> cache) {
        this.cache = cache;
        this.ignite = ignite;
     ...
     * @throws CacheException If failed.
     */
    static void evict(Ignite ignite, InternalCache<Object,Object> cache, Object key) throws CacheException {
        try {
     ...
     * @throws CacheException If failed.
     */
    static void evictAll(InternalCache<Object,Object> cache) throws CacheException {
        try {
            cache.clear();
        }
        catch (IgniteCheckedException e) {
