 ...
 * {@link org.apache.ignite.internal.processors.cache.InternalCache} corresponding to the L2 cache region are configured to use the same transaction manager.
 * <p>
...
public class HibernateTransactionalAccessStrategy extends HibernateAccessStrategyAdapter {
     ...
     * @param cache Cache.
     */
    public HibernateTransactionalAccessStrategy(Ignite ignite, InternalCache<Object, Object> cache) {
        super(ignite, cache);
    }
