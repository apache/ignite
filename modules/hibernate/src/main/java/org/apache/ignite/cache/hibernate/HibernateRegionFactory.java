 ...
 * </pre>
 * Each Hibernate cache region must be associated with some {@link org.apache.ignite.internal.processors.cache.InternalCache}, by default it is assumed that
 * for each cache region there is a {@link org.apache.ignite.internal.processors.cache.InternalCache} with the same name. Also it is possible to define
...
public class HibernateRegionFactory implements RegionFactory {
    ...
    /** Default cache. */
    private InternalCache<Object, Object> dfltCache;
     ...
     */
    private InternalCache<Object, Object> regionCache(String regionName) throws CacheException {
