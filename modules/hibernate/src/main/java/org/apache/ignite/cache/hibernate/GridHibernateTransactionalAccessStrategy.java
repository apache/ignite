 ...
 * {@link org.apache.ignite.cache.Cache} corresponding to the L2 cache region are configured to use the same transaction manager.
 * <p>
...
public class GridHibernateTransactionalAccessStrategy extends GridHibernateAccessStrategyAdapter {
     ...
     * @param cache Cache.
     */
    public GridHibernateTransactionalAccessStrategy(Ignite ignite, Cache<Object, Object> cache) {
        super(ignite, cache);
    }
