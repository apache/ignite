...
/**
 * Marks a message field that is planned for removal in a future release. Removing the field requires introducing a new
 * {@link IgniteFeature} to which this annotation must be linked.
 *
 * <p>A field annotated with this annotation is excluded from message serialization when doing so does not break
...
public @interface DeprecatedBy {
    /** @return Name of the Ignite feature that deprecated this field. */
    String value();
