...
public class H2PkHashIndex extends GridH2IndexBase {
    ...
    public H2PkHashIndex(
        ...
        super(tbl, 0, name, colsList.toArray(new IndexColumn[0]), IndexType.createPrimaryKey(false, true));

        assert segments > 0: segments;

        this.segments = segments;

        IndexColumn.mapColumns(colsList.toArray(new IndexColumn[0]), tbl);
