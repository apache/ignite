...
public class PartitionInfo {
     ...
     */
    private final PartitionInfo[][] intersections;

    public PartitionInfo(PartitionInfo[][] intersections) {
     ...
     */
    public PartitionInfo[][] intersections() {
