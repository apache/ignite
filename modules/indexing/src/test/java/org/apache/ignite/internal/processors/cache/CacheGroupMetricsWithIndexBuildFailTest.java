...
public class CacheGroupMetricsWithIndexBuildFailTest extends AbstractIndexingCommonTest {
    ...
    public void testIndexRebuildCountPartitionsLeft() throws Exception {
        ...
        LongMetric indexBuildCntPartitionsLeft = grpMreg.findMetric("IndexBuildCountPartitionsLeft");

        assertTrue(GridTestUtils.waitForCondition(
            new GridAbsPredicate() {
                @Override public boolean apply() {
                    return parts1 + parts2 == indexBuildCntPartitionsLeft.value();
                }
            },
            5000
        ));
        ...
        assertEquals(parts2, indexBuildCntPartitionsLeft.value());
        ...
        assertEquals(0, indexBuildCntPartitionsLeft.value());
    }
