...
public abstract class GridIndexingSpiAbstractSelfTest extends GridCommonAbstractTest {
    ...
    public void testSpi() throws Exception {
        ...
        assertFalse(spi.queryLocalSql(typeAA.space(), "select * from A.A", Collections.emptySet(), typeAA.name(), null, null).hasNext());
        assertFalse(spi.queryLocalSql(typeAB.space(), "select * from A.B", Collections.emptySet(), typeAB.name(), null, null).hasNext());
        assertFalse(spi.queryLocalSql(typeBA.space(), "select * from B.A", Collections.emptySet(), typeBA.name(), null, null).hasNext());
        ...
        res = spi.queryLocalSql(typeAB.space(), "from b order by name", Collections.emptySet(), typeAB.name(), null, null);
        ...
        res = spi.queryLocalSql(typeBA.space(), "from a", Collections.emptySet(), typeBA.name(), null, null);
