...
public abstract class GridIndexingSpiAbstractSelfTest extends GridCommonAbstractTest {
    ...
    public void testSpi() throws Exception {
        ...
        Iterator<IgniteBiTuple<Integer, BinaryObjectImpl>> res = spi.queryLocalSql(spi.schema(typeAA.cacheName()),
            "from a order by age", null, null, typeAA.name(), null, null);
        ...
        res = spi.queryLocalSql(spi.schema(typeAB.cacheName()), "from b order by name", null, null,
        ...
        res = spi.queryLocalSql(spi.schema(typeBA.cacheName()), "from a", null, null, typeBA.name(),
            null, null);
        ...
        GridQueryFieldsResult fieldsRes =
            ...
            "b.a.age a2 from a.a, b.a where a.a.id = b.a.id ", null, null, false, 0, null);
    ...
    public void testLongQueries() throws Exception {
        ...
        try {
            ...
            while (now - time <= longQryExecTime * 3 / 2) {
                ...
                GridQueryFieldsResult res = spi.queryLocalSqlFields(spi.schema("A"), sql, new Object[]{1, range},
                    null, false, 0, null);
