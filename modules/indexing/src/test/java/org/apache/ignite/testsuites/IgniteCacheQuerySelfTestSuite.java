...
public class IgniteCacheQuerySelfTestSuite extends TestSuite {
    ...
    public static TestSuite suite() throws Exception {
        ...
        suite.addTestSuite(SqlIndexesSystemViewTest.class);
        suite.addTestSuite(SqlIndexesSystemViewStaticCfgTest.class);
        ...
        suite.addTestSuite(LocalQueryLazyTest.class);

        suite.addTestSuite(LongRunningQueryTest.class);

        suite.addTestSuite(CancelLazyDistributedJoinQueryTest.class);
