...
public class IgniteSqlGroupConcatCollocatedTest extends GridCommonAbstractTest {
    ...
    public void testGroupConcatOrderBy() {
        ...
        expected.put(1, "id#0=A");
        expected.put(2, "id#1=B; id#2=C");
        expected.put(3, "id#3=D; id#4=E; id#5=F");
        expected.put(4, "id#6=G; id#7=H; id#8=I; id#9=J");
        expected.put(5, "id#10=K; id#11=L; id#12=M; id#13=N; id#14=O");
