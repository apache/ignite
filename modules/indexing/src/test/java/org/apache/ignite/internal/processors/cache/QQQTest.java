 ...
 *
 */
public class QQQTest extends GridCommonAbstractTest {
    /** {@inheritDoc} */
    ...
    private void executeQuery() {
        ...
        SqlFieldsQuery qry = new SqlFieldsQuery("select name, age from person where age > 10 and name='moon'");
    ...
    private IgniteCache<Integer, Person> createAndFillCache() {
        ...
        cache.put(1, new Person("moon", 100));
