...
public class AtomicBinaryOffheapBatchTest extends IgniteCacheAbstractTest {
    ...
    protected CacheConfiguration cacheConfiguration(String gridName) throws Exception {
        ...
        cfg.setIndexedTypes(Integer.class, Persone.class, Integer.class, Organization.class);
    ...
    public void testBatchOperations() throws Exception {
        ...
        try (IgniteCache defaultCache = ignite(0).cache(null)) {
            ...
            for (int cnt = 0; cnt < 200; cnt++) {
                Map<Integer, Persone> putMap1 = new TreeMap<>();
                for (int i = 0; i < BATCH_SIZE; i++)
                    putMap1.put(i, new Persone(i, i+1, String.valueOf(i), String.valueOf(i+1), i/0.99));
    ...
    private void loadingCacheAnyDate() {
        try (IgniteDataStreamer streamer = ignite(0).dataStreamer(null)) {
            for (int i =0; i<30_000; i++) {
                if (i%2 == 0)
                    streamer.addData(i, new Persone(i, i+1, String.valueOf(i), String.valueOf(i+1), i/0.99));
                else
     ...
     */
    private static class Persone implements Binarylizable {
         ...
         * @param salary Salary.
         */
        public Persone(int id, int orgId, String firstName, String lastName, double salary) {
            this.id = id;
            this.orgId = orgId;
