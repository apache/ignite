...
public class ManagerStatisticsTypesTest extends StatisticsTypesAbstractTest {
    ...
    public void testUUIDStatistics() {
        ...
        assertEquals(SMALL_SIZE - 1, decimalStats.distinct());
        assertEquals(new BigDecimal(new BigInteger(1, U.uuidToBytes(new UUID(0L, 1L)))),
            decimalStats.min());
        assertEquals(new BigDecimal(new BigInteger(1, U.uuidToBytes(new UUID(0L, SMALL_SIZE - 1L)))),
            decimalStats.max());
