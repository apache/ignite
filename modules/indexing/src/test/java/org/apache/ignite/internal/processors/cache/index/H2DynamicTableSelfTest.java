...
public class H2DynamicTableSelfTest extends AbstractSchemaSelfTest {
    ...
    public void testCreateTable() throws Exception {
        cache().query(new SqlFieldsQuery("CREATE TABLE PUBLIC.\"Person\" (\"id\" int, \"city\" varchar," +
    ...
    public void testCreateTableIfNotExists() throws Exception {
        ...
        cache().query(new SqlFieldsQuery("CREATE TABLE IF NOT EXISTS PUBLIC.\"Person\" (\"id\" int, \"city\" varchar," +
            " \"name\" varchar, \"surname\" varchar, \"age\" int, PRIMARY KEY (\"id\", \"city\")) WITH " +
            "\"cacheTemplate=cache\""));
    }
