...
public class RemoveConstantsFromQueryTest extends AbstractIndexingCommonTest {
    ...
    @Override protected IgniteConfiguration getConfiguration(String igniteInstanceName) throws Exception {
        return super.getConfiguration(igniteInstanceName).setIncludeEventTypes(EventType.EVT_QUERY_EXECUTION);
    }
    ...
    public void testConstantRemoved() throws Exception {
        ...
        ignite.events().localListen(evt -> {
            assertTrue(evt instanceof QueryExecutionEvent);

            lastQryFromEvt.set(((QueryExecutionEvent)evt).clause());

            return true;
        }, EventType.EVT_QUERY_EXECUTION);
