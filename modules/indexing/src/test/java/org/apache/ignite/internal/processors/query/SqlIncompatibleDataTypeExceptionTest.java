...
public class SqlIncompatibleDataTypeExceptionTest extends AbstractIndexingCommonTest {
    ...
    public void testUseKeyField() {
        ...
        GridTestUtils.assertThrows(log, ()-> {
            ...
            return null;
        }, IgniteSQLException.class, "Composite _KEY column is not supported at INSERT/UPDATE/MERGE statements");
    ...
    public void testUseValField() {
        ...
        GridTestUtils.assertThrows(log, ()-> {
            ...
            return null;
        }, IgniteSQLException.class, "Composite _VAL column is not supported at INSERT/UPDATE/MERGE statements");
