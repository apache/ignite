...
public class SqlSystemViewsSelfTest extends AbstractIndexingCommonTest {
    ...
    public void testIndexesView() throws Exception {
        Ignite srv = startGrid(getConfiguration());

        Ignite client = startGrid(getConfiguration().setClientMode(true).setIgniteInstanceName("CLIENT"));
    ...
    public void testCachesViews() throws Exception {
        ...
        execSql("CREATE TABLE PUBLIC.cache_sql (ID INT PRIMARY KEY, VAL VARCHAR) WITH " +
