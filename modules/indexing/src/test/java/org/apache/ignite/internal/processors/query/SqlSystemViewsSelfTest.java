...
public class SqlSystemViewsSelfTest extends AbstractIndexingCommonTest {
    ...
    public void testIndexesView() throws Exception {
        ...
        Object[][] expectedResults = {
            ...
            {707660652, "SQL_PUBLIC_CACHE_SQL", "PUBLIC", "CACHE_SQL", "IDX_2", "SORTED", "\"ID\" DESC, \"ID\" ASC", false, false, 10},
            ...
            {2584860, "TST1", "TST1", "VALUECLASS", "_key_PK_proxy", "SORTED", "\"KEY\" ASC", true, true, 5},
        };
