...
import org.apache.ignite.internal.processors.query.h2.twostep.ReduceMergeIndex;
...
public class IgniteSqlSplitterSelfTest extends AbstractIndexingCommonTest {
    ...
    public void testSortedMergeIndex() throws Exception {
        ...
        try {
            GridTestUtils.setFieldValue(null, ReduceMergeIndex.class, "PREFETCH_SIZE", 8);
            ...
            GridTestUtils.setFieldValue(null, ReduceMergeIndex.class, "PREFETCH_SIZE", 1024);
