...
import org.apache.ignite.hadoop.client.HadoopClientProtocolEmbeddedSelfTest;
import org.apache.ignite.hadoop.client.HadoopClientProtocolSelfTest;
...
import org.apache.ignite.hadoop.igfs.Hadoop1OverIgfsDualAsyncTest;
import org.apache.ignite.hadoop.igfs.Hadoop1OverIgfsDualSyncTest;
import org.apache.ignite.hadoop.igfs.HadoopFIleSystemFactorySelfTest;
import org.apache.ignite.hadoop.igfs.HadoopIgfs20FileSystemLoopbackPrimarySelfTest;
import org.apache.ignite.hadoop.igfs.HadoopIgfsDualAsyncSelfTest;
import org.apache.ignite.hadoop.igfs.HadoopIgfsDualSyncSelfTest;
import org.apache.ignite.hadoop.igfs.HadoopSecondaryFileSystemConfigurationTest;
import org.apache.ignite.hadoop.igfs.IgfsEventsTestSuite;
import org.apache.ignite.hadoop.igfs.IgniteHadoopFileSystemClientSelfTest;
import org.apache.ignite.hadoop.igfs.IgniteHadoopFileSystemHandshakeSelfTest;
import org.apache.ignite.hadoop.igfs.IgniteHadoopFileSystemLoggerSelfTest;
import org.apache.ignite.hadoop.igfs.IgniteHadoopFileSystemLoggerStateSelfTest;
import org.apache.ignite.hadoop.igfs.IgniteHadoopFileSystemLoopbackEmbeddedDualAsyncSelfTest;
import org.apache.ignite.hadoop.igfs.IgniteHadoopFileSystemLoopbackEmbeddedDualSyncSelfTest;
import org.apache.ignite.hadoop.igfs.IgniteHadoopFileSystemLoopbackEmbeddedPrimarySelfTest;
import org.apache.ignite.hadoop.igfs.IgniteHadoopFileSystemLoopbackEmbeddedSecondarySelfTest;
import org.apache.ignite.hadoop.igfs.IgniteHadoopFileSystemLoopbackExternalDualAsyncSelfTest;
import org.apache.ignite.hadoop.igfs.IgniteHadoopFileSystemLoopbackExternalDualSyncSelfTest;
import org.apache.ignite.hadoop.igfs.IgniteHadoopFileSystemLoopbackExternalPrimarySelfTest;
import org.apache.ignite.hadoop.igfs.IgniteHadoopFileSystemLoopbackExternalSecondarySelfTest;
import org.apache.ignite.hadoop.igfs.IgniteHadoopFileSystemSecondaryFileSystemInitializationSelfTest;
