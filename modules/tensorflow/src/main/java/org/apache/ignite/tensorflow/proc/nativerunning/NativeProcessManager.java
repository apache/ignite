...
package org.apache.ignite.tensorflow.proc.nativerunning;
...
import org.apache.ignite.tensorflow.proc.nativerunning.task.NativeProcessStartTask;
...
public class NativeProcessManager extends ProcessManagerWrapper<LongRunningProcess, NativeProcess> {
     ...
     */
    public NativeProcessManager() {
        super(new LongRunningProcessManager());
    }
