...
package org.apache.ignite.tensorflow.tf.tfrunning;

import org.apache.ignite.tensorflow.proc.ProcessManager;
import org.apache.ignite.tensorflow.proc.ProcessManagerWrapper;
import org.apache.ignite.tensorflow.proc.pythonrunning.PythonProcess;
import org.apache.ignite.tensorflow.proc.pythonrunning.PythonProcessManager;
...
public class TensorFlowServerManager extends ProcessManagerWrapper<PythonProcess, TensorFlowServer> {
     ...
     */
    public TensorFlowServerManager() {
        this(new PythonProcessManager());
    }
