...
public class GridTuple6<V1, V2, V3, V4, V5, V6> implements Iterable<Object>, Externalizable,
    Cloneable {
    private static final long serialVersionUID = 7519492274706752810L;
    /** Value 1. */
    @GridToStringInclude
    private V1 v1;
     ...
     */
    public GridTuple6(@Nullable V1 v1, @Nullable V2 v2, @Nullable V3 v3, @Nullable V4 v4, @Nullable V5 v5,
        @Nullable V6 v6) {
        this.v1 = v1;
        this.v2 = v2;
        this.v3 = v3;
    ...
    @Override public int hashCode() {
        ...
        res = 37 * res + (v6 != null ? v6.hashCode() : 0);
