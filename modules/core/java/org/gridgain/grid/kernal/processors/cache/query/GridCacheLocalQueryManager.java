...
//        boolean rmtOnly, @Nullable org.gridgain.grid.lang.GridBiInClosure<UUID, Collection<List<Object>>> pageLsnr,
//        @Nullable org.gridgain.grid.lang.GridPredicate<?> vis) {
...
//        boolean rmtOnly, @Nullable org.gridgain.grid.lang.GridBiInClosure<UUID, Collection<List<Object>>> pageLsnr,
//        @Nullable org.gridgain.grid.lang.GridPredicate<?> vis, boolean sync) {
//        assert cctx.config().getCacheMode() == LOCAL;
//
//        if (log.isDebugEnabled())
//            log.debug("Executing query on local node: " + qry);
...
//        @Nullable org.gridgain.grid.lang.GridBiInClosure<UUID, Collection<List<Object>>> pageLsnr, @Nullable org.gridgain.grid.lang.GridPredicate<?> vis) {
//        assert cctx.config().getCacheMode() == LOCAL;
//
//        throw new GridRuntimeException("Distributed queries are not available for local cache " +
//            "(use 'GridCacheQuery.execute(grid.forLocal())' instead) [cacheName=" + cctx.name() + ']');
