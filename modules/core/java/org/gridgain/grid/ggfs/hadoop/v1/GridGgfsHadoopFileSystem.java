 ...
 * <p>
 * For sample client and data node configuration refer to {@code config/hadoop/default-config-ggfs-client.xml}
 * and {@code config/hadoop/default-config-ggfs.xml} configuration files in GridGain installation.
 */
