...
public class TestCollectionsMessageSerializer implements MessageSerializer {
    ...
    @Override public boolean writeTo(Message m, ByteBuffer buf, MessageWriter writer) {
        ...
        switch (writer.state()) {
            ...
            case 23:
                if (!writer.writeCollection(msg.gridIntListList(), MessageCollectionItemType.GRID_INT_LIST))
                    return false;
    ...
    @Override public boolean readFrom(Message m, ByteBuffer buf, MessageReader reader) {
        ...
        switch (reader.state()) {
            ...
            case 23:
                msg.gridIntListList(reader.readCollection(MessageCollectionItemType.GRID_INT_LIST));
