 ...
 */
public final class TestDeploymentAwareMessageMarshaller implements MessageMarshaller<TestDeploymentAwareMessage> {
    /** */
    private final Marshaller marshaller;

    /** */
    public TestDeploymentAwareMessageMarshaller(Marshaller marshaller) {
        this.marshaller = marshaller;
    }

    /** */
    @Override public void marshal(TestDeploymentAwareMessage msg, GridKernalContext kctx, CacheObjectContext cacheObjCtx) throws IgniteCheckedException {
