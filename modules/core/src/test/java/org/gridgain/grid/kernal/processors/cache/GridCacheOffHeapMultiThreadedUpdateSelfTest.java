...
/**
 * Multithreaded transform test.
 */
public class GridCacheOffHeapMultiThreadedUpdateSelfTest extends GridCacheAbstractSelfTest {
    /** */
    ...
    private void testPutWithFilter(final Integer key) throws Exception {
        ...
        final int THREADS = 1;
        final int ITERATIONS_PER_THREAD = 1;
     ...
     */
    private Integer keyForNode(int idx) {
        Integer key0 = null;
    ...
    /**
     */
    private static class IncClosure implements GridClosure<Integer, Integer> {
        /** {@inheritDoc} */
    ...
    /**
     */
    private static class TestFilter implements GridPredicate<GridCacheEntry<Integer, Integer>> {
        /** {@inheritDoc} */
