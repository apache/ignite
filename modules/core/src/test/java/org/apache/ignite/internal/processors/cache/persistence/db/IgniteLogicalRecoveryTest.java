...
public class IgniteLogicalRecoveryTest extends GridCommonAbstractTest {
     ...
     */
    private CacheConfiguration<Object, Object> cacheConfiguration(String name, CacheMode cacheMode,
     ...
     * @param atomicityMode Atomicity mode.
     */
    private CacheConfiguration<Object, Object> cacheConfiguration(String name, @Nullable String groupName,
        CacheMode cacheMode, CacheAtomicityMode atomicityMode) {
