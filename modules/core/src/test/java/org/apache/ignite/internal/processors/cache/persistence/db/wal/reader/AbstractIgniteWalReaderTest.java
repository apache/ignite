...
/**
 */
public class AbstractIgniteWalReaderTest extends GridCommonAbstractTest {
    /** Wal segments count */
    protected static final int WAL_SEGMENTS = 10;

    /** Cache name. */
    protected static final String CACHE_NAME = "cache0";

    /** additional cache for testing different combinations of types in WAL. */
    protected static final String CACHE_ADDL_NAME = "cache1";

    /** Dump records to logger. Should be false for non local run. */
    protected static final boolean dumpRecords = false;
     ...
     */
    protected int archiveIncompleteSegmentAfterInactivityMs;

    /** Custom wal mode. */
    protected WALMode customWalMode;

    /** Clear properties in afterTest() method. */
    protected boolean clearProperties;

    /** Set WAL and Archive path to same value. */
    protected boolean setWalAndArchiveToSameValue;
     ...
     */
    protected int iterateAndCount(WALIterator walIter) throws IgniteCheckedException {
        int cnt = 0;
     ...
     */
    protected void putDummyRecords(Ignite ignite, int recordsToWrite) {
     ...
     */
    protected boolean remove(Map m, Object key, Object val) {
     ...
     */
    @NotNull protected String genDbSubfolderName(Ignite ignite, int nodeIdx) {
     ...
     */
    protected void scanIterateAndCount(
     ...
     */
    protected void createCache2(Ignite ig, CacheAtomicityMode mode) {
     ...
     * @param mode Cache Atomicity Mode.
     */
    protected void runRemoveOperationTest(CacheAtomicityMode mode) throws Exception {
        final Ignite ignite = startGrid("node0");
     ...
     * @throws IgniteCheckedException If failed.
     */
    @NotNull protected IgniteWalIteratorFactory createWalIteratorFactory(
        final String workDir,
        final String subfolderName
     ...
     */
    protected int valuesSum(Iterable<Integer> values) {
        int sum = 0;
     ...
     */
    protected Map<GridCacheVersion, Integer> iterateAndCountDataRecord(
