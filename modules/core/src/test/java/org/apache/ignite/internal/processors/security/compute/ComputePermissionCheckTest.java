...
public class ComputePermissionCheckTest extends AbstractSecurityTest {
    ...
    public void test() throws Exception {
        ...
        Ignite srvForbidden = startGrid("srv_forbidden", permissions(null), false);
        ...
        Ignite clntForbidden = startGrid("clnt_forbidden", permissions(null), true);
    ...
    private Permissions permissions(String actions) {
        PermissionsBuilder builder = PermissionsBuilder.create()
            .add(SecurityConstants.JOIN_AS_SERVER_PERMISSION);

        if (actions != null)
            builder.add(
                new TaskPermission("org.apache.ignite.internal.processors.security.compute.*", actions)
            );
