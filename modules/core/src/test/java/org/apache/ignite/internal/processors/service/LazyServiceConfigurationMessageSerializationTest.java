...
public class LazyServiceConfigurationMessageSerializationTest extends GridCommonAbstractTest {
    ...
    /** */
    @Test
    public void testLazyServiceConfiguration() throws Exception {
    ...
    /** */
    @Test
    public void testLazyServiceConfigurationWithBytes() throws Exception {
     ...
     */
    private LazyServiceConfiguration serializeAndDeserialize(LazyServiceConfiguration src) throws IgniteCheckedException {
