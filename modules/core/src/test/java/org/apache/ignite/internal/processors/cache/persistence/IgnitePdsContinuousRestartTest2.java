...
public class IgnitePdsContinuousRestartTest2 extends GridCommonAbstractTest {
    ...
    private static final String DFLT_STORE_DIR = "db";
    ...
    @Override protected IgniteConfiguration getConfiguration(String gridName) throws Exception {
        ...
        PersistentStoreConfiguration pcfg = new PersistentStoreConfiguration()
            ...
            .setPersistentStorePath(DFLT_STORE_DIR)
            .setWalArchivePath(DFLT_STORE_DIR + "/wal/archive")
            .setWalStorePath(DFLT_STORE_DIR + "/wal")
            .setCheckpointingFrequency(checkpointDelay);

        final MemoryConfiguration memCfg = new MemoryConfiguration();

        memCfg.setDefaultMemoryPolicySize(400 * 1024 * 1024);
