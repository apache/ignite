...
public class GridCacheTestEntryEx extends GridMetadataAwareAdapter implements GridCacheEntryEx {
    ...
    @Override public GridCacheUpdateTxResult mvccSet(@Nullable IgniteInternalTx tx, UUID affNodeId, CacheObject val,
        ...
        GridCacheOperation op, boolean needHistory, boolean noCreate, boolean needOldVal,
        @Nullable CacheEntryPredicate filter, boolean retVal,
        boolean keepBinary) {
        return null;
    }
    ...
    @Override public GridCacheUpdateTxResult mvccRemove(@Nullable IgniteInternalTx tx, UUID affNodeId,
        AffinityTopologyVersion topVer, MvccSnapshot mvccVer, boolean needHist, boolean needOldValue,
    ...
    /** {@inheritDoc} */
    @Override public @Nullable CacheObject mvccPeek(boolean onheapOnly) {
        return null;
    }
    ...
    /** {@inheritDoc} */
    @Override public boolean initialValue(CacheObject val, GridCacheVersion ver, @Nullable MvccVersion mvccVer,
        @Nullable MvccVersion newMvccVer, byte mvccTxState, byte newMvccTxState, long ttl, long expireTime,
    ...
    /** {@inheritDoc} */
    @Override public GridCacheUpdateTxResult mvccUpdateRowsWithPreloadInfo(IgniteInternalTx tx, UUID affNodeId,
        AffinityTopologyVersion topVer, List<GridCacheEntryInfo> entries, GridCacheOperation op, MvccSnapshot mvccVer,
        IgniteUuid futId, int batchNum) {
        return null;
    }
