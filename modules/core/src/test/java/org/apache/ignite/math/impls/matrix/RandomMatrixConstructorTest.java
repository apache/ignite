...
public class RandomMatrixConstructorTest {
    ...
    public void mapInvalidArgsTest() {
        verifyAssertionError(() -> new RandomMatrix(0, 1), "invalid row parameter");

        verifyAssertionError(() -> new RandomMatrix(1, 0), "invalid col parameter");

        verifyAssertionError(() -> new RandomMatrix(0, 1, true), "invalid row parameter, fastHash true");

        verifyAssertionError(() -> new RandomMatrix(1, 0, true), "invalid col parameter, fastHash true");

        verifyAssertionError(() -> new RandomMatrix(0, 1, false), "invalid row parameter, fastHash false");

        verifyAssertionError(() -> new RandomMatrix(1, 0, false), "invalid col parameter, fastHash false");
    }
