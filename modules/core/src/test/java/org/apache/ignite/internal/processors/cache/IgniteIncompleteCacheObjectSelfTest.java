...
public class IgniteIncompleteCacheObjectSelfTest extends GridCommonAbstractTest {
    ...
    public void testIncompleteObject() throws Exception {
        ...
        assert CacheObjectUtils.putValue(obj.cacheObjectType(), dataBuf, off, len, data, 0);
    ...
    private static class TestCacheObject implements CacheObject {
        ...
        /** {@inheritDoc} */
        @Override public void unmarshal(final CacheObjectValueContext ctx, final ClassLoader ldr)
            throws IgniteCheckedException {
            // No-op
        }

        /** {@inheritDoc} */
        @Override public void marshal(final CacheObjectValueContext ctx) throws IgniteCheckedException {
            // No-op
        }
    }
}
