...
public class RebalanceWithDifferentThreadPoolSizeTest extends GridCommonAbstractTest {
    ...
    @Override protected IgniteConfiguration getConfiguration(String gridName) throws Exception {
        ...
        cfg.setCacheConfiguration(new CacheConfiguration(CACHE_NAME)
            .setRebalanceMode(CacheRebalanceMode.SYNC) // Wait rebalance finish before node start
    ...
    /** */
    @Test
    public void testShouldFinishRebalanceWhenConnectedNewNodeWithHigherThreadPoolSize() throws Exception {
        rebalancePoolSize = 1;
