...
import static org.apache.ignite.internal.processors.cache.consistentcut.AbstractConsistentCutBlockingTest.NodeType.BACKUP;
...
public class ConsistentCutSingleBackupWALBlockingTest extends AbstractConsistentCutWALBlockingTest {
    /** */
    ...
    public static List<Object[]> params() {
        ...
        Stream.of(PREPARED, COMMITTED).forEach((tx) ->
            Stream.of(NEAR, PRIMARY, BACKUP).forEach((nt) ->
