...
public class VisorManagementEventSelfTest extends GridCommonAbstractTest {
    ...
    /**
     * Current test case start valid one node visor task that has GridVisorManagementTask annotation. No exceptions are
     * expected.
     *
    ...
    /**
     * Current test case start valid multi node visor task that has GridVisorManagementTask annotation. No exceptions
     * are expected.
     *
     * @throws Exception If failed.
     */
    ...
    /**
     * Current test case start one node visor task that has not GridVisorManagementTask annotation. No exceptions are
     * expected.
     *
     * @throws Exception If failed.
     */
    ...
    /**
     * Current test case start multi node visor task that has not GridVisorManagementTask annotation. No exceptions are
     * expected.
     *
     * @throws Exception If failed.
     */
