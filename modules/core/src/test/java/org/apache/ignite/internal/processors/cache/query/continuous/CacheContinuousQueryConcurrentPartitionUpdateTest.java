...
public class CacheContinuousQueryConcurrentPartitionUpdateTest extends GridCommonAbstractTest {
    ...
    /** */
    private static String DEFAULT_CACHE_NAME = "cache-name";
     ...
     * @throws Exception If failed.
     */
    public void testConcurrentUpdatePartitionTxClient() throws Exception {
     ...
     * @throws Exception If failed.
     */
    private void concurrentUpdatePartition(CacheAtomicityMode atomicityMode, boolean clientMode) throws Exception {
        ...
        final IgniteCache<Object, Object> cache0 = clientMode ? client.cache(DEFAULT_CACHE_NAME)
        ...
        for (int i = 0; i < 10; i++) {
            ...
            final ConcurrentSkipListSet<Long> sets = new ConcurrentSkipListSet<>();
            ...
            qry.setLocalListener(new CacheEntryUpdatedListener<Object, Object>() {
                @Override public void onUpdated(Iterable<CacheEntryEvent<?, ?>> evts) {
                    for (CacheEntryEvent evt : evts) {
                        ...
                        CacheQueryEntryEvent e = (CacheQueryEntryEvent)evt.unwrap(CacheQueryEntryEvent.class);

                        sets.add(e.getPartitionUpdateCounter());
            ...
            QueryCursor qryCur = clientCache.query(qry);
    ...
    private void concurrentUpdatesAndQueryStart(CacheAtomicityMode atomicityMode) throws Exception {
        ...
        IgniteCache clientCache = this.client ? client.createCache(ccfg) : srv.createCache(ccfg);
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if ((THREADS * UPDATES) != evtCnt.get())
                log.info("Entries: " + sets);
