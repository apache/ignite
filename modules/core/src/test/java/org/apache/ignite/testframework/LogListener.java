 ...
 *
 * Supports {@link #matches(String) substring}, {@link #matches(Pattern) regular expression} or {@link
 * #matches(Predicate) predicate} listeners and the following optional modifiers:
 * <ul>
...
public abstract class LogListener implements Consumer<String> {
    ...
    public static class Builder {
        ...
        /**
         * Set expected number of matches.<br> Each log message may contain several matches that will be counted, except
         * {@code Predicate} which can have only one match for message.
         *
        ...
        /**
         * Set expected minimum number of matches.<br> Each log message may contain several matches that will be
         * counted, except {@code Predicate} which can have only one match for message.
         *
         * @param n Expected number of matches.
         * @return current builder instance.
         */
        ...
        /**
         * Set expected maximum number of matches.<br> Each log message may contain several matches that will be
         * counted, except {@code Predicate} which can have only one match for message.
         *
         * @param n Expected number of matches.
         * @return current builder instance.
