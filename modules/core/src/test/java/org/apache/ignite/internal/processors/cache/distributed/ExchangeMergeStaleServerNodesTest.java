...
public class ExchangeMergeStaleServerNodesTest extends GridCommonAbstractTest {
    ...
    public void testServersFailAfterMerge() throws Exception {
        DelayableCommunicationSpi delaySpi1 = new DelayableCommunicationSpi(
            log,
            (msg) -> {
        ...
        commSpis = F.asMap(
            getTestIgniteInstanceName(0), new DelayableCommunicationSpi(log, (msg) -> false),
            getTestIgniteInstanceName(1), delaySpi1,
            getTestIgniteInstanceName(2), new DelayableCommunicationSpi(log, (msg) -> msg instanceof GridDhtPartitionsSingleMessage),
            getTestIgniteInstanceName(3), new DelayableCommunicationSpi(log, (msg) -> false)
        );
    ...
    private static class DelayableCommunicationSpi extends TcpCommunicationSpi {
         ...
         */
        private DelayableCommunicationSpi(IgniteLogger log, IgnitePredicate<Message> delayPred) {
            this.log = log;
