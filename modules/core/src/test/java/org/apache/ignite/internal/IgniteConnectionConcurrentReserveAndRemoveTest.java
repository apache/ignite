...
public class IgniteConnectionConcurrentReserveAndRemoveTest extends GridCommonAbstractTest {
    ...
    public void test() throws Exception {
        ...
        TestRecordingCommunicationSpi spi3 = (TestRecordingCommunicationSpi)c2.configuration().getCommunicationSpi();
        ...
        for (GridCommunicationClient c : arr) {
            ...
            if(client != null) {
                log.error("AAAAAAA" + client.session().outRecoveryDescriptor());
