...
public class ClientSlowDiscoveryTransactionRemapTest extends ClientSlowDiscoveryAbstractTest {
    ...
    private CountDownLatch clientDiscoSpiUnblockedLatch;
    ...
    @Override public void beforeTest() throws Exception {
        clientDiscoSpiUnblockedLatch = new CountDownLatch(1);

        NodeJoinInterceptingDiscoverySpi clientDiscoSpi = NodeJoinInterceptingDiscoverySpi.create(msg -> {
            if (msg.nodeId().toString().endsWith("2"))
                U.awaitQuiet(clientDiscoSpiUnblockedLatch);
        });
    ...
    public void testTransactionRemap() throws Exception {
        ...
        try {
            ...
            clientDiscoSpiUnblockedLatch.countDown();
        }
