...
public class GridManagerLocalMessageListenerSelfTest extends GridCommonAbstractTest {
    ...
    private void doSend() throws Exception {
        ...
        mgr1.addUserMessageListener(topic, new IgniteBiPredicate<UUID, Object>() {
        ...
        for (int i = 1; i <= SAMPLE_CNT; i++) {
            mgr0.sendUserMessage(Collections.singletonList(grid(1).localNode()), new GridIoUserMessage(), topic, false, 3);
        }
