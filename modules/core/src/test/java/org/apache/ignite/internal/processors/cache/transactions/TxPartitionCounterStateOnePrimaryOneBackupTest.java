...
public class TxPartitionCounterStateOnePrimaryOneBackupTest extends TxPartitionCounterStateAbstractTest {
    ...
    private void doTestSkipReservedCountersAfterRecovery(boolean skipCheckpointOnStop) throws Exception {
        ...
        runOnPartition(partId, backups, nodes, new PrimaryBackupTxCallbackAdapter(prepOrd, new int[0]) {
    ...
    private void doTestPrepareCommitReorder(boolean skipCheckpointOnStop,
        ...
        runOnPartition(PARTITION_ID, BACKUPS, NODES_CNT, new PrimaryBackupTxCallbackAdapter(PREPARE_ORDER, COMMIT_ORDER) {
    ...
    protected class PrimaryBackupTxCallbackAdapter extends TxCallbackAdapter {
         ...
         */
        public PrimaryBackupTxCallbackAdapter(int[] prepOrd, int[] commitOrd) {
