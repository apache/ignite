...
import static org.apache.ignite.internal.processors.cache.persistence.GridCacheDatabaseSharedManager
...
public class CheckpointReadLockFailureTest extends GridCommonAbstractTest {
    ...
    @Override protected void afterTest() throws Exception {
        ...
        System.clearProperty(IGNITE_PDS_LOG_CP_READ_LOCK_HOLDERS);
    }
    ...
    public void testPrintCpRLockHolder() throws Exception {
        System.setProperty(IGNITE_PDS_LOG_CP_READ_LOCK_HOLDERS, "true");
