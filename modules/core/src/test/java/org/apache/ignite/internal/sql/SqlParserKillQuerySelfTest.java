...
public class SqlParserKillQuerySelfTest extends SqlParserAbstractSelfTest {
    ...
    public void testKillQuery() {
        ...
        assertParseError(null, "KILL " + TEST_UUID + " " + TEST_QRY_ID, "Unexpected token: \"B3C0624A\" (expected: \"QUERY\")");

        assertParseError(null, "KILL QUERY", "Unexpected end of command (expected: \"[UUID]\")");

        assertParseError(null, "KILL QUERY b3c0624a122c-46ea-9d65-67b56df00001 123", "Unexpected token: \"67B56DF00001\" (expected: \"[UUID]");

        assertParseError(null, "KILL QUERY b3c0624a-122c1-46ea-9d65-67b56df00001 123", "Unexpected token: \"67B56DF00001\" (expected: \"[UUID]\"");

        assertParseError(null, "KILL QUERY " + TEST_UUID + " aaa", "Unexpected token: \"AAA\" (expected: \"[long]\")");
