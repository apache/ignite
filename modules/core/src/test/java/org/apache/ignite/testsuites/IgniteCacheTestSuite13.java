...
import org.apache.ignite.internal.processors.cache.transform.CacheObjectsTransformationEvolutionTest;
...
public class IgniteCacheTestSuite13 {
    ...
    public static List<Class<?>> suite(Collection<Class> ignoredTests) {
        ...
        GridTestUtils.addTestIfNeeded(suite, CacheObjectsTransformationEvolutionTest.class, ignoredTests);
