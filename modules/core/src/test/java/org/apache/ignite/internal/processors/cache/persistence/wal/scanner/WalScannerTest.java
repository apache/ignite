...
public class WalScannerTest extends TestCase {
     ...
     */
    public void testShouldFindCorrectRecords() throws Exception {
     ...
     * @throws Exception If failed.
     */
    public void testShouldFindCorrectRecordsForMoreThanOnePages() throws Exception {
     ...
     * @throws Exception If failed.
     */
    public void testShouldDumpToLogFoundRecord() throws Exception {
     ...
     * @throws Exception If failed.
     */
    public void testShouldDumpToFileFoundRecord() throws Exception {
     ...
     * @throws Exception If failed.
     */
    public void testShouldDumpToFileAndLogFoundRecord() throws Exception {
