...
public class IgniteCacheClientNodeChangingTopologyTest extends GridCommonAbstractTest {
    ...
    public void testPessimisticTx2() throws Exception {
        ...
        List<ClusterNode> nodes1 = aff.nodesByPartition(key1, topVer1);
        List<ClusterNode> nodes2 = aff.nodesByPartition(key1, topVer2);

        assertEquals(nodes1, nodes2);

        nodes1 = aff.nodesByPartition(key2, topVer1);
        nodes2 = aff.nodesByPartition(key2, topVer2);
