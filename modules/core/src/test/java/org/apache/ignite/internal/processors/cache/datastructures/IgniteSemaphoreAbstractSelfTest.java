...
public abstract class IgniteSemaphoreAbstractSelfTest extends IgniteAtomicsAbstractTest
    ...
    public void testSemaphoreStopNPE() throws Exception {
        String text;
        ...
        text = stringLogger.toString();
        assertFalse(text.contains(NullPointerException.class.getName()));
    }
    ...
    /**
     * This method only checks if parameter of new semaphore is initialized properly. For tests considering failure recovery see
