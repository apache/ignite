...
import org.apache.ignite.internal.processors.cache.distributed.CacheLoadingConcurrentGridStartSelfTestAllowOverride;
...
public class IgniteCacheTestSuite2 extends TestSuite {
    ...
    public static TestSuite suite() throws Exception {
        ...
        suite.addTest(new TestSuite(CacheLoadingConcurrentGridStartSelfTestAllowOverride.class));
