...
import org.apache.ignite.internal.processors.cache.distributed.CacheLoadingSequentialGridStartSelfTest;
...
public class IgniteCacheTestSuite2 extends TestSuite {
    ...
    public static TestSuite suite() throws Exception {
        ...
        suite.addTest(new TestSuite(CacheLoadingSequentialGridStartSelfTest.class));
