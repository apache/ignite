...
public abstract class ContinuousQueryBufferCleanupAbstractTest extends GridCommonAbstractTest {
     ...
     */
    public void testCheckCacheWithSingleNode() throws Exception {
     ...
     * @throws Exception If fail.
     */
    public void testCheckCacheWithMultipleNodes() throws Exception {
     ...
     * @throws Exception If fail.
     */
    public void testCheckCacheWithMultipleNodesWithBackups() throws Exception {
     ...
     * @throws Exception If fail.
     */
    public void testCheckCacheWithMultipleNodesWithBackupsWithoutClient() throws Exception {
