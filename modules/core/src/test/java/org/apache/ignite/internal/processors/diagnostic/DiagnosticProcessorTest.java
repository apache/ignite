...
public class DiagnosticProcessorTest extends GridCommonAbstractTest {
    ...
    @Override protected void beforeTestsStarted() throws Exception {
        ...
        try {
            IgniteEx ignite = (IgniteEx)startGrid("node0");
     ...
     */
    public void testDumpPageHistoryToDefaultDir() throws Exception {
     ...
     * @throws Exception If failed.
     */
    public void testDumpRawPageHistoryToDefaultDir() throws Exception {
        diagnosticProcessor.dumpPageHistory(new PageHistoryDiagnoster.DiagnosticPageBuilder()
            .pageIds(expectedPageId)
        ...
        try (SegmentIO io = new SegmentIO(0L, new RandomAccessFileIO(dumpFile, StandardOpenOption.READ))) {
            ...
            assertEquals(2, hdr.getSerializerVersion());
        }
    }
     ...
     * @throws Exception If failed.
     */
    public void testDumpPageHistoryToCustomAbsoluteDir() throws Exception {
     ...
     * @throws Exception If failed.
     */
    public void testDumpPageHistoryToCustomRelativeDir() throws Exception {
     ...
     * @throws Exception If failed.
     */
    public void testDumpOnlyCheckpointRecordBecausePageIdNotSet() throws Exception {
        diagnosticProcessor.dumpPageHistory(new PageHistoryDiagnoster.DiagnosticPageBuilder()
            .addAction(PRINT_TO_LOG)
            .addAction(PRINT_TO_FILE)
        );
     ...
     */
    public void testThrowExceptionBecauseNotAnyActionsWasSet() throws IgniteCheckedException {
        try {
            diagnosticProcessor.dumpPageHistory(new PageHistoryDiagnoster.DiagnosticPageBuilder()
                .pageIds(expectedPageId)
            );
