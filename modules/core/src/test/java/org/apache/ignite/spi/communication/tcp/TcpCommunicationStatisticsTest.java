    ...
    public void testStatistics() throws Exception {
        ...
        try {
            ...
            synchronized (mux) {
                ...
                MetricRegistry mreg0 = grid(0).context().metric().getRegistry(node1regName);
                MetricRegistry mreg1 = grid(1).context().metric().getRegistry(node0regName);
                ...
                mreg0 = grid(0).context().metric().getRegistry(node1regName);
