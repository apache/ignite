...
/**
 * Tests for {@link ClusterAttributeNodeFilter}.
 */
public class ClusterAttributeNodeFilterSelfTest extends GridCommonAbstractTest {
    /** */
    ...
    public void testSingleAttribute() throws Exception {
        IgnitePredicate<ClusterNode> filter = new ClusterAttributeNodeFilter("attr", "value");
    ...
    public void testSingleAttributeNullValue() throws Exception {
        IgnitePredicate<ClusterNode> filter = new ClusterAttributeNodeFilter("attr", null);
    ...
    public void testMultipleAttributes() throws Exception {
        IgnitePredicate<ClusterNode> filter =
            new ClusterAttributeNodeFilter(F.<String, Object>asMap("attr1", "value1", "attr2", "value2"));
    ...
    public void testMultipleAttributesNullValues() throws Exception {
        IgnitePredicate<ClusterNode> filter = new ClusterAttributeNodeFilter(F.asMap("attr1", null, "attr2", null));
    ...
    public void testClusterGroup() throws Exception {
        ...
        assertEquals(2, group1.cluster().forPredicate(new ClusterAttributeNodeFilter("group", "data")).nodes().size());
        assertEquals(2, group2.cluster().forPredicate(new ClusterAttributeNodeFilter("group", "data")).nodes().size());

        assertEquals(3, group1.cluster().forPredicate(new ClusterAttributeNodeFilter("group", null)).nodes().size());
        assertEquals(3, group2.cluster().forPredicate(new ClusterAttributeNodeFilter("group", null)).nodes().size());

        assertEquals(0, group1.cluster().forPredicate(new ClusterAttributeNodeFilter("group", "wrong")).nodes().size());
        assertEquals(0, group2.cluster().forPredicate(new ClusterAttributeNodeFilter("group", "wrong")).nodes().size());
    }
    ...
    public void testCacheFilter() throws Exception {
        ...
        group1.createCache(new CacheConfiguration<>("test-cache").
            setNodeFilter(new ClusterAttributeNodeFilter("group", "data")));
