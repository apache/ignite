...
public class IgniteCacheMvccTestSuite7  extends TestSuite {
    ...
    public static TestSuite suite() {
        ...
        ignoredTests.add(AuthenticationProcessorNodeRestartPersistenceOffTest.class);
        ignoredTests.add(AuthenticationOnNotActiveClusterTest.class);
        ignoredTests.add(AuthenticationProcessorPersistenceOnSelfTest.class);
        ignoredTests.add(AuthenticationProcessorPersistenceOffSelfTest.class);
