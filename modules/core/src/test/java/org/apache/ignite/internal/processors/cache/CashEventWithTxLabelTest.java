...
public class CashEventWithTxLabelTest extends GridCommonAbstractTest {
     ...
     * @throws Exception If failed.
     */
    private void singleWriteReadRemoveTest(Ignite instanceToPut, Ignite instanceToGet) throws Exception {
     ...
     * @throws Exception If failed.
     */
    private void multiWriteReadRemoveTest(Ignite instanceToPut, Ignite instanceToGet) throws Exception {
        runTransactionally(instanceToPut, (Ignite ign) -> {
     ...
     * @throws Exception If failed.
     */
    private void multiNodeBatchWriteReadRemoveTest(Ignite instanceToPut, Ignite instanceToGet) throws Exception {
     ...
     * @throws Exception If failed.
     */
    private void writeInvokeRemoveTest(Ignite instanceToPut, Ignite instanceToGet) throws Exception {
        runTransactionally(instanceToGet, (Ignite ign) -> {
            ign.cache(CACHE_NAME).put(primaryKey, 3);
        });
