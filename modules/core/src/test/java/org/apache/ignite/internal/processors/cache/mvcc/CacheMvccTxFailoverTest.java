...
public class CacheMvccTxFailoverTest extends GridCommonAbstractTest {
     ...
     * @param recoverFromWAL If {@code True} then Tx recovery from WAL will be checked, binary recovery from latest
     ...
     * @throws Exception If fails.
     */
    public void checkSingleNodeRestart(boolean rollBack, boolean recoverFromWAL,
        boolean omitTxFinish) throws Exception {
