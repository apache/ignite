...
public class EncryptedSnapshotTest extends AbstractSnapshotSelfTest {
    ...
    public void testRestoringEncryptedAndPlainCaches() throws Exception {
        start2GridsWithEncAndPlainSnapshot();
        ...
        assertCacheKeys(grid(1).cache(SECOND_CACHE_NAME), CACHE_KEYS_RANGE);
    }
     ...
     */
    private void start2GridsWithEncAndPlainSnapshot() throws Exception {
        ...
        grid(1).cache(SECOND_CACHE_NAME).destroy();
