...
//        remoteJvmServerStarted.await(getTestTimeout(), TimeUnit.MILLISECONDS);
    ...
    private static class TestCutTailJob implements IgniteRunnable {
        ...
        @Override public void run() {
            ...
            IgniteCache<Object, Object> cache2 = ignite.createCache(new CacheConfiguration<>(DEFAULT_CACHE_NAME + "-2"));
            IgniteCache<Object, Object> cache3 = ignite.createCache(new CacheConfiguration<>(DEFAULT_CACHE_NAME + "-3"));
            ...
            IgniteInternalFuture<Object> clear2Fut = runAsync(() -> {
                try {
                    cache2.clear();
                }
                catch (Exception ex) {
            ...
            IgniteInternalFuture<Object> clear3Fut = runAsync(() -> {
                try {
                    cache3.clear();
                }
                catch (Exception ex) {
    ...
    @Override protected IgniteConfiguration getConfiguration(String igniteInstanceName) throws Exception {
        ...
        dsCfg.setDefaultDataRegionConfiguration(new DataRegionConfiguration()
            .setMaxSize(pageSize * 1000L * KEYS_COUNT));
