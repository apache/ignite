...
public class BinaryContextPredefinedTypesTest extends GridCommonAbstractTest {
    ...
    public void testDefaultConstructor() {
        for (BinaryClassDescriptor desc : U.binaryContext(null).predefinedTypes()) {
            if (!desc.isBinary())
                continue;
            ...
            assertSame(desc.describedClass(), desc.ctor().getDeclaringClass(),
                "Missing default constructor for predifined type " + desc.describedClass().getName());
        }
    }
}
