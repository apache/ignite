...
public class IgniteCacheEntryProcessorSequentialCallTest extends GridCommonAbstractTest {
    ...
    public void testOptimisticSerializableTxInvokeSequentialCall() throws Exception {
        testTxInvokeSequentialCallOnPrimaryNode(TransactionConcurrency.OPTIMISTIC, TransactionIsolation.SERIALIZABLE);

        testTxInvokeSequentialCallOnNearNode(TransactionConcurrency.OPTIMISTIC, TransactionIsolation.SERIALIZABLE);
    }
    ...
    public void testOptimisticRepeatableReadTxInvokeSequentialCall() throws Exception {
        testTxInvokeSequentialCallOnPrimaryNode(TransactionConcurrency.OPTIMISTIC, TransactionIsolation.REPEATABLE_READ);

        testTxInvokeSequentialCallOnNearNode(TransactionConcurrency.OPTIMISTIC, TransactionIsolation.REPEATABLE_READ);
    }
    ...
    public void testOptimisticReadCommittedTxInvokeSequentialCall() throws Exception {
        testTxInvokeSequentialCallOnPrimaryNode(TransactionConcurrency.OPTIMISTIC, TransactionIsolation.READ_COMMITTED);

        testTxInvokeSequentialCallOnNearNode(TransactionConcurrency.OPTIMISTIC, TransactionIsolation.READ_COMMITTED);
    }
    ...
    public void testPessimisticSerializableTxInvokeSequentialCall() throws Exception {
        testTxInvokeSequentialCallOnPrimaryNode(TransactionConcurrency.PESSIMISTIC, TransactionIsolation.SERIALIZABLE);

        testTxInvokeSequentialCallOnNearNode(TransactionConcurrency.PESSIMISTIC, TransactionIsolation.SERIALIZABLE);
    }
    ...
    public void testPessimisticRepeatableReadTxInvokeSequentialCall() throws Exception {
        testTxInvokeSequentialCallOnPrimaryNode(TransactionConcurrency.PESSIMISTIC, TransactionIsolation.REPEATABLE_READ);

        testTxInvokeSequentialCallOnNearNode(TransactionConcurrency.PESSIMISTIC, TransactionIsolation.REPEATABLE_READ);
    }
    ...
    public void testPessimisticReadCommittedTxInvokeSequentialCall() throws Exception {
        testTxInvokeSequentialCallOnPrimaryNode(TransactionConcurrency.PESSIMISTIC, TransactionIsolation.READ_COMMITTED);

        testTxInvokeSequentialCallOnNearNode(TransactionConcurrency.PESSIMISTIC, TransactionIsolation.READ_COMMITTED);
    }
     ...
     */
    private void testTxInvokeSequentialCallOnPrimaryNode(TransactionConcurrency transactionConcurrency,
     ...
     * @param transactionIsolation Transaction isolation.
     */
    public void testTxInvokeSequentialCallOnNearNode(TransactionConcurrency transactionConcurrency,
        TransactionIsolation transactionIsolation) throws Exception {
        TestKey key = new TestKey(1L);
        TestValue val = new TestValue();
        val.value("1");
