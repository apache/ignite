...
import org.apache.ignite.internal.processors.cache.local.GridCacheLocalAtomicMetricsSelfTest;
...
public class IgniteCacheMetricsSelfTestSuite extends TestSuite {
    ...
    public static TestSuite suite() throws Exception {
        ...
        suite.addTestSuite(GridCacheLocalAtomicMetricsSelfTest.class);
