...
public class AffinityDistributionPrintLogTest extends GridCommonAbstractTest {
    ...
    /** */
    private final String checkMsg = "Local node affinity assignment distribution is not ideal";
    ...
    public void testDistributionCalculationForThreePartitionsNotIdealMessage() throws Exception {
        ...
        assertTrue(log.contains(checkMsg));
    }
    ...
    public void testDistributionCalculationIdeal() throws Exception {
        ...
        assertFalse(log.contains(checkMsg));
    }
     ...
     * @throws Exception If failed.
     */
    public String print(boolean useDfltPartDistributionThreshold, double partDistributionThreshold,
        int nodeCnt) throws Exception {
