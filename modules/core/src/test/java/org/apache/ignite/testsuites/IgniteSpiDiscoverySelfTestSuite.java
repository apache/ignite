...
public class IgniteSpiDiscoverySelfTestSuite extends TestSuite {
    ...
    public static TestSuite suite() throws Exception {
        ...
        suite.addTest(new TestSuite(TcpDiscoveryIpFinderCleanerTest.class));
        ...
        suite.addTest(new TestSuite(TcpDiscoveryNodeJoinAndFailureTest.class));
        ...
        suite.addTest(new TestSuite(TcpDiscoveryMetricsWarnLogTest.class));
        ...
        suite.addTest(new TestSuite(TcpDiscoveryFailedJoinTest.class));

        // SSL.
        suite.addTest(new TestSuite(IgniteClientConnectSslTest.class));
        suite.addTest(new TestSuite(IgniteClientReconnectMassiveShutdownSslTest.class));
        ...
        suite.addTest(new TestSuite(TcpDiscoveryReconnectUnstableTopologyTest.class));

        suite.addTest(new TestSuite(DiscoveryClientSocketTest.class));
