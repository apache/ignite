...
public class TestCacheContinuousQueryUtils {
    ...
    public static Map<Integer, CacheContinuousQueryEventBuffer> partitionContinuesQueryEntryBuffers(
        ...
        return hnd.partitionContinuesQueryEntryBuffers();
    }

    /** */
    public static CacheContinuousQueryEntry[] bufferedEntries(CacheContinuousQueryEventBuffer buf) {
        return buf.bufferedEntries();
    }
