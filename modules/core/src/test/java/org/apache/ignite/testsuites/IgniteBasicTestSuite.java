...
public class IgniteBasicTestSuite extends TestSuite {
    ...
    public static TestSuite suite(@Nullable final Set<Class> ignoredTests) throws Exception {
        ...
        suite.addTestSuite(DropCacheContextDuringEvictionTest.class);
        suite.addTestSuite(PartitionsEvictionTaskFailureHandlerTest.class);
        ...
        suite.addTestSuite(PartitionEvictionOrderTest.class);
        ...
        suite.addTestSuite(WALRecordSerializationTest.class);

        suite.addTestSuite(GridPeerDeploymentRetryTest.class);
        suite.addTestSuite(GridPeerDeploymentRetryModifiedTest.class);
