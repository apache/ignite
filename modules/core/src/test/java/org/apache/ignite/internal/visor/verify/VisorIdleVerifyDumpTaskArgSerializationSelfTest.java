...
/**
 * Test checks backward compatibility for {@link VisorIdleVerifyDumpTaskArg}.
 */
@RunWith(JUnit4.class)
public class VisorIdleVerifyDumpTaskArgSerializationSelfTest {
    ...
    private static final VisorIdleVerifyDumpTaskArg GOLDEN_ARG =
        new VisorIdleVerifyDumpTaskArg(CACHES, EXCLUDE_CACHES, false, SYSTEM, true);

    /** Deserialized argument */
    private VisorIdleVerifyDumpTaskArg arg;
    ...
    public void beforeTest() throws IOException {
        arg = new VisorIdleVerifyDumpTaskArg();
    ...
    public void deserializeWithVersion1() throws IOException, ClassNotFoundException {
        ...
        assertEquals(ALL, arg.getCacheFilterEnum());
    }
    ...
    private void checkFieldsForVersion2() {
        ...
        assertEquals(GOLDEN_ARG.getCacheFilterEnum(), arg.getCacheFilterEnum());
    }
    ...
    private void checkFieldsForVersion1() {
        assertEquals(GOLDEN_ARG.isSkipZeros(), arg.isSkipZeros());
