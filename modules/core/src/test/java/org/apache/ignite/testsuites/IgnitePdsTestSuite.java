...
import org.apache.ignite.internal.processors.metastorage.persistence.MetaStorageSkipKeysTest;
...
public class IgnitePdsTestSuite {
    ...
    public static void addRealPageStoreTests(List<Class<?>> suite, Collection<Class> ignoredTests) {
        ...
        GridTestUtils.addTestIfNeeded(suite, MetaStorageSkipKeysTest.class, ignoredTests);
