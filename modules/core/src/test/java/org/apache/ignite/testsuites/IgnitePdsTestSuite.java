...
import org.apache.ignite.internal.processors.metastorage.persistence.DistributedMetaStorageSkipKeysTest;
...
public class IgnitePdsTestSuite {
    ...
    public static void addRealPageStoreTests(List<Class<?>> suite, Collection<Class> ignoredTests) {
        ...
        GridTestUtils.addTestIfNeeded(suite, DistributedMetaStorageSkipKeysTest.class, ignoredTests);
