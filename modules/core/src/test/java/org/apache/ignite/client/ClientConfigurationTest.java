...
public class ClientConfigurationTest {
    ...
    public void testRebalanceThreadPoolSize() {
        ...
        gridStringLogger.logLength(1024 * 100);
        ...
        cci.setGridLogger(gridStringLogger);
        try (
            ...
            String log = gridStringLogger.toString();
            boolean containsMessage = log.contains("Setting the rebalance pool size has no effect on the client mode");
