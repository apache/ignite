...
/**
 * Implementation of {@link org.apache.ignite.IgniteLogger} that performs any actions when certain message is logged. It
 * can be useful in tests to ensure that a specific message was (or was not) printed to the log.
 */
