...
import org.apache.ignite.wal.record.ExchangeRecord;
import org.apache.ignite.wal.record.MasterKeyChangeRecordV2;
...
import org.apache.ignite.wal.record.MvccTxRecord;
import org.apache.ignite.wal.record.PageSnapshot;
import org.apache.ignite.wal.record.ReencryptionStartRecord;
import org.apache.ignite.wal.record.RollbackRecord;
import org.apache.ignite.wal.record.SnapshotRecord;
...
import org.apache.ignite.internal.pagemem.wal.delta.DataPageInsertFragmentRecord;
import org.apache.ignite.internal.pagemem.wal.delta.DataPageInsertRecord;
import org.apache.ignite.internal.pagemem.wal.delta.DataPageMvccMarkUpdatedRecord;
import org.apache.ignite.internal.pagemem.wal.delta.DataPageMvccUpdateNewTxStateHintRecord;
import org.apache.ignite.internal.pagemem.wal.delta.DataPageMvccUpdateTxStateHintRecord;
import org.apache.ignite.internal.pagemem.wal.delta.DataPageRemoveRecord;
import org.apache.ignite.internal.pagemem.wal.delta.DataPageSetFreeListPageRecord;
import org.apache.ignite.internal.pagemem.wal.delta.DataPageUpdateRecord;
import org.apache.ignite.internal.pagemem.wal.delta.FixCountRecord;
import org.apache.ignite.internal.pagemem.wal.delta.FixLeftmostChildRecord;
import org.apache.ignite.internal.pagemem.wal.delta.FixRemoveId;
import org.apache.ignite.internal.pagemem.wal.delta.InitNewPageRecord;
import org.apache.ignite.internal.pagemem.wal.delta.InsertRecord;
import org.apache.ignite.internal.pagemem.wal.delta.MetaPageAddRootRecord;
import org.apache.ignite.internal.pagemem.wal.delta.MetaPageCutRootRecord;
import org.apache.ignite.internal.pagemem.wal.delta.MetaPageInitRecord;
import org.apache.ignite.internal.pagemem.wal.delta.MetaPageInitRootInlineRecord;
import org.apache.ignite.internal.pagemem.wal.delta.MetaPageInitRootRecord;
import org.apache.ignite.internal.pagemem.wal.delta.MetaPageUpdateIndexDataRecord;
import org.apache.ignite.internal.pagemem.wal.delta.MetaPageUpdateLastAllocatedIndex;
import org.apache.ignite.internal.pagemem.wal.delta.MetaPageUpdateLastSuccessfulFullSnapshotId;
import org.apache.ignite.internal.pagemem.wal.delta.MetaPageUpdateLastSuccessfulSnapshotId;
import org.apache.ignite.internal.pagemem.wal.delta.MetaPageUpdateNextSnapshotId;
import org.apache.ignite.internal.pagemem.wal.delta.MetaPageUpdatePartitionDataRecord;
import org.apache.ignite.internal.pagemem.wal.delta.MetaPageUpdatePartitionDataRecordV2;
import org.apache.ignite.internal.pagemem.wal.delta.MetaPageUpdatePartitionDataRecordV3;
import org.apache.ignite.internal.pagemem.wal.delta.NewRootInitRecord;
import org.apache.ignite.internal.pagemem.wal.delta.PageListMetaResetCountRecord;
import org.apache.ignite.internal.pagemem.wal.delta.PagesListAddPageRecord;
import org.apache.ignite.internal.pagemem.wal.delta.PagesListInitNewPageRecord;
import org.apache.ignite.internal.pagemem.wal.delta.PagesListRemovePageRecord;
import org.apache.ignite.internal.pagemem.wal.delta.PagesListSetNextRecord;
import org.apache.ignite.internal.pagemem.wal.delta.PagesListSetPreviousRecord;
import org.apache.ignite.internal.pagemem.wal.delta.PartitionDestroyRecord;
import org.apache.ignite.internal.pagemem.wal.delta.PartitionMetaStateRecord;
import org.apache.ignite.internal.pagemem.wal.delta.RecycleRecord;
import org.apache.ignite.internal.pagemem.wal.delta.RemoveRecord;
import org.apache.ignite.internal.pagemem.wal.delta.ReplaceRecord;
import org.apache.ignite.internal.pagemem.wal.delta.RotatedIdPartRecord;
import org.apache.ignite.internal.pagemem.wal.delta.SplitExistingPageRecord;
import org.apache.ignite.internal.pagemem.wal.delta.TrackingPageDeltaRecord;
...
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_EXISTING_PAGE_SPLIT;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_FIX_COUNT;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_FIX_LEFTMOST_CHILD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_FIX_REMOVE_ID;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_FORWARD_PAGE_SPLIT;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_INIT_NEW_ROOT;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_META_PAGE_ADD_ROOT;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_META_PAGE_CUT_ROOT;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_META_PAGE_INIT_ROOT;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_META_PAGE_INIT_ROOT2;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_META_PAGE_INIT_ROOT_V3;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_PAGE_INNER_REPLACE;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_PAGE_INSERT;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_PAGE_MERGE;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_PAGE_RECYCLE;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_PAGE_REMOVE;
import static org.apache.ignite.wal.record.WALRecord.RecordType.BTREE_PAGE_REPLACE;
import static org.apache.ignite.wal.record.WALRecord.RecordType.CHECKPOINT_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.CONSISTENT_CUT;
import static org.apache.ignite.wal.record.WALRecord.RecordType.DATA_PAGE_INSERT_FRAGMENT_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.DATA_PAGE_INSERT_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.DATA_PAGE_REMOVE_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.DATA_PAGE_SET_FREE_LIST_PAGE;
import static org.apache.ignite.wal.record.WALRecord.RecordType.DATA_PAGE_UPDATE_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.DATA_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.ENCRYPTED_DATA_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.ENCRYPTED_DATA_RECORD_V2;
import static org.apache.ignite.wal.record.WALRecord.RecordType.ENCRYPTED_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.ENCRYPTED_RECORD_V2;
import static org.apache.ignite.wal.record.WALRecord.RecordType.EXCHANGE;
import static org.apache.ignite.wal.record.WALRecord.RecordType.HEADER_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.INDEX_META_PAGE_DELTA_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.INIT_NEW_PAGE_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.MASTER_KEY_CHANGE_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.MASTER_KEY_CHANGE_RECORD_V2;
import static org.apache.ignite.wal.record.WALRecord.RecordType.MEMORY_RECOVERY;
import static org.apache.ignite.wal.record.WALRecord.RecordType.METASTORE_DATA_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.META_PAGE_INIT;
import static org.apache.ignite.wal.record.WALRecord.RecordType.META_PAGE_UPDATE_LAST_ALLOCATED_INDEX;
import static org.apache.ignite.wal.record.WALRecord.RecordType.META_PAGE_UPDATE_LAST_SUCCESSFUL_FULL_SNAPSHOT_ID;
import static org.apache.ignite.wal.record.WALRecord.RecordType.META_PAGE_UPDATE_LAST_SUCCESSFUL_SNAPSHOT_ID;
import static org.apache.ignite.wal.record.WALRecord.RecordType.META_PAGE_UPDATE_NEXT_SNAPSHOT_ID;
import static org.apache.ignite.wal.record.WALRecord.RecordType.MVCC_DATA_PAGE_MARK_UPDATED_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.MVCC_DATA_PAGE_NEW_TX_STATE_HINT_UPDATED_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.MVCC_DATA_PAGE_TX_STATE_HINT_UPDATED_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.MVCC_DATA_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.MVCC_TX_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.OUT_OF_ORDER_UPDATE;
import static org.apache.ignite.wal.record.WALRecord.RecordType.PAGES_LIST_ADD_PAGE;
import static org.apache.ignite.wal.record.WALRecord.RecordType.PAGES_LIST_INIT_NEW_PAGE;
import static org.apache.ignite.wal.record.WALRecord.RecordType.PAGES_LIST_REMOVE_PAGE;
import static org.apache.ignite.wal.record.WALRecord.RecordType.PAGES_LIST_SET_NEXT;
import static org.apache.ignite.wal.record.WALRecord.RecordType.PAGES_LIST_SET_PREVIOUS;
import static org.apache.ignite.wal.record.WALRecord.RecordType.PAGE_LIST_META_RESET_COUNT_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.PAGE_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.PARTITION_DESTROY;
import static org.apache.ignite.wal.record.WALRecord.RecordType.PARTITION_META_PAGE_DELTA_RECORD_V3;
import static org.apache.ignite.wal.record.WALRecord.RecordType.PARTITION_META_PAGE_UPDATE_COUNTERS;
import static org.apache.ignite.wal.record.WALRecord.RecordType.PARTITION_META_PAGE_UPDATE_COUNTERS_V2;
import static org.apache.ignite.wal.record.WALRecord.RecordType.PART_META_UPDATE_STATE;
import static org.apache.ignite.wal.record.WALRecord.RecordType.REENCRYPTION_START_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.RESERVED;
import static org.apache.ignite.wal.record.WALRecord.RecordType.ROLLBACK_TX_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.ROTATED_ID_PART_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.SNAPSHOT;
import static org.apache.ignite.wal.record.WALRecord.RecordType.SWITCH_SEGMENT_RECORD;
import static org.apache.ignite.wal.record.WALRecord.RecordType.TRACKING_PAGE_DELTA;
import static org.apache.ignite.wal.record.WALRecord.RecordType.TRACKING_PAGE_REPAIR_DELTA;
import static org.apache.ignite.wal.record.WALRecord.RecordType.TX_RECORD;
import static org.apache.ignite.internal.processors.cache.tree.DataInnerIO.VERSIONS;

/**
 * Class contains builder methods for at least one record of each type{@link org.apache.ignite.wal.record.WALRecord.RecordType}.
