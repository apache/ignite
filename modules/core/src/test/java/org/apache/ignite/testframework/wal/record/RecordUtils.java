...
import org.apache.ignite.wal.record.delta.DataPageInsertFragmentRecord;
import org.apache.ignite.wal.record.delta.DataPageInsertRecord;
...
import org.apache.ignite.wal.record.delta.DataPageRemoveRecord;
import org.apache.ignite.wal.record.delta.DataPageSetFreeListPageRecord;
import org.apache.ignite.wal.record.delta.DataPageUpdateRecord;
import org.apache.ignite.wal.record.delta.FixCountRecord;
import org.apache.ignite.wal.record.delta.FixLeftmostChildRecord;
import org.apache.ignite.wal.record.delta.FixRemoveId;
import org.apache.ignite.wal.record.delta.InitNewPageRecord;
import org.apache.ignite.wal.record.delta.InsertRecord;
import org.apache.ignite.wal.record.delta.MetaPageAddRootRecord;
import org.apache.ignite.wal.record.delta.MetaPageCutRootRecord;
import org.apache.ignite.wal.record.delta.MetaPageInitRecord;
import org.apache.ignite.wal.record.delta.MetaPageInitRootInlineRecord;
import org.apache.ignite.wal.record.delta.MetaPageInitRootRecord;
import org.apache.ignite.wal.record.delta.MetaPageUpdateIndexDataRecord;
import org.apache.ignite.wal.record.delta.MetaPageUpdateLastAllocatedIndex;
import org.apache.ignite.wal.record.delta.MetaPageUpdateLastSuccessfulFullSnapshotId;
import org.apache.ignite.wal.record.delta.MetaPageUpdateLastSuccessfulSnapshotId;
import org.apache.ignite.wal.record.delta.MetaPageUpdateNextSnapshotId;
import org.apache.ignite.wal.record.delta.MetaPageUpdatePartitionDataRecord;
import org.apache.ignite.wal.record.delta.MetaPageUpdatePartitionDataRecordV2;
import org.apache.ignite.wal.record.delta.MetaPageUpdatePartitionDataRecordV3;
import org.apache.ignite.wal.record.delta.NewRootInitRecord;
import org.apache.ignite.wal.record.delta.PageListMetaResetCountRecord;
import org.apache.ignite.wal.record.delta.PagesListAddPageRecord;
import org.apache.ignite.wal.record.delta.PagesListInitNewPageRecord;
import org.apache.ignite.wal.record.delta.PagesListRemovePageRecord;
import org.apache.ignite.wal.record.delta.PagesListSetNextRecord;
import org.apache.ignite.wal.record.delta.PagesListSetPreviousRecord;
import org.apache.ignite.wal.record.delta.PartitionDestroyRecord;
import org.apache.ignite.wal.record.delta.PartitionMetaStateRecord;
import org.apache.ignite.wal.record.delta.RecycleRecord;
import org.apache.ignite.wal.record.delta.RemoveRecord;
import org.apache.ignite.wal.record.delta.ReplaceRecord;
import org.apache.ignite.wal.record.delta.RotatedIdPartRecord;
import org.apache.ignite.wal.record.delta.SplitExistingPageRecord;
import org.apache.ignite.wal.record.delta.TrackingPageDeltaRecord;
