...
import static org.apache.ignite.internal.pagemem.wal.record.WALRecord.RecordType.META_PAGE_DELTA_RECORD;
...
public class RecordUtils {
    ...
    private static final Map<WALRecord.RecordType, Supplier<WALRecord>> TEST_WAL_RECORD_SUPPLIER =
        new EnumMap<WALRecord.RecordType, Supplier<WALRecord>>(WALRecord.RecordType.class) {{
            ...
            put(ENCRYPTION_STATUS_RECORD, RecordUtils::buildEncryptionStatusRecord);
    ...
    /** **/
    public static EncryptionStatusRecord buildEncryptionStatusRecord() {
        return new EncryptionStatusRecord(Collections.emptyMap());
    }
