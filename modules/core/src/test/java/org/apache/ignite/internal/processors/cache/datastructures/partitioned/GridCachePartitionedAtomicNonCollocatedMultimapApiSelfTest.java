...
public class GridCachePartitionedAtomicNonCollocatedMultimapApiSelfTest extends GridCacheMultimapApiSelfAbstractTest {
    ...
    @Override public void testMultimapCollocationMode() throws Exception {
        ...
        assertTrue(getMultimapBackingCache(multimap).name().startsWith("datastructures_" + multimapName + "_" + collectionCacheAtomicityMode() + "_" + collectionCacheMode()));
        assertFalse(multimap.collocated());
    }
}
