...
import org.apache.ignite.internal.processors.cache.consistency.OperationRestrictionsCacheConsistencyTest;
...
@Suite.SuiteClasses({
    ...
    OperationRestrictionsCacheConsistencyTest.class
})
