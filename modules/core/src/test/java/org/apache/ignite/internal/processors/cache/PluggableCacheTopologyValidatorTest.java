...
/** */
public class PluggableCacheTopologyValidatorTest extends GridCommonAbstractTest {
    /** */
    ...
    /** */
    @Test
    public void testSimultaneousCacheConfigurationAndPluginValidation() throws Exception {
        startGrid(0);
