...
public class PrintoutBaselineTest extends GridCommonAbstractTest {
    ...
    public void testBaselinePrintout() throws Exception {
        ...
        RegexpMessageReducer startAutoActivationMsgReducer = new RegexpMessageReducer(
        ...
        loggers[0].addReducer(startAutoActivationMsgReducer);
        ...
        assertNull(startAutoActivationMsgReducer.reduce());
        ...
        assertNull(autoActivationNodesCntMsgReducer.reduce());
        assertNull(autoActivationNodesIdsMsgReducer.reduce());
        assertNotNull(startAutoActivationMsgReducer.reduce());
