...
import org.apache.ignite.internal.processors.cache.distributed.dht.atomic.AtomicConcurrentUnorderedPutAllTest;
...
@Suite.SuiteClasses({
    ...
    AtomicConcurrentUnorderedPutAllTest.class
})
