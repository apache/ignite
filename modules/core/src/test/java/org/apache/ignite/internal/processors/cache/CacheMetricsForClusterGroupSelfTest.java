...
public class CacheMetricsForClusterGroupSelfTest extends GridCommonAbstractTest {
    ...
    public void testMetricsStatisticsEnabled() throws Exception {
        ...
        try {
            ...
            assertMetrics(cache1, ENTRY_CNT_CACHE1, true);
            assertMetrics(cache2, ENTRY_CNT_CACHE2, true);
        } finally {
            destroyCaches();
        }
    }
    ...
    public void testMetricsStatisticsDisabled() throws Exception {
        ...
        try {
            ...
            assertMetrics(cache1, ENTRY_CNT_CACHE1, false);
            assertMetrics(cache2, ENTRY_CNT_CACHE2, false);
        } finally {
            destroyCaches();
        }
    }
     ...
     * @param cache Cache.
     */
    private void assertMetrics(IgniteCache<Integer, Integer> cache, long count, boolean expectNonZero) {
