...
public class TcpDiscoveryPendingMessageDeliveryTest extends GridCommonAbstractTest {
    ...
    public void testPendingMessagesOverflow() throws Exception {
        ...
        final TcpDiscoverySpi coordDisco = (TcpDiscoverySpi)coord.configuration().getDiscoverySpi();

        final Set<TcpDiscoveryAbstractMessage> sentEnsuredMsgs = new ConcurrentHashSet<>();
        coordDisco.addSendMessageListener(new IgniteInClosure<TcpDiscoveryAbstractMessage>() {
