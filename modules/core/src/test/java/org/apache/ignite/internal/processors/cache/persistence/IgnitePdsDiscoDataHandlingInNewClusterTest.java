...
public class IgnitePdsDiscoDataHandlingInNewClusterTest extends GridCommonAbstractTest {
    ...
    /** */
    @Before
    public void beforeIgnitePdsDiscoDataHandlingInNewClusterTest() throws Exception {
        cleanPersistenceDir();
    }

    /** */
    @After
    public void afterIgnitePdsDiscoDataHandlingInNewClusterTest() throws Exception {
        stopAllGrids();
