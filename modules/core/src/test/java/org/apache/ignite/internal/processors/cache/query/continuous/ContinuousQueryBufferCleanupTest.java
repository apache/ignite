...
public class ContinuousQueryBufferCleanupTest extends GridCommonAbstractTest {
    ...
    protected static final AtomicInteger updCntr = new AtomicInteger();
    ...
    public AbstractContinuousQuery<Integer, String> continuousQry;
    ...
    public static List<Object[]> parameters() {
        ...
        AbstractContinuousQuery<Integer, String> cq = getContinuousQuery();

        params.add(new Object[]{1, 0, true, cq});
        params.add(new Object[]{2, 0, true, cq});
        params.add(new Object[]{2, 1, true, cq});
        params.add(new Object[]{2, 1, false, cq});

        AbstractContinuousQuery<Integer, String> cqWithTransformer = getContinuousQueryWithTransformer();

        params.add(new Object[]{1, 0, true, cqWithTransformer});
        params.add(new Object[]{2, 0, true, cqWithTransformer});
        params.add(new Object[]{2, 1, true, cqWithTransformer});
        params.add(new Object[]{2, 1, false, cqWithTransformer});

        return params;
    }

    /** Provides continuous query for the test. */
    private static AbstractContinuousQuery<Integer, String> getContinuousQuery() {
    ...
    /** Provides continuous query with transformer for the test. */
    private static AbstractContinuousQuery<Integer, String> getContinuousQueryWithTransformer() {
