 ...
 * MBean test.
 */
public class IgniteDisableMBeansTest extends GridCommonAbstractTest implements IgniteInClosure<String> {
    static String policyFileName = IgniteDisableMBeansTestMain.policyFileName;
    ...
    public void testInst() throws Exception {
        ...
        try {
            proc = GridJavaProcess.exec(
                    IgniteDisableMBeansTestMain.class,
                    null, // Params.
                    this.log,
