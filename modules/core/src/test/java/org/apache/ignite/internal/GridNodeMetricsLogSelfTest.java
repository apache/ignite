...
public class GridNodeMetricsLogSelfTest extends GridCommonAbstractTest {
    ...
    protected void checkNodeMetricsFormat(String fullLog) {
        ...
        assertTrue(msg, fullLog.matches("(?s).* region \\[type=internal, persistence=(true|false),.*"));
        assertTrue(msg, fullLog.matches("(?s).* region \\[type=default, persistence=(true|false),.*"));
    ...
    /**
     * @param name */
    protected boolean persistenceEnabled(String name) {
        return false;
    }
}
