...
public class SqlParserMultiStatementSelfTest extends SqlParserAbstractSelfTest {
    ...
    public void testEmptyStatements() {
        ...
        assertEquals(null, parser.lastSqlStatement());
        ...
        assertEquals("CREATE INDEX TEST on TABLE1(id)", parser.lastSqlStatement());
        ...
        assertEquals("BEGIN", parser.lastSqlStatement());
    ...
    public void testComments() {
        ...
        assertEquals("COMMIT", parser.lastSqlStatement());
        assertEquals(";;", parser.remainingSql());
