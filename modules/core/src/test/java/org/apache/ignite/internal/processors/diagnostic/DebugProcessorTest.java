...
public class DebugProcessorTest extends GridCommonAbstractTest {
    ...
    @Test
    public void dumpPageHistory() throws Exception {
        ...
        DebugProcessor debugProcessor = ignite.context().debug();
        ...
        debugProcessor.dumpPageHistory(new DebugProcessor.DebugPageBuilder()
            .pageIds(pageId)
            .addAction(DebugProcessor.DebugAction.PRINT_TO_LOG)
            .addAction(DebugProcessor.DebugAction.PRINT_TO_FILE)
        );
    }
