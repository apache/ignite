...
public class TcpDiscoveryWithWrongServerTest extends GridCommonAbstractTest {
     ...
     */
    private void startTcpThread(final WorkerFactory workerFactory, final int port) {
        final ServerSocket srvSock;
        try {
            srvSock = new ServerSocket(port, 10, InetAddress.getByName("127.0.0.1"));
        }
        catch (Exception e) {
