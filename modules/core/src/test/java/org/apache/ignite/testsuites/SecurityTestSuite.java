...
import org.apache.ignite.internal.processors.security.AuthenticatorSecurityContextEncodingMultiJvmTest;
...
@Suite.SuiteClasses({
    ...
    AuthenticatorSecurityContextEncodingMultiJvmTest.class
})
