...
import org.apache.ignite.internal.processors.security.discovery.CustomDiscoveryMessageSecurityContextTest;
...
@Suite.SuiteClasses({
    ...
    CustomDiscoveryMessageSecurityContextTest.class
})
