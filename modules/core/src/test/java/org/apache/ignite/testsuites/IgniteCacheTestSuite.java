...
import org.apache.ignite.internal.processors.cache.GridDataStorageConfigurationValidationTest;
...
public class IgniteCacheTestSuite extends TestSuite {
    ...
    public static TestSuite suite(Set<Class> ignoredTests) throws Exception {
        ...
        suite.addTestSuite(GridDataStorageConfigurationValidationTest.class);
