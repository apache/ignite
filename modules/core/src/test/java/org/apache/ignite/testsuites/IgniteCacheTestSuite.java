...
import org.apache.ignite.internal.processors.cacheobject.IgniteCacheObjectProcessorSelfTest;
...
public class IgniteCacheTestSuite extends TestSuite {
    ...
    public static TestSuite suite(Set<Class> ignoredTests) throws Exception {
        ...
        suite.addTestSuite(IgniteCacheObjectProcessorSelfTest.class);
