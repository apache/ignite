...
package org.gridgain.grid.design.userservices;
 ...
 * </pre>
 */
public interface UserServicesTopology extends AsyncSupport, ClusterTopology<UserServicesTopology> {
    /** {@inheritDoc} */
    @Override UserServicesTopology enableAsync();
