...
/**
 * Defines {@code alias} for {@link org.gridgain.grid.lang.IgniteBiClosure} by extending it. Since Java doesn't provide type aliases
 * (like Scala, for example) we resort to these types of measures. This is intended to provide for more
 * concise code in cases when readability won't be sacrificed. For more information see {@link org.gridgain.grid.lang.IgniteBiClosure}.
 ...
 * @see GridFunc
 * @see org.gridgain.grid.lang.IgniteBiClosure
 */
