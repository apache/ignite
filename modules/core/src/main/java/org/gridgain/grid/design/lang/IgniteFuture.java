...
public interface IgniteFuture<R> {
     ...
     */
    public void listenAsync(@Nullable GridInClosure<? super IgniteFuture<R>> lsnr);
     ...
     */
    public void stopListenAsync(@Nullable GridInClosure<? super IgniteFuture<R>>... lsnr);
     ...
     */
    public <T> IgniteFuture<T> chain(GridClosure<? super IgniteFuture<R>, T> doneCb);
}
