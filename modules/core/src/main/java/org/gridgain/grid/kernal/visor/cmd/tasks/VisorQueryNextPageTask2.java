 ...
 *
 * TODO GG-8942
 * @deprecated Should replace VisorQueryNextPageTask in compatibility breaking release.
 */
...
public class VisorQueryNextPageTask2 extends VisorOneNodeTask<GridBiTuple<String, Integer>, VisorQueryResult> {
    ...
    /** {@inheritDoc} */
    @Override protected VisorQueryNextPageJob2 job(GridBiTuple<String, Integer> arg) {
        return new VisorQueryNextPageJob2(arg);
    }

    /**
     * Job for collecting next page previously executed SQL or SCAN query.
     */
    private static class VisorQueryNextPageJob2 extends VisorJob<GridBiTuple<String, Integer>, VisorQueryResult> {
        /** */
        private static final long serialVersionUID = 0L;
         ...
         */
        private VisorQueryNextPageJob2(GridBiTuple<String, Integer> arg) {
            super(arg);
        }
        ...
        @Override protected VisorQueryResult run(GridBiTuple<String, Integer> arg) throws GridException {
            ...
            VisorQueryResult res = arg.get1().startsWith(SCAN_QRY_NAME) ? nextScanPage(arg) : nextSqlPage(arg);

            return new VisorQueryResult2(res, U.currentTimeMillis() - start);
        }
