...
public class Ignition {
     ...
     */
    public static Grid ignite() throws GridIllegalStateException {
     ...
     *      initialized or grid instance was stopped or was not started.
     */
    public static Grid ignite(UUID locNodeId) throws GridIllegalStateException {
     ...
     *      initialized or grid instance was stopped or was not started.
     */
    public static Grid ignite(@Nullable String name) throws GridIllegalStateException {
