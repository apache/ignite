...
import org.gridgain.grid.design.util.*;
 ...
 */
public interface ClusterSubgroupSupport<T extends ClusterSubgroupSupport> {
     ...
     */
    public T forNodes(Collection<? extends GridNode> nodes);
     ...
     */
    public T forNode(GridNode node, GridNode... nodes);
     ...
     *      given nodes.
     */
    public T forOthers(GridNode node, GridNode... nodes);
     ...
     */
    public T forPredicate(IgnitePredicate<GridNode> p);
     ...
     */
    public T forHost(GridNode node);
