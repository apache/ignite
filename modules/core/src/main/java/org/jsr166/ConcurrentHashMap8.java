...
public class ConcurrentHashMap8<K, V>
    ...
    @SuppressWarnings("serial") static class Traverser<K,V,R> {
        ...
        Traverser(ConcurrentHashMap8<K, V> map) {
            this.map = map;
        }

        /** Creates iterator for split() methods and task constructors */
        Traverser(ConcurrentHashMap8<K,V> map, Traverser<K,V,?> it, int batch) {
            this.batch = batch;
    ...
    public static <K> KeySetView<K,Boolean> newKeySet() {
        return new KeySetView<K,Boolean>(new ConcurrentHashMap8<K,Boolean>(),
            Boolean.TRUE);
    }
    ...
    public static <K> KeySetView<K,Boolean> newKeySet(int initialCapacity) {
        return new KeySetView<K,Boolean>(new ConcurrentHashMap8<K,Boolean>(initialCapacity),
            Boolean.TRUE);
    }
    ...
    @SuppressWarnings("serial") static final class KeyIterator<K,V> extends Traverser<K,V,Object>
        ...
        KeyIterator(ConcurrentHashMap8<K, V> map) { super(map); }
        KeyIterator(ConcurrentHashMap8<K, V> map, Traverser<K,V,Object> it) {
            super(map, it, -1);
        }
    ...
    @SuppressWarnings("serial") static final class ValueIterator<K,V> extends Traverser<K,V,Object>
        ...
        ValueIterator(ConcurrentHashMap8<K, V> map) { super(map); }
        ValueIterator(ConcurrentHashMap8<K, V> map, Traverser<K,V,Object> it) {
            super(map, it, -1);
        }
    ...
    @SuppressWarnings("serial") static final class EntryIterator<K,V> extends Traverser<K,V,Object>
        ...
        EntryIterator(ConcurrentHashMap8<K, V> map) { super(map); }
        EntryIterator(ConcurrentHashMap8<K, V> map, Traverser<K,V,Object> it) {
            super(map, it, -1);
        }
    ...
    static abstract class CHMView<K, V> {
        final ConcurrentHashMap8<K, V> map;
        CHMView(ConcurrentHashMap8<K, V> map)  { this.map = map; }
