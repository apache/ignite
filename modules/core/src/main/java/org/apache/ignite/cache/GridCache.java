 ...
 * </li>
 * <li>
 *     Method {@link #affinity()} provides {@link org.apache.ignite.cache.affinity.GridCacheAffinityFunction} service for information on
 *     data partitioning and mapping keys to grid nodes responsible for caching those keys.
 * </li>
 * <li>
 *     Method {@link #dataStructures()} provides {@link org.apache.ignite.cache.datastructures.GridCacheDataStructures} service for
 *     creating and working with distributed concurrent data structures, such as
 *     {@link org.apache.ignite.cache.datastructures.GridCacheAtomicLong}, {@link org.apache.ignite.cache.datastructures.GridCacheAtomicReference}, {@link org.apache.ignite.cache.datastructures.GridCacheQueue}, etc.
 * </li>
 * <li>
...
public interface GridCache<K, V> extends GridCacheProjection<K, V> {
     ...
     * {@link org.apache.ignite.cache.affinity.consistenthash.GridCacheConsistentHashAffinityFunction#setHashIdResolver(GridCacheAffinityNodeHashResolver)} to make sure that
