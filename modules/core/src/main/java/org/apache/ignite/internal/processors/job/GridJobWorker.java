...
public class GridJobWorker extends GridWorker implements GridTimeoutObject {
    ...
    boolean initialize(GridDeployment dep, Class<?> taskCls) {
        ...
        try {
            if (job == null) {
                job = MarshallerUtils.unmarshal(marsh, jobBytes, dep.classLoader(), ctx);
                    ...
                    if (sndNode == null) {
                        ...
                        try {
                            ...
                            GridJobExecuteResponse jobRes = new GridJobExecuteResponse(
                                ...
                                ses.getId(),
                                ses.getJobId(),
                                loc ? null : MarshallerUtils.marshal(marsh, ex, ctx),
                                loc ? ex : null,
                                loc ? null: MarshallerUtils.marshal(marsh, res, ctx),
                                loc ? res : null,
