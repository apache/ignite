 ...
 * This API extends {@link org.apache.ignite.cache.GridCacheProjection} API which contains vast majority of cache functionality
 * and documentation. In addition to {@link org.apache.ignite.cache.GridCacheProjection} functionality this API provides:
 * <ul>
 * <li>
 ...
 *     {@link IgniteAtomicLong}, {@link IgniteAtomicReference}, {@link org.apache.ignite.cache.datastructures.GridCacheQueue}, etc.
 * </li>
 * <li>
...
public interface IgniteCache<K, V> extends javax.cache.Cache<K, V>, IgniteAsyncSupport {
     ...
     * <p>
     * Note that this method is not available on {@link org.apache.ignite.cache.GridCacheProjection} API since it is
     ...
     * {@link org.apache.ignite.cache.GridCacheFlag#LOCAL}, {@link org.apache.ignite.cache.GridCacheFlag#READ}.
     *
     ...
     * @throws org.apache.ignite.cache.GridCacheFlagException If projection flags validation failed.
     */
     ...
     * {@link org.apache.ignite.cache.GridCacheFlag#SKIP_SWAP} is not enabled, the evicted entry will
     ...
     * <h2 class="header">Cache Flags</h2>
     * This method is not available if any of the following flags are set on projection:
     * {@link org.apache.ignite.cache.GridCacheFlag#SKIP_SWAP}, {@link org.apache.ignite.cache.GridCacheFlag#READ}.
     *
     * @param keys Keys to promote entries for.
     * @throws CacheException If promote failed.
     * @throws org.apache.ignite.cache.GridCacheFlagException If flags validation failed.
     */
     ...
     * <p>
     * If {@link CacheConfiguration#isSwapEnabled()} is set to {@code true} and
     * {@link org.apache.ignite.cache.GridCacheFlag#SKIP_SWAP} is not enabled, the evicted entries will
