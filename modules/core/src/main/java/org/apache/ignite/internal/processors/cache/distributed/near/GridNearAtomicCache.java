...
public class GridNearAtomicCache<K, V> extends GridNearCacheAdapter<K, V> {
    ...
    /** {@inheritDoc} */
    @Override public void putAll(Map<? extends K, ? extends V> m, IgnitePredicate<Entry<K, V>>[] filter)
        throws IgniteCheckedException {
        dht.putAll(m, filter);
    }
    ...
    /** {@inheritDoc} */
    @Override public void removeAll(Collection<? extends K> keys, IgnitePredicate<Entry<K, V>>... filter)
        throws IgniteCheckedException {
