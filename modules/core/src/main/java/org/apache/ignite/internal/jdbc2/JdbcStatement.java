...
public class JdbcStatement implements Statement {
    ...
    @Override public ResultSet executeQuery(String sql) throws SQLException {
        ...
        JdbcQueryTask qryTask = new JdbcQueryTask(loc ? ignite : null, conn.cacheName(), conn.getSchema(), sql, true,
    ...
    long doUpdate(String sql, Object[] args) throws SQLException {
        ...
        JdbcQueryTask qryTask = new JdbcQueryTask(loc ? ignite : null, conn.cacheName(), conn.getSchema(), sql, false,
    ...
    @Override public boolean execute(String sql) throws SQLException {
        ...
        JdbcQueryTask qryTask = new JdbcQueryTask(loc ? ignite : null, conn.cacheName(), conn.getSchema(), sql, null,
            loc, getArgs(), fetchSize, uuid, conn.isLocalQuery(), conn.isCollocatedQuery(), conn.isDistributedJoins());
