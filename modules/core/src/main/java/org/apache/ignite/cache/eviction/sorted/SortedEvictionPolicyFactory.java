 ...
 */
public class SortedEvictionPolicyFactory extends AbstractEvictionPolicyFactory<SortedEvictionPolicy> {
    ...
    /** {@inheritDoc} */
    @Override public SortedEvictionPolicy create() {
        SortedEvictionPolicy policy = new SortedEvictionPolicy<>();
