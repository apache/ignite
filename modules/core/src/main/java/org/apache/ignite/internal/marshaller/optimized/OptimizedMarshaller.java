...
public class OptimizedMarshaller extends AbstractNodeNameAwareMarshaller {
    ...
    @Override protected <T> T unmarshal0(InputStream in, @Nullable ClassLoader clsLdr, boolean useCache) throws IgniteCheckedException {
        ...
        try {
            objIn = OptimizedObjectStreamRegistry.in(useCache);
            ...
            OptimizedObjectStreamRegistry.closeIn(objIn, useCache);
        }
    }
    ...
    @Override protected <T> T unmarshal0(byte[] arr, @Nullable ClassLoader clsLdr) throws IgniteCheckedException {
        ...
        try {
            objIn = OptimizedObjectStreamRegistry.in(true);
            ...
            OptimizedObjectStreamRegistry.closeIn(objIn, true);
        }
    }
