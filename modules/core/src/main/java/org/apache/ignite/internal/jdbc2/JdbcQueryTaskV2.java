...
class JdbcQueryTaskV2 extends JdbcQueryTask {
     ...
     */
    public JdbcQueryTaskV2(Ignite ignite, String cacheName, String sql, boolean loc, Object[] args, int fetchSize,
        UUID uuid, boolean locQry, boolean collocatedQry, boolean distributedJoins, boolean enforceJoinOrder) {
        super(ignite, cacheName, sql, loc, args, fetchSize, uuid, locQry,
     ...
     */
    public static JdbcQueryTask createTask(Ignite ignite, String cacheName, String sql,
        boolean loc, Object[] args, int fetchSize, UUID uuid, boolean locQry,
        boolean collocatedQry, boolean distributedJoins, boolean enforceJoinOrder) {

        if (enforceJoinOrder)
            return new JdbcQueryTaskV2(ignite, cacheName, sql, loc, args, fetchSize,
                uuid, locQry, collocatedQry, distributedJoins, true);
        else
            return new JdbcQueryTask(ignite, cacheName, sql, loc, args, fetchSize,
