...
public class IgniteKernal implements IgniteEx, IgniteMXBean, Externalizable {
        ...
        throws IgniteCheckedException
    {
        ...
        try {
            ...
            GridComponent cmp = createHadoopComponent();

            if (!(cmp instanceof HadoopNoopProcessor)) {
                int c = ((ThreadPoolExecutor)igfsExecSvc).prestartAllCoreThreads();

                assert c == ((ThreadPoolExecutor) igfsExecSvc).getCorePoolSize();
            }
