...
package org.apache.ignite.internal.processors.cache.config;
 ...
 * Index descriptor.
 */
public class IndexDescriptor implements GridQueryIndexDescriptor {
     ...
     */
    IndexDescriptor(QueryIndexType type, int inlineSize) {
        assert type != null;
     ...
     * @param type Type.
     */
    IndexDescriptor(QueryIndexType type) {
        this(type, -1);
    }
