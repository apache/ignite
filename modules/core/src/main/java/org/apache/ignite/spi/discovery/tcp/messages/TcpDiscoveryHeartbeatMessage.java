...
public class TcpDiscoveryHeartbeatMessage extends TcpDiscoveryAbstractMessage {
     ...
     */
    public void setMetrics(UUID nodeId, ClusterNodeMetricsMBean metrics) {
        assert nodeId != null;
        assert metrics != null;
     ...
     * @param metrics Node metrics.
     */
    public void setClientMetrics(UUID nodeId, UUID clientNodeId, ClusterNodeMetricsMBean metrics) {
        assert nodeId != null;
     ...
     */
    private static byte[] serializeMetrics(ClusterNodeMetricsMBean metrics) {
        assert metrics != null;
     ...
     * @return Serialized metrics.
     */
    private static byte[] serializeMetrics(UUID nodeId, ClusterNodeMetricsMBean metrics) {
        assert nodeId != null;
        assert metrics != null;
    ...
    public static class MetricsSet implements Externalizable {
         ...
         * @param metrics Metrics.
         */
        public MetricsSet(ClusterNodeMetricsMBean metrics) {
            assert metrics != null;
         ...
         */
        public ClusterNodeMetricsMBean metrics() {
         ...
         */
        public Collection<T2<UUID, ClusterNodeMetricsMBean>> clientMetrics() {
            return F.viewReadOnly(clientMetrics, new C1<byte[], T2<UUID, ClusterNodeMetricsMBean>>() {
                @Override public T2<UUID, ClusterNodeMetricsMBean> apply(byte[] bytes) {
         ...
         */
        private void addClientMetrics(UUID nodeId, ClusterNodeMetricsMBean metrics) {
            assert nodeId != null;
            assert metrics != null;
