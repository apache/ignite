...
public class DataStreamerImpl<K, V> implements IgniteDataStreamer<K, V>, Delayed {
    ...
    private void flushAllThreadsBufs() {
        ...
        for (ThreadBuffer buf : threadBufMap.values())
            loadData(buf.getEntries(), (GridFutureAdapter)buf.getFut().internalFuture());
        ...
        try {
            ...
            try {
                ...
                if (cancel) {
                    ...
                    for (ThreadBuffer buf : threadBufMap.values()) {
                        GridFutureAdapter internalFut = (GridFutureAdapter)buf.getFut().internalFuture();
