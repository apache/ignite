...
public class IgniteSnapshotManager extends GridCacheSharedManagerAdapter
    ...
    /** Minimal number of thread to perform local snapshot. */
    private static final int SNAPSHOT_THREAD_MIN_POOL_SIZE = 4;

    /** Maximal number of thread to perform local snapshot. */
    private static final int SNAPSHOT_THREAD_MAX_POOL_SIZE = Runtime.getRuntime().availableProcessors() / 4;
    ...
    @Override protected void start0() throws IgniteCheckedException {
        ...
        snpRunner = new IgniteThreadPoolExecutor(SNAPSHOT_RUNNER_THREAD_PREFIX,
            ...
            SNAPSHOT_THREAD_MIN_POOL_SIZE,
            SNAPSHOT_THREAD_MAX_POOL_SIZE,
