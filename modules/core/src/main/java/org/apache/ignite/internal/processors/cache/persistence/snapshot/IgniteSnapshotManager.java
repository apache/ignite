                    ...
                    try {
                        ...
                        IgniteInternalFuture<?> fut = scheduleSnapshot(snpName,
                            ...
                            new SerialExecutor(cctx.kernalContext()
                                .pools()
                                .poolForPolicy(plc)),
                            remoteSnapshotReceiver(nodeId, DFLT_RMT_SNAPSHOT_TOPIC));
