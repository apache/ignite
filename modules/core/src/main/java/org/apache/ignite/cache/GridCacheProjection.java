 ...
 * </li>
 * <li>
 *  {@link #queries()} method to get an instance of {@link org.apache.ignite.cache.query.GridCacheQueries} service for working
 ...
 * only keys with identical affinity-key (see {@link org.apache.ignite.cache.affinity.GridCacheAffinityKeyMapped}) can participate in the
 ...
 * only keys belonging to identical partition (see {@link org.apache.ignite.cache.affinity.GridCacheAffinity#partition(Object)}) can participate in the
