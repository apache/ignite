 ...
 */
public class VisorDumpDiagnosticInfoArg extends IgniteDataTransferObject {
    /** */
    private static final long serialVersionUID = 0L;

    /** Dump operation. */
    VisorDumpDiagnosticInfoOperation operation;
     ...
     * Default constructor.
     */
    public VisorDumpDiagnosticInfoArg() {
        // No-op.
    }
     ...
     */
    public VisorDumpDiagnosticInfoOperation getOperation() {
        return operation;
    }
    ...
    @Override protected void readExternalData(byte protoVer,
        ...
        operation = U.readEnum(in, VisorDumpDiagnosticInfoOperation.class);
    ...
    @Override public String toString() {
        return S.toString(VisorDumpDiagnosticInfoArg.class, this);
    }
