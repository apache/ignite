...
import org.apache.ignite.internal.codegen.HostAddressMessageSerializer;
...
import org.apache.ignite.spi.discovery.tcp.messages.HostAddressMessage;
...
public class DiscoveryMessageFactory implements MessageFactoryProvider {
    ...
    @Override public void registerAll(MessageFactory factory) {
        factory.register((short)-100, HostAddressMessage::new, new HostAddressMessageSerializer());
        ...
        factory.register((short)7, TcpDiscoveryHandshakeResponse::new, new TcpDiscoveryHandshakeResponseSerializer());
    }
}
