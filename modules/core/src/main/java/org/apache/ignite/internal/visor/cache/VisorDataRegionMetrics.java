 ...
 */
public class VisorDataRegionMetrics extends VisorDataTransferObject {
    /** */
     ...
     */
    public VisorDataRegionMetrics(DataRegionMetrics m) {
        name = m.getName();
    ...
    @Override public String toString() {
        return S.toString(VisorDataRegionMetrics.class, this);
    }
}
