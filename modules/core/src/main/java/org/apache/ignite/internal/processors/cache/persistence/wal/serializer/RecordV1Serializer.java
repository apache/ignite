...
public class RecordV1Serializer implements RecordSerializer {
     ...
     */
    public static void putVersion(ByteBuffer buf, GridCacheVersion ver, boolean allowNull) {
     ...
     */
    public static GridCacheVersion readVersion(ByteBufferBackedDataInput in, boolean allowNull) throws IOException {
