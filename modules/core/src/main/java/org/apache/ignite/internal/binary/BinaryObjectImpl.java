 ...
 * <p>
 * Currently there is 6 possible layouts for Binary Objects, all depends on provided flags:
 * <ol>
 *     <li>
 *         {@link BinaryUtils#FLAG_HAS_SCHEMA} is set, {@link BinaryUtils#FLAG_HAS_RAW}
 *         and {@link BinaryUtils#FLAG_HAS_UPDATE_TIME} both are not set
 *         <p>
 *         {@code <header: 24 byte><schema data: var len><footer: var len>}
 *     </li>
 *     <li>
 *         {@link BinaryUtils#FLAG_HAS_SCHEMA} and {@link BinaryUtils#FLAG_HAS_UPDATE_TIME} both are set,
 *         {@link BinaryUtils#FLAG_HAS_RAW} is not set
 *         <p>
 *         {@code <header: 24 byte><schema data: var len><footer: var len><update time: 8 byte>}
 *     </li>
 *     <li>
 *         {@link BinaryUtils#FLAG_HAS_SCHEMA} and {@link BinaryUtils#FLAG_HAS_RAW} both are set,
 *         {@link BinaryUtils#FLAG_HAS_UPDATE_TIME} is not set
 *         <p>
 *         {@code <header: 24 byte><schema data: var len><raw data: var len><footer: var len><raw data offset: 4 byte>}
 *     </li>
 *     <li>
 *         {@link BinaryUtils#FLAG_HAS_SCHEMA}, {@link BinaryUtils#FLAG_HAS_RAW}
 *         and {@link BinaryUtils#FLAG_HAS_UPDATE_TIME} are all set
 *         <p>
 *         {@code <header: 24 byte><schema data: var len><raw data: var len><footer: var len><raw data offset: 4 byte><update time: 8 byte>}
 *     </li>
 *     <li>
 *         {@link BinaryUtils#FLAG_HAS_RAW} is set, {@link BinaryUtils#FLAG_HAS_UPDATE_TIME}
 *         and {@link BinaryUtils#FLAG_HAS_SCHEMA} both are not set
 *         <p>
 *         {@code <header: 24 byte><raw data: var len>}
 *     </li>
 *     <li>
 *         {@link BinaryUtils#FLAG_HAS_RAW} and {@link BinaryUtils#FLAG_HAS_UPDATE_TIME} both are set,
 *         {@link BinaryUtils#FLAG_HAS_SCHEMA} is not set
 *         <p>
 *         {@code <header: 24 byte><raw data: var len><update time: 8 byte>}
 *     </li>
 * </ol>
 */
