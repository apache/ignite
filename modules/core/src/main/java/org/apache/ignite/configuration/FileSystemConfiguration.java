...
public class FileSystemConfiguration {
    ...
    public FileSystemConfiguration(FileSystemConfiguration cfg) {
        ...
        dataCacheName = cfg.dataCacheName;
        ...
        metaCacheName = cfg.metaCacheName;
    ...
    /**
     * Cache name to store IGFS meta information. The name is generated by template: "igfs-[fs_name]-meta".
     *
    ...
    /**
     * Cache name to store IGFS data. The name is generated by template: "igfs-[fs_name]-data".
     *
    ...
    /**
     * Sets cache name to store IGFS meta information. The cache must be pre-configured.
     * The cache will be renamed to the {@link #getMetaCacheName()}.
     *
     * @param metaCacheName Cache name to store IGFS meta information.
     * @deprecated Since 2.0
     */
    @Deprecated public void setMetaCacheName(String metaCacheName) {
        this.metaCacheName = metaCacheName;
    }

    /**
     * Sets cache name to store IGFS data. The cache must be pre-configured.
     * The cache will be renamed to the {@link #getDataCacheName()}.
     *
     * @param dataCacheName Cache name to store IGFS data.
     * @deprecated Since 2.0
     */
    @Deprecated public void setDataCacheName(String dataCacheName) {
        this.dataCacheName = dataCacheName;
    }

    /**
     * Pre-configured cache name to store IGFS data. This cache will be renamed according with
     *
     * @return Cache name to store IGFS data.
     * @deprecated Since 2.0
     */
    @Deprecated @Nullable public String getLinkedDataCacheName() {
     ...
     * @deprecated Since 2.0
     */
    @Deprecated @Nullable public String getLinkedMetaCacheName() {
