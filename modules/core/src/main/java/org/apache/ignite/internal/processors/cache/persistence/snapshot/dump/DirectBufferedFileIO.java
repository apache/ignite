 ...
 */
public class DirectBufferedFileIO extends FileIODecorator {
    /** */
    ...
    /** */
    public DirectBufferedFileIO(FileIO fileIO, int alignment) throws IOException {
        super(fileIO);
        ...
        buf = ByteBuffer.allocateDirect(SIZE + alignment - 1).alignedSlice(alignment);
    }
    ...
    @Override public void close() throws IOException {
        ...
        ((RandomAccessFileIO)delegate).size(pos);
