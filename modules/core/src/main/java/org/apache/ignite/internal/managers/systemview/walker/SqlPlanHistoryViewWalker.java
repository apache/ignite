...
public class SqlPlanHistoryViewWalker implements SystemViewRowAttributeWalker<SqlPlanHistoryView> {
    ...
    @Override public void visitAll(AttributeVisitor v) {
        ...
        v.accept(3, "engine", String.class);
        v.accept(4, "lastStartTime", Date.class);
        v.accept(5, "plan", String.class);
    }
    ...
    @Override public void visitAll(SqlPlanHistoryView row, AttributeWithValueVisitor v) {
        ...
        v.accept(3, "engine", String.class, row.engine());
        v.accept(4, "lastStartTime", Date.class, row.lastStartTime());
        v.accept(5, "plan", String.class, row.plan());
    }
