...
public class SchemaOperationException extends IgniteCheckedException {
    ...
    /** Code: cache already supports SQL. */
    public static final int CODE_CACHE_ALREADY_SUPPORTS_SQL = 8;
    ...
    private static String message(int code, String objName) {
        switch (code) {
            ...
            case CODE_CACHE_ALREADY_SUPPORTS_SQL:
                return "Cache already supports SQL: " + objName;
