 ...
 * Get request.
 */
public class GridNearInvokeRequest extends GridCacheMessage implements GridCacheDeployable,
    ...
    @GridToStringInclude
    @GridDirectTransient
    private LinkedHashMap<KeyCacheObject, EntryProcessor> processorMap;
    ...
    /**
     * @param key Key cache object.
     * @return Entry processor.
     */
    public EntryProcessor entryProcessor(KeyCacheObject key) {
    ...
    @Override public void finishUnmarshal(GridCacheSharedContext ctx, ClassLoader ldr) throws IgniteCheckedException {
        ...
        if (keyMap == null) {
            ...
            if (entryProcessors != null && !entryProcessors.isEmpty())
                processorMap = U.newLinkedHashMap(keys.size());
            ...
            while (keysIt.hasNext()) {
                KeyCacheObject key = keysIt.next();

                keyMap.put(key, flagsIt.next());

                if (processorMap != null) {
                    processorMap.put(key, entryProcessors.get(idx));
    ...
    @Override public boolean readFrom(ByteBuffer buf, MessageReader reader) {
        ...
        return reader.afterMessageRead(GridNearInvokeRequest.class);
    }
    ...
    @Override public String toString() {
        return S.toString(GridNearInvokeRequest.class, this);
    }
}
