 ...
 */
public class BulkLoadDirectCacheWriter extends BulkLoadCacheWriter {
    /** Serialization version UID. */
    private static final long serialVersionUID = 0L;

    /** The streamer. */
    private final GridCacheAdapter streamer;
     ...
     */
    public BulkLoadDirectCacheWriter(GridCacheAdapter streamer) {
    ...
    @Override public void apply(IgniteBiTuple<?, ?> entry) {
        try {
            streamer.put(entry.getKey(), entry.getValue());
        }
