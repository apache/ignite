...
import static org.apache.ignite.internal.binary.InternalBinaryMarshaller.BOOLEAN;
import static org.apache.ignite.internal.binary.InternalBinaryMarshaller.BYTE;
import static org.apache.ignite.internal.binary.InternalBinaryMarshaller.CHAR;
import static org.apache.ignite.internal.binary.InternalBinaryMarshaller.DATE;
import static org.apache.ignite.internal.binary.InternalBinaryMarshaller.DECIMAL;
import static org.apache.ignite.internal.binary.InternalBinaryMarshaller.DOUBLE;
import static org.apache.ignite.internal.binary.InternalBinaryMarshaller.FLOAT;
import static org.apache.ignite.internal.binary.InternalBinaryMarshaller.INT;
import static org.apache.ignite.internal.binary.InternalBinaryMarshaller.LONG;
...
import static org.apache.ignite.internal.binary.InternalBinaryMarshaller.TIMESTAMP;
...
public class BinaryObjectOffheapImpl extends BinaryObjectExImpl implements Externalizable, CacheObject {
    ...
    @Override public int typeId() {
        return UNSAFE.getInt(ptr + start + InternalBinaryMarshaller.TYPE_ID_POS);
    }

    /** {@inheritDoc} */
    @Override public int length() {
        return UNSAFE.getInt(ptr + start + InternalBinaryMarshaller.TOTAL_LEN_POS);
    }

    /** {@inheritDoc} */
    @Override public int hashCode() {
        return UNSAFE.getInt(ptr + start + InternalBinaryMarshaller.HASH_CODE_POS);
    }

    /** {@inheritDoc} */
    @Override protected int schemaId() {
        return UNSAFE.getInt(ptr + start + InternalBinaryMarshaller.SCHEMA_ID_POS);
    }
    ...
    @Nullable @Override protected <F> F fieldByOrder(int order) {
        ...
        int schemaOffset = BinaryPrimitives.readInt(ptr, start + InternalBinaryMarshaller.SCHEMA_OR_RAW_OFF_POS);

        short flags = BinaryPrimitives.readShort(ptr, start + InternalBinaryMarshaller.FLAGS_POS);
