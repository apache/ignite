...
/**
 * Request to flush streamer data.
 */
public class ClientDataStreamerFlushRequest extends ClientRequest {
     ...
     * @param reader Reader.
     */
    public ClientDataStreamerFlushRequest(BinaryRawReaderEx reader) {
        super(reader);
