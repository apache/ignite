 ...
 *
 * NOTE: Following protocol applied to statically configured caches. For dynamically created caches key generated in
 * request creation.
 *
 ...
 * <li>2. Generate(but doesn't store locally!) and send keys for all statically configured groups in case the not
 * presented in metastore.</li>
