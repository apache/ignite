...
public final class GridCacheAtomicReferenceImpl<T> implements GridCacheAtomicReferenceEx<T>, Externalizable {
    ...
    private InternalCache<GridCacheInternalKey, GridCacheAtomicReferenceValue<T>> atomicView;
    ...
    public GridCacheAtomicReferenceImpl(String name,
        ...
        InternalCache<GridCacheInternalKey, GridCacheAtomicReferenceValue<T>> atomicView,
