...
public final class RecordTypes {
    ...
    static {
        ...
        DELTA_TYPE_SET.add(WALRecord.RecordType.DATA_PAGE_INSERT_REF_RECORD);
        DELTA_TYPE_SET.add(WALRecord.RecordType.DATA_PAGE_INSERT_FRAGMENT_REF_RECORD);
        DELTA_TYPE_SET.add(WALRecord.RecordType.DATA_PAGE_UPDATE_REF_RECORD);
    }
}
