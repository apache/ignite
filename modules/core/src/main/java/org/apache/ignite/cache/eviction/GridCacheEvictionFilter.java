 ...
 * calling explicit evict via {@link org.apache.ignite.cache.GridCacheEntry#evict()}.
 * If {@link #evictAllowed(org.apache.ignite.cache.GridCacheEntry)} method returns {@code false} then eviction
