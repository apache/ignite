...
public class VisorQueryInitTask extends VisorOneNodeTask<VisorQueryTaskArg, VisorEither<VisorQueryResult>> {
    /** */
        ...
        @Override protected VisorEither<VisorQueryResult> run(final VisorQueryTaskArg arg) {
            try {
                ...
                if (meta == null)
                    ...
                    return new VisorEither<>(new VisorQueryResult(nid, qryId, names, null, hasNext, duration));
                }
            }
            catch (Throwable e) {
