...
public class VisorTaskArgument<A> extends IgniteDataTransferObject {
    ...
    @Override public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        if ((hdr & MAGIC) != MAGIC) {
            throw new IOException("Failed to deserialize the Ignite Management API command argument. Unexpected Ignite" +
                " DTO message header. The input stream is malformed or was generated by an incompatible Ignite version" +
