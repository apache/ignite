...
public class GridNearLockResponse extends GridDistributedLockResponse {
     ...
     * @return DHT versions.
     */
    public GridCacheVersion[] dhtVers() {
        return dhtVers;
    }
     ...
     */
    public void dhtVers(GridCacheVersion[] dhtVers) {
     ...
     */
    public GridCacheVersion[] mappedVers() {
        return mappedVers;
    }
     ...
     */
    public void mappedVers(GridCacheVersion[] mappedVers) {
     ...
     */
    public void filterRes(boolean[] filterRes) {
