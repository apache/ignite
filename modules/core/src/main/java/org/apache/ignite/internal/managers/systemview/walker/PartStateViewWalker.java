 ...
 * {@link PartStateView} attributes walker.
 * 
 * @see PartStateView
 */
public class PartStateViewWalker implements SystemViewRowAttributeWalker<PartStateView> {
    ...
    /** {@inheritDoc} */
    @Override public void visitAll(PartStateView row, AttributeWithValueVisitor v) {
