...
public final class GridCacheAtomicStampedImpl<T, S> implements GridCacheAtomicStampedEx<T, S>, Externalizable {
    ...
    private InternalCache<GridCacheInternalKey, GridCacheAtomicStampedValue<T, S>> atomicView;
     ...
     */
    public GridCacheAtomicStampedImpl(String name, GridCacheInternalKey key, InternalCache<GridCacheInternalKey,
