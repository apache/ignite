 ...
 */
public class GridNearLockResponseV1 extends GridDistributedLockResponse implements GridNearLockResponse {
    /** */
     ...
     */
    @Override @Nullable public AffinityTopologyVersion clientRemapVersion() {
     ...
     */
    @Override public Collection<GridCacheVersion> pending() {
        return pending;
    }
     ...
     */
    @Override public void pending(Collection<GridCacheVersion> pending) {
     ...
     * @return DHT version.
     */
    @Override public GridCacheVersion mappedVersion(int idx) {
     ...
     */
    @Override public boolean filterResult(int idx) {
     ...
     */
    @Override public void addValueBytes(
    ...
    @Override public boolean readFrom(ByteBuffer buf, MessageReader reader) {
        ...
        return reader.afterMessageRead(GridNearLockResponseV1.class);
    }
    ...
    @Override public String toString() {
        return S.toString(GridNearLockResponseV1.class, this, super.toString());
    }
}
