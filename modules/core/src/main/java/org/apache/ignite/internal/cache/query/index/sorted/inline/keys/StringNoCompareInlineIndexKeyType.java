 ...
 */
public class StringNoCompareInlineIndexKeyType extends NullableInlineIndexKeyType<String> {
    ...
    /** {@inheritDoc} */
    @Override protected int put0(long pageAddr, int off, String val, int maxSize) {
        return delegate.put0(pageAddr, off, val, maxSize);
    }
    ...
    /** {@inheritDoc} */
    @Override public int compare0(long pageAddr, int off, String v) {
        return COMPARE_UNSUPPORTED;
    }

    /** {@inheritDoc} */
    @Override protected int inlineSize0(String key) {
