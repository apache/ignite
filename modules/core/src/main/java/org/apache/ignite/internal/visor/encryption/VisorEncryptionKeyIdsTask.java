...
public class VisorEncryptionKeyIdsTask extends VisorCacheGroupEncryptionTask<List<Integer>> {
    ...
    /** {@inheritDoc} */
    @Override protected VisorJob<EncryptionCacheGroupArg, VisorSingleFieldDto<List<Integer>>> job(
    ...
    private static class VisorEncryptionKeyIdsJob extends VisorReencryptionBaseJob<List<Integer>> {
         ...
         */
        protected VisorEncryptionKeyIdsJob(@Nullable EncryptionCacheGroupArg arg, boolean debug) {
            super(arg, debug);
        }
