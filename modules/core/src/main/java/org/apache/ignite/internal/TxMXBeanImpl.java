...
public class TxMXBeanImpl implements TxMXBean {
    ...
    /** {@inheritDoc} */
    @Override public long getTxCommittedNumber() {
        return gridKernalCtx.cache().context().txMetrics().txCommits();
    }

    /** {@inheritDoc} */
    @Override public long getTxRolledBackNumber() {
        return gridKernalCtx.cache().context().txMetrics().txRollbacks();
    }

    /** {@inheritDoc} */
    @Override public long getTxHoldingLockNumber() {
        return 0; // TODO
    }
    ...
    /** {@inheritDoc} */
    @Override public long getOwnerTxNumber() {
        return nearTxNum();
    }
