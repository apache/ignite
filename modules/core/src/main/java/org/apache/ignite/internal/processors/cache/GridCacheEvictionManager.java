...
public class GridCacheEvictionManager extends GridCacheManagerAdapter {
    ...
    public void printStats() {
        X.println("Eviction stats [grid=" + cctx.instanceName() + ", cache=" + cctx.cache().name() +
    ...
    @Override public void printMemoryStats() {
        X.println(">>> ");
        X.println(">>> Eviction manager memory stats [grid=" + cctx.instanceName() + ", cache=" + cctx.name() + ']');
    ...
    private class BackupWorker extends GridWorker {
        ...
        private BackupWorker() {
            super(cctx.instanceName(), "cache-eviction-backup-worker", GridCacheEvictionManager.this.log);
