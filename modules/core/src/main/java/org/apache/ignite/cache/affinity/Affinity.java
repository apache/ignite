 ...
 * {@link Ignite#affinity(String) Ignite#affinity(cacheName)} method.
 * <p>
...
public interface Affinity<K> {
     ...
     *
     * @return Number of cache partitions or <code>0</code> if cache doesn't exist.
     ...
     * @return Partition id or <code>-1</code> if cache doesn't exist.
     * @see AffinityFunction
     * @see org.apache.ignite.configuration.CacheConfiguration#getAffinity()
     * @see org.apache.ignite.configuration.CacheConfiguration#setAffinity(AffinityFunction)
     */
     ...
     * If cache doesn't exist it returns {@code false}.
     *
     ...
     *      If cache doesn't exist it returns empty {@code int} array.
     * @see AffinityFunction
     * @see org.apache.ignite.configuration.CacheConfiguration#getAffinity()
     * @see org.apache.ignite.configuration.CacheConfiguration#setAffinity(AffinityFunction)
     */
     ...
     *      key as passed in). If cache doesn't exist it returns {@code null}.
     */
    @Nullable public Object affinityKey(K key);
     ...
     *      If cache doesn't exist it returns empty map.
     */
     ...
     *      always first or empty collection if there are no alive nodes for this cache.
     *      If cache doesn't exist it returns empty collection.
     */
     ...
     * @return Primary node for the given partition or {@code null} if cache doesn't exist.
     * @see AffinityFunction
     * @see org.apache.ignite.configuration.CacheConfiguration#getAffinity()
     * @see org.apache.ignite.configuration.CacheConfiguration#setAffinity(AffinityFunction)
     */
    @Nullable public ClusterNode mapPartitionToNode(int part);

    /**
     * Gets primary nodes for the given partitions.
     *
     * @param parts Partition ids.
     * @return Mapping of given partitions to their primary nodes. If cache doesn't exist it returns empty map.
     * @see AffinityFunction
     * @see org.apache.ignite.configuration.CacheConfiguration#getAffinity()
     * @see org.apache.ignite.configuration.CacheConfiguration#setAffinity(AffinityFunction)
     */
     ...
     *      always first. If cache doesn't exist it returns empty collection.
     */
