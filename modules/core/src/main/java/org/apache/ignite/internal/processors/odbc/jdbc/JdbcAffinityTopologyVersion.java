...
public class JdbcAffinityTopologyVersion {
     ...
     */
    public JdbcAffinityTopologyVersion(AffinityTopologyVersion version, boolean changed) {
    ...
    public AffinityTopologyVersion getVersionIfChanged() {
    ...
    @Override public String toString() {
        return S.toString(JdbcAffinityTopologyVersion.class, this);
    }
}
