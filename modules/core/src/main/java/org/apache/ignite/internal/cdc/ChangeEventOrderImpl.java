 ...
 */
public class ChangeEventOrderImpl implements ChangeEventOrder {
    /** */
     ...
     */
    public ChangeEventOrderImpl(int topVer, int nodeOrderDrId, long order) {
        this.topVer = topVer;
    ...
    /** {@inheritDoc} */
    @Override public int topVer() {
        return topVer;
    }

    /** {@inheritDoc} */
    @Override public int nodeOrderDrId() {
    ...
    @Override public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        ChangeEventOrderImpl order1 = (ChangeEventOrderImpl)o;
    ...
    @Override public String toString() {
        return S.toString(ChangeEventOrderImpl.class, this);
    }
}
