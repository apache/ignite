...
public class GridDistributedTxFinishRequest extends GridDistributedBaseMessage implements IgniteTxStateAware {
    ...
    @Order(19)
    private CacheWriteSynchronizationModeMessage syncMode;
    ...
    public GridDistributedTxFinishRequest(
        ...
        this.sys = sys;
        this.plc = plc;
        this.syncMode = new CacheWriteSynchronizationModeMessage(syncMode);
    ...
    /**
     * @return Transaction write synchronization mode message (can be null is message sent from old nodes).
     */
    public final CacheWriteSynchronizationModeMessage syncMode() {
        return syncMode;
    }

    /**
     * @param syncMode Transaction write synchronization mode message.
     */
    public void syncMode(CacheWriteSynchronizationModeMessage syncMode) {
    ...
    public boolean replyRequired() {
        assert syncMode != null && syncMode.value() != null;

        return syncMode.value() == FULL_SYNC;
    }
