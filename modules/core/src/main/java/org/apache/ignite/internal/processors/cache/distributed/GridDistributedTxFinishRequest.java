...
public class GridDistributedTxFinishRequest extends GridDistributedBaseMessage implements IgniteTxStateAware {
    ...
    /** Write synchronization mode ordinal. */
    @Order(value = 19, method = "syncModeOrdinal")
    private byte syncModeOrd = -1;
    ...
    public GridDistributedTxFinishRequest(
        ...
        syncModeOrd = (byte)syncMode.ordinal();
    ...
    /**
     * @return Sync mode ordinal.
     */
    public byte syncModeOrdinal() {
        return syncModeOrd;
    }

    /**
     * @param syncModeOrd Sync mode ordinal.
     */
    public void syncModeOrdinal(byte syncModeOrd) {
        this.syncModeOrd = syncModeOrd;
