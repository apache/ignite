...
import static org.apache.ignite.internal.processors.cache.distributed.dht.preloader.GridDhtPartitionsExchangeFuture.ExchangeType.CLIENT;
    ...
    @Override public boolean afterExchange(GridDhtPartitionsExchangeFuture exchFut) {
        ...
        try {
            ...
            try {
                ...
                if (!ctx.localNode().isClient() && exchFut.exchangeType() == CLIENT) {
                    for (int p = 0; p < partitions; p++) {
