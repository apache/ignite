...
/**
 * Message for {@link DistributedMetaStorageHistoryItem} which is a persistent {@link IgniteDataTransferObject} stored
 * by {@link MetaStorage} with dedicated DTO-serializer.
 *
...
public class DistributedMetaStorageHistoryItemMessage implements Message {
    ...
    /** @return {@link Message} wrap array for {@link DistributedMetaStorageHistoryItem} array. The history item is a persistent
     * {@link IgniteDataTransferObject} stored by {@link MetaStorage} with dedicated code-generated serializer.
     * Thus, we keep a {@link Message} wrap for them to transfer across the cluster. */
