 ...
 */
public class LongInlineIndexKeyType extends NullableInlineIndexKeyType<Long> {
    /** Constructor. */
    ...
    /** {@inheritDoc} */
    @Override protected int put0(long pageAddr, int off, Long val, int maxSize) {
    ...
    /** {@inheritDoc} */
    @Override protected Long get0(long pageAddr, int off) {
        // +1 shift after type
        return PageUtils.getLong(pageAddr, off + 1);
    }

    /** {@inheritDoc} */
    @Override public int compare0(long pageAddr, int off, Long v) {
        long val1 = PageUtils.getLong(pageAddr, off + 1);

        return Integer.signum(Long.compare(val1, v));
    }
