 ...
 */
public class MvccLastCommittedSearchClosure implements MvccTreeClosure {
    /** */
    ...
    public MvccLastCommittedSearchClosure(GridCacheContext cctx, KeyCacheObject key) {
        this.cctx = cctx;
        this.key = key;
    }
    ...
    @Override public boolean apply(BPlusTree<CacheSearchRow, CacheDataRow> tree, BPlusIO<CacheSearchRow> io,
        ...
        byte txState = MvccUtils.state(cctx, rowCrdVer, rowCntr, rowOpCntr);

        // t0d0 removed version
    ...
    @Override public String toString() {
        return S.toString(MvccLastCommittedSearchClosure.class, this);
    }
}
