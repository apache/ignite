...
public class GridUnsafeDataInput extends InputStream implements GridDataInput {
    ...
    @Override public short[] readShortArray() throws IOException {
        ...
        GridUnsafe.copyMemory(buf, BYTE_ARR_OFF + offset(bytesToCp), arr, SHORT_ARR_OFF, bytesToCp);
    ...
    @Override public int[] readIntArray() throws IOException {
        ...
        GridUnsafe.copyMemory(buf, BYTE_ARR_OFF + offset(bytesToCp), arr, INT_ARR_OFF, bytesToCp);
    ...
    @Override public double[] readDoubleArray() throws IOException {
        ...
        GridUnsafe.copyMemory(buf, BYTE_ARR_OFF + offset(bytesToCp), arr, DOUBLE_ARR_OFF, bytesToCp);
    ...
    @Override public char[] readCharArray() throws IOException {
        ...
        GridUnsafe.copyMemory(buf, BYTE_ARR_OFF + offset(bytesToCp), arr, CHAR_ARR_OFF, bytesToCp);
    ...
    @Override public long[] readLongArray() throws IOException {
        ...
        GridUnsafe.copyMemory(buf, BYTE_ARR_OFF + offset(bytesToCp), arr, LONG_ARR_OFF, bytesToCp);
    ...
    @Override public float[] readFloatArray() throws IOException {
        ...
        GridUnsafe.copyMemory(buf, BYTE_ARR_OFF + offset(bytesToCp), arr, FLOAT_ARR_OFF, bytesToCp);
    ...
    @Override public short readShort() throws IOException {
        ...
        return GridUnsafe.getShortAligned(buf, BYTE_ARR_OFF + offset(2));
    }
    ...
    @Override public char readChar() throws IOException {
        ...
        char v = GridUnsafe.getCharAligned(buf, BYTE_ARR_OFF + off);
    ...
    @Override public int readInt() throws IOException {
        ...
        return GridUnsafe.getIntAligned(buf, BYTE_ARR_OFF + offset(4));
    }
    ...
    @Override public long readLong() throws IOException {
        ...
        return GridUnsafe.getLongAligned(buf, BYTE_ARR_OFF + offset(8));
    }
    ...
    @Override public float readFloat() throws IOException {
        ...
        return GridUnsafe.getFloatAligned(buf, BYTE_ARR_OFF + offset(4));
    }
    ...
    @Override public double readDouble() throws IOException {
        ...
        return GridUnsafe.getDoubleAligned(buf, BYTE_ARR_OFF + offset(8));
    }
