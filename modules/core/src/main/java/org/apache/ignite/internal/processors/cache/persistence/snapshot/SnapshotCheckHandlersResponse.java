...
public class SnapshotCheckHandlersResponse implements Message {
    ...
    @Order(0)
    private Map<String, SnapshotCheckHandlersNodeResponse> perMetaResults;
    ...
    /** */
    public void perMetaResults(Map<String, SnapshotCheckHandlersNodeResponse> perMetaResults) {
        this.perMetaResults = perMetaResults;
    }

    /** */
    public Map<String, SnapshotCheckHandlersNodeResponse> perMetaResults() {
