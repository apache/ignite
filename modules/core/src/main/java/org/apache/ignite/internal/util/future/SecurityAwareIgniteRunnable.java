...
/** */
public class SecurityAwareIgniteRunnable extends AbstractSecurityAwareWrapper<IgniteRunnable> implements IgniteRunnable {
    /** */
    private static final long serialVersionUID = 0L;

    /** */
    private SecurityAwareIgniteRunnable(IgniteSecurity security, IgniteRunnable delegate) {
