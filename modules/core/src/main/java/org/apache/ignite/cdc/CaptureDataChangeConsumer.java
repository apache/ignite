 ...
 * <ul>
 *     <li>Start of the consumer {@link #start(IgniteConfiguration, MetricRegistry, IgniteLogger)}.</li>
...
public interface CaptureDataChangeConsumer {
     ...
     * @param log Logger.
     */
    void start(IgniteConfiguration configuration, MetricRegistry metrics, IgniteLogger log);
    ...
    /**
     * Stops the consumer.
     * This methods can be invoked only after {@link #start(IgniteConfiguration, MetricRegistry, IgniteLogger)}.
     */
    void stop();
}
