...
public class GridNearAtomicSingleUpdateFuture extends GridNearAtomicAbstractUpdateFuture {
    ...
    private GridNearAtomicUpdateRequestInt req;
    ...
    @Override public boolean onNodeLeft(UUID nodeId) {
        ...
        GridNearAtomicUpdateRequestInt req;
     ...
     */
    private void updateNear(GridNearAtomicUpdateRequestInt req, GridNearAtomicUpdateResponse res) {
        assert nearEnabled;
    ...
    private GridNearAtomicAbstractUpdateRequest mapSingleUpdate(AffinityTopologyVersion topVer,
        ...
        if (canUseSingleRequest(primary)) {
            ...
            req = new GridNearAtomicUpdateRequest(
                cctx.cacheId(),
                primary.id(),
                futVer,
                false,
