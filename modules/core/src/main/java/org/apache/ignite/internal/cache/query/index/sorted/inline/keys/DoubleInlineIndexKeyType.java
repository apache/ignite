 ...
 */
public class DoubleInlineIndexKeyType extends NullableInlineIndexKeyType<Double> {
    /** */
    ...
    /** {@inheritDoc} */
    @Override public int compare0(long pageAddr, int off, Double v) {
        double val1 = Double.longBitsToDouble(PageUtils.getLong(pageAddr, off + 1));

        return Integer.signum(Double.compare(val1, v));
    }

    /** {@inheritDoc} */
    @Override protected int put0(long pageAddr, int off, Double val, int maxSize) {
    ...
    /** {@inheritDoc} */
    @Override protected Double get0(long pageAddr, int off) {
        return Double.longBitsToDouble(PageUtils.getLong(pageAddr, off + 1));
    }
