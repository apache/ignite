...
public class GridCacheOffheapManager extends IgniteCacheOffheapManagerImpl implements DbCheckpointListener {
    ...
    private void saveStoreMetadata(
        ...
        if (rowStore0 != null) {
            rowStore0.freeList().saveMetadata();
    ...
    long freeSpace() {
        ...
        for (CacheDataStore store : partDataStores.values()) {
            ...
            FreeList freeList = ((GridCacheDataStore)store).freeList;
    ...
    private static class PartitionCacheFreeList extends CacheFreeList {
        ...
        PartitionCacheFreeList(CacheGroupContext grp, String freeListName, int partId, RootPage reuseRoot)
            ...
            super(grp.groupId(),
                ...
                grp.shared().diagnostic().pageLockTracker().createPageLockTracker(freeListName));
        ...
        private CacheDataStore init0(boolean checkExists) throws IgniteCheckedException {
            ...
            if (!init.get() && init.compareAndSet(false, true)) {
                ...
                try {
                    ...
                    LazyCacheFreeList freeList = new LazyCacheFreeList() {
                        @Override protected CacheFreeList createDelegate(boolean create) throws IgniteCheckedException {
                            boolean lock = false;
