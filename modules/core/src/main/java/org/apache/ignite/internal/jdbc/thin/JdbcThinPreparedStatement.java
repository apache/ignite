...
public class JdbcThinPreparedStatement extends JdbcThinStatement implements PreparedStatement {
    ...
    @Override public ResultSet executeQuery() throws SQLException {
        ...
        if (rs == null)
            throw igniteSqlException("The query isn't SELECT query: " + sql, IgniteQueryErrorCode.STMT_TYPE_MISMATCH);
    ...
    @Override public ResultSet executeQuery(String sql) throws SQLException {
        throw igniteSqlException("The method 'executeQuery(String)' is called on PreparedStatement instance.",
    ...
    @Override public int executeUpdate() throws SQLException {
        ...
        if (res == -1)
            throw igniteSqlException("The query is not DML statement: " + sql, IgniteQueryErrorCode.STMT_TYPE_MISMATCH);
    ...
    @Override public int executeUpdate(String sql) throws SQLException {
        throw igniteSqlException("The method 'executeUpdate(String)' is called on PreparedStatement instance.",
            IgniteQueryErrorCode.STMT_TYPE_MISMATCH);
    }

    /** {@inheritDoc} */
    @Override public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        throw igniteSqlException("The method 'executeUpdate(String, int)' is called on PreparedStatement instance.",
            IgniteQueryErrorCode.STMT_TYPE_MISMATCH);
    }
    ...
    @Override public int executeUpdate(String sql, String columnNames[]) throws SQLException {
        throw igniteSqlException("The method 'executeUpdate(String, String[])' is called on PreparedStatement " +
            "instance.", IgniteQueryErrorCode.STMT_TYPE_MISMATCH);
    }
    ...
    @Override public boolean execute(String sql) throws SQLException {
        throw igniteSqlException("The method 'execute(String)' is called on PreparedStatement instance.",
            IgniteQueryErrorCode.STMT_TYPE_MISMATCH);
    }
    ...
    @Override public void addBatch(String sql) throws SQLException {
        throw igniteSqlException("The method 'addBatch(String)' is called on PreparedStatement instance.",
            IgniteQueryErrorCode.STMT_TYPE_MISMATCH);
    }
    ...
    @Override public <T> T unwrap(Class<T> iface) throws SQLException {
        if (!isWrapperFor(iface))
            throw igniteSqlException("Prepared statement is not a wrapper for " + iface.getName());
    ...
    private void setArgument(int paramIdx, Object val) throws SQLException {
        ...
        if (val != null && !SqlListenerUtils.isPlainType(val.getClass()))
            throw igniteSqlException("Parameter type is unsupported. [cls=" + val.getClass() + ']',
                IgniteQueryErrorCode.UNSUPPORTED_PARAM_TYPE);

        if (paramIdx < 1)
            throw igniteSqlException("Parameter index is invalid: " + paramIdx);
