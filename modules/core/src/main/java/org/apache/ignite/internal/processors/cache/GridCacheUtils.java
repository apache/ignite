...
//    }
     ...
     * @throws IllegalArgumentException In case the name is not valid.
     */
    public static void validateCacheNames(@NotNull Collection<String> cacheNames) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException In case the name is not valid.
     */
    public static void validateCfgCacheNames(@NotNull Collection<CacheConfiguration> ccfgs) throws IllegalArgumentException {
