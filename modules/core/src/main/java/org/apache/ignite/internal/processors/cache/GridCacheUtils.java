...
//    }
     ...
     */
    public static <K, V> void inTx(InternalCache<K, V> cache, TransactionConcurrency concurrency,
        TransactionIsolation isolation, IgniteInClosureX<InternalCache<K ,V>> clo) throws IgniteCheckedException {
