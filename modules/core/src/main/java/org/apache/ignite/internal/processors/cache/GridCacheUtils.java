...
//    }
     ...
     */
    public static Map<String, String> validateKeyConfiguration(
    ...
    public static void validateKeyConfiguration(
        ...
        Map<String, String> rmtAffinityKeys = CU.validateKeyConfiguration(groupName, cacheName, rmtCacheKeyCfgs, log, fail);

        Map<String, String> locAffinityKey = CU.validateKeyConfiguration(groupName, cacheName, locCacheKeyCfgs, log, fail);
    ...
    public static void initializeConfigDefaults(IgniteLogger log, CacheConfiguration cfg,
        ...
        validateKeyConfiguration(cfg.getGroupName(), cfg.getName(), cfg.getKeyConfiguration(), log, true);
