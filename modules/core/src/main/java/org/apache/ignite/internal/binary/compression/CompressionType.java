...
public enum CompressionType {
    ...
    /** */
    CUSTOM(BinaryWriteMode.COMPRESSED_CUSTOM);
    ...
    /**
     * @param typeId Type id of {@link BinaryWriteMode}
     * @return CompressionType which mapping with type id.
     */
