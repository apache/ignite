...
/**
 * Provides serialization operations for {@link TcpDiscoveryIoSession}.
 * Encapsulates {@link MessageWriter}, {@link MessageReader} and message buffer.
 * <b>NOTE:</b> Is not thread-safe! Should not be shared between threads.
 * <p>
 ...
 */
public class TcpDiscoveryIoSessionSerializer {
     ...
     */
    TcpDiscoveryIoSessionSerializer(TcpDiscoverySpi spi) {
        this.spi = spi;
    ...
    /**
     * Writes a discovery message to the specified output stream.
     *
     * @param msg Message to send to the remote node.
     * @param out Output stream.
     * @throws IgniteCheckedException If serialization fails.
     */
    void writeMessage(TcpDiscoveryAbstractMessage msg, OutputStream out) throws IgniteCheckedException, IOException {
     ...
     */
    <T> T readMessage(CompositeInputStream in) throws IgniteCheckedException, IOException {
     ...
     */
    static class CompositeInputStream extends BufferedInputStream {
        ...
        CompositeInputStream(InputStream srcIs) {
            super(srcIs);
        }
