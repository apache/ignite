...
/** */
public class SecurityAwareOutClosure<T> extends AbstractSecurityAwareWrapper<IgniteOutClosure<T>> implements IgniteOutClosure<T> {
    /** */
    private static final long serialVersionUID = 0L;

    /** */
    private SecurityAwareOutClosure(IgniteSecurity security, IgniteOutClosure<T> delegate) {
