        ...
        private synchronized void partitionDone(UUID nodeId, int p, boolean updateState) {
            ...
            if (parts.getValue().isEmpty()) {
                ...
                U.log(log, "Completed " + ((remainingRoutines == 0 ? "(final) " : "") +
                    ...
                    ", time=" + (U.currentTimeMillis() - parts.getKey()) + " ms]"));
