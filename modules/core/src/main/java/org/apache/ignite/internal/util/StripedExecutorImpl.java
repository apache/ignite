 ...
 * Striped executor.
 */
public class StripedExecutorImpl implements StripedExecutor {
    /** Stripes. */
     ...
     * @param log Logger.
     */
    public StripedExecutorImpl(int cnt, String igniteInstanceName, String poolName, final IgniteLogger log) {
     ...
     */
    public StripedExecutorImpl(int cnt, String igniteInstanceName, String poolName, final IgniteLogger log, boolean stealTasks) {
    ...
    @Override public String toString() {
        return S.toString(StripedExecutorImpl.class, this);
    }
