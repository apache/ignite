...
public interface FilePageStoreFactory {
     ...
     */
    default PageStore createPageStore(byte type, File file, LongAdderMetricImpl allocatedTracker)
     ...
     * @throws IgniteCheckedException if failed
     */
    PageStore createPageStore(byte type, IgniteOutClosure<Path> pathProvider, LongAdderMetricImpl allocatedTracker)
        throws IgniteCheckedException;
}
