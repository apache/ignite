...
public interface FilePageStoreFactory {
     ...
     */
    default FilePageStore createPageStore(byte type, File file, AllocatedPageTracker allocatedTracker)
     ...
     * @throws IgniteCheckedException if failed
     */
    FilePageStore createPageStore(byte type, IgniteOutClosure<Path> pathProvider, AllocatedPageTracker allocatedTracker)
        throws IgniteCheckedException;
}
