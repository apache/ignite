...
public class IgniteConfiguration {
    ...
    /**
     * Sets maximum inactivity period for system worker. When this value is exceeded, worker is considered blocked with
     * consequent critical failure handler invocation.
     *
