...
public interface ClusterGroupEx extends ClusterGroup {
     ...
     * @return Cluster group.
     */
    public ClusterGroup forCacheNodes(String cacheName, boolean affNodes, boolean nearNodes,
        boolean clientNodes);
     ...
     * @return Cluster group.
     */
    public ClusterGroup forIgfsMetadataDataNodes(@Nullable String igfsName, String metaCacheName);
}