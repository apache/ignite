...
public class ClientMessageHolder {
    ...
    /** */
    private final Map<MessageSerializationContext, byte[]> bytesByCtx = new ConcurrentHashMap<>(1);
    ...
    /** */
    public byte @Nullable [] messageBytes(MessageSerializationContext ctx) {
        return bytesByCtx.get(ctx);
    }

    /** */
    public void serialize(TcpDiscoveryMessageSerializer ser, MessageSerializationContext ctx) throws IgniteCheckedException {
