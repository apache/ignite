...
/** */
public class PerformanceStatisticsStartCommand implements ComputeCommand<IgniteDataTransferObject, String> {
    /** {@inheritDoc} */
    ...
    /** {@inheritDoc} */
    @Override public Class<PerformanceStatisticsStartCommandArg> argClass() {
