 ...
 */
public class DistributedProcessHandler<I extends Serializable, R extends Serializable> {
    /** Kernal context. */
     ...
     */
    public DistributedProcessHandler(GridKernalContext ctx, DistributedProcesses type,
        DistributedProcessFactory<I, R> factory) {
        this.ctx = ctx;
        this.type = type;
    ...
    private class Process {
        ...
        private volatile DistributedProcess<I, R> instance;
