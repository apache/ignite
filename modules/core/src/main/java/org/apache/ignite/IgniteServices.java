...
public interface IgniteServices extends IgniteAsyncSupport {
    ...
    /**
     * Creates configuration for a cluster-wide singleton service. Ignite will guarantee that there is always
     ...
     * {@link #multipleConfiguration(String, org.apache.ignite.services.Service, int, int)
     * multiple(name, svc, 1, 1)} method.
     *
     * @param name Service name.
     * @param svc Service instance.
     * @return Configuration of cluster singleton service.
     */
    public ServiceConfiguration clusterSingletonConfiguration(String name, Service svc);

    /**
     * Creates configuration for a per-node singleton service. Ignite will guarantee that there is always
     ...
     * This method is analogous to calling
     * {@link #multipleConfiguration(String, org.apache.ignite.services.Service, int, int)
     * multiple(name, svc, 0, 1)} method.
     *
     * @param name Service name.
     * @param svc Service instance.
     * @return Configuration of node singleton service.
     */
    public ServiceConfiguration nodeSingletonConfiguration(String name, Service svc);

    /**
     * Creates configuration for one instance of this service on the primary node for a given affinity key.
     ...
     * @return Configuration of multi-instance service.
     */
    public ServiceConfiguration multipleConfiguration(String name, Service svc, int totalCnt, int maxPerNodeCnt);
