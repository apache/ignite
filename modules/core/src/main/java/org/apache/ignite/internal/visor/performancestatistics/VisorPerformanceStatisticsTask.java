...
public class VisorPerformanceStatisticsTask extends VisorOneNodeTask<EmptyArg, String> {
    ...
    /** */
    private static class VisorPerformanceStatisticsJob extends VisorJob<EmptyArg, String> {
        /** */
        private static final long serialVersionUID = 0L;
         ...
         */
        protected VisorPerformanceStatisticsJob(EmptyArg arg, boolean debug) {
            super(arg, debug);
        }
