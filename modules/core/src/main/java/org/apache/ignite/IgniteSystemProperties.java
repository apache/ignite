...
public final class IgniteSystemProperties {
    ...
    /**
     * The master key name that the node will use during the recovery procedure.
     * <p>
     * If a node was unavailable during a master key change process it won't be able to join to cluster with old the
     * master key name. Set up this property to re-encrypt cache keys on startup and join to cluster with the valid
     * master key name.
     */
