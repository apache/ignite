...
public final class IgniteSystemProperties {
    ...
    /** Comma separated list of keys that {@link DistributedMetaStorage} will skip on start. */
    @SystemProperty(value = "Comma separated list of keys that Distribute MetaStorage will skip on start",
        type = String.class)
