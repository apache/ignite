...
public interface IgniteCompute extends IgniteAsyncSupport {
     ...
     * @param affKey Affinity key.
     * @param job Job which will be co-located on the node with given affinity key.
     * @return Future for affinity run.
     * @throws IgniteException If job failed.
     */
    public ComputeTaskFuture<?> affinityRunAsync(@Nullable String cacheName, Object affKey, IgniteRunnable job)
     ...
     * @throws IgniteException If job failed.
     */
    public ComputeTaskFuture<?> affinityRunAsync(@NotNull Collection<String> cacheNames, Object affKey, IgniteRunnable job)
        throws IgniteException;
     ...
     * @throws IgniteException If job failed.
     */
    public ComputeTaskFuture<?> affinityRunAsync(@NotNull Collection<String> cacheNames, int partId, IgniteRunnable job)
        throws IgniteException;
     ...
     * @param affKey Affinity key.
     * @param job Job which will be co-located on the node with given affinity key.
     * @return Future for affinity call.
     * @throws IgniteException If job failed.
     */
     ...
     * @throws IgniteException If job failed.
     */
    public <R> ComputeTaskFuture<R> affinityCallAsync(@NotNull Collection<String> cacheNames, Object affKey, IgniteCallable<R> job)
        throws IgniteException;
     ...
     *      class name is used as task name.
     * @param arg Optional argument of task execution, can be {@code null}.
     * @return Future for task execution.
     * @throws IgniteException If task failed.
     */
     ...
     *
     * @param job Job to broadcast to all cluster group nodes.
     * @return Future for broadcast execution.
     * @throws IgniteException If job failed.
     */
    public ComputeTaskFuture<?> broadcastAsync(IgniteRunnable job) throws IgniteException;
...
\     *
     ...
     * @throws IgniteException If execution failed.
     */
    public <R, T> ComputeTaskFuture<Collection<R>> broadcastAsync(IgniteClosure<T, R> job, @Nullable T arg) throws IgniteException;
     ...
     *
     * @param job Job closure to execute.
     * @return Future for job.
     * @throws IgniteException If execution failed.
     */
    public ComputeTaskFuture<?> runAsync(IgniteRunnable job) throws IgniteException;
     ...
     *
     * @param jobs Collection of jobs to execute.
     * @return Future for jobs.
     * @throws IgniteException If execution failed.
     */
    public ComputeTaskFuture<?> runAsync(Collection<? extends IgniteRunnable> jobs) throws IgniteException;
     ...
     * @throws IgniteException If execution failed.
     */
    public <R> ComputeTaskFuture<Collection<R>> callAsync(Collection<? extends IgniteCallable<R>> jobs) throws IgniteException;
     ...
     * @throws IgniteException If execution failed.
     */
    public <R1, R2> ComputeTaskFuture<R2> callAsync(Collection<? extends IgniteCallable<R1>> jobs, IgniteReducer<R1, R2> rdc)
        throws IgniteException;
