...
public interface IgniteCompute extends IgniteAsyncSupport {
    ...
    public void affinityRun(@NotNull String cacheName, Object affKey, IgniteRunnable job) throws IgniteException;
     ...
     * @throws IgniteException If job failed.
     */
    public IgniteFuture<Void> affinityRunAsync(@NotNull String cacheName, Object affKey, IgniteRunnable job)
     ...
     */
    @IgniteAsyncSupported
    public <R> R affinityCall(@NotNull String cacheName, Object affKey, IgniteCallable<R> job) throws IgniteException;
     ...
     * @throws IgniteException If job failed.
     */
    public <R> IgniteFuture<R> affinityCallAsync(@NotNull String cacheName, Object affKey, IgniteCallable<R> job)
        throws IgniteException;
