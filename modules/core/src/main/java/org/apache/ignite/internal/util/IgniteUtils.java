...
public abstract class IgniteUtils {
    ...
    public static final byte[] IGNITE_HEADER = IgniteByteUtils.intToBytes(0x00004747);
    ...
    public static void igniteUuidToBytes(IgniteUuid uuid, byte[] out, int off) {
        ...
        IgniteByteUtils.longToBytes(uuid.globalId().getMostSignificantBits(), out, off);
        IgniteByteUtils.longToBytes(uuid.globalId().getLeastSignificantBits(), out, off + 8);
