            ...
            for (FileSystemConfiguration igfsCfg : igfsCfgs) {
                ...
                if (ccfgMeta == null) {
                    if(metaCacheName != null)
                        effectiveMetaCacheCfg = config(cfg, metaCacheName);
                    else {
                ...
                if (ccfgData == null) {
                    if(dataCacheName != null)
                        effectiveDataCacheCfg = config(cfg, dataCacheName);
                    else {
