...
public interface IgniteEx extends Ignite {
     ...
     * The {@link org.apache.ignite.internal.processors.cache.InternalCache#name()} method on default instance returns <tt>null</tt>.
     *
     * @param <K> Key type.
     * @param <V> Value type.
     ...
     */
    public Collection<InternalCache<?, ?>> cachesx(@Nullable IgnitePredicate<? super InternalCache<?, ?>>... p);
