...
public class IgfsMetaManager extends IgfsManager {
    ...
    protected static final Comparator<IgniteUuid> PATH_ID_SORTING_COMPARATOR
    ...
    /** IGFS configuration. */
    protected FileSystemConfiguration cfg;
    ...
    protected IgniteInternalCache<IgniteUuid, IgfsFileInfo> id2InfoPrj;
    ...
    /** Delete worker. */
    protected volatile IgfsDeleteWorker delWorker;
     ...
     */
    public @Nullable IgfsFileInfo lock(IgniteUuid fileId, boolean del) throws IgniteCheckedException {
        if (busyLock.enterBusy()) {
            try {
                validTxState(false);
                ...
                try (IgniteInternalTx tx = startTx()) {
                    ...
                    IgfsFileInfo newInfo = invokeLock(fileId, del);
     ...
     * @return Lock ID.
     */
    protected final IgniteUuid createFileLockId(boolean del) {
        if (del)
    ...
    IgniteUuid format() throws IgniteCheckedException {
        if (busyLock.enterBusy()) {
            try {
                ...
                try (final IgniteInternalTx tx = startTx()) {
     ...
     * @throws IgniteCheckedException If failed.
     */
    protected final IgfsFileInfo invokeLock(IgniteUuid id, boolean del) throws IgniteCheckedException {
        return invokeAndGet(id, new FileLockProcessor(createFileLockId(del)));
    }
     ...
     */
    protected static IgniteCheckedException fsException(String msg) {
     ...
     */
    @GridInternal
    protected static final class ListingAddProcessor implements EntryProcessor<IgniteUuid, IgfsFileInfo, Void>,
        Externalizable {
        /** */
        private static final long serialVersionUID = 0L;
         ...
         */
        protected ListingAddProcessor(String fileName, IgfsListingEntry entry) {
     ...
     */
    @GridInternal
    protected static final class UpdatePathProcessor implements EntryProcessor<IgniteUuid, IgfsFileInfo, Void>,
        Externalizable {
        /** */
        private static final long serialVersionUID = 0L;
         ...
         * @param path Path.
         */
        protected UpdatePathProcessor(IgfsPath path) {
            this.path = path;
        }
    ...
    /**
     * Throws an exception if the path to be created is a directory.
     *
     * @param append Append flag.
     * @param path The path.
     */
    protected final void throwExists(boolean append, IgfsPath path) {
    ...
    /** File chain builder. */
    protected class DirectoryChainBuilder {
     ...
     */
    protected static class FileCreateProcessor implements EntryProcessor<IgniteUuid, IgfsFileInfo, IgfsFileInfo>,
        Externalizable {
        /** */
        private static final long serialVersionUID = 0L;
     ...
     */
    protected static class FileLockProcessor implements EntryProcessor<IgniteUuid, IgfsFileInfo, IgfsFileInfo>,
        Externalizable {
        /** */
        private static final long serialVersionUID = 0L;
     ...
     */
    protected static class FileReserveSpaceProcessor implements EntryProcessor<IgniteUuid, IgfsFileInfo, IgfsFileInfo>,
        Externalizable {
        /** */
        private static final long serialVersionUID = 0L;
         ...
         *
         * @param space Space.
         * @param affRange The affinity range.
         */
     ...
     */
    protected static class UpdateTimesProcessor implements EntryProcessor<IgniteUuid, IgfsFileInfo, Void>,
        Externalizable {
        /** */
        private static final long serialVersionUID = 0L;
