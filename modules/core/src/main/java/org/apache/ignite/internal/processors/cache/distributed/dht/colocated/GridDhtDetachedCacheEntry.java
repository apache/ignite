...
public class GridDhtDetachedCacheEntry extends GridDistributedCacheEntry {
    ...
    /** {@inheritDoc} */
    @Override protected void logUpdate(GridCacheOperation op, CacheObject val, GridCacheVersion writeVer, long expireTime,
        long updCntr, boolean p2pEnabled, IgniteUuid keyClsLdrId, IgniteUuid valClsLdrId) throws IgniteCheckedException {
