...
public class SnapshotRestoreTask extends SnapshotOneNodeTask<SnapshotRestoreCommandArg, String> {
    ...
    /** */
    private static class VisorSnapshotStartRestoreJob extends SnapshotJob<SnapshotRestoreCommandArg, String> {
        /** Serial version uid. */
        private static final long serialVersionUID = 0L;
     ...
     */
    @Deprecated
    private static class VisorSnapshotRestoreCancelJob extends SnapshotJob<SnapshotRestoreCommandArg, String> {
        /** Serial version uid. */
        private static final long serialVersionUID = 0L;
     ...
     */
    @Deprecated
    private static class VisorSnapshotRestoreStatusJob extends SnapshotJob<SnapshotRestoreCommandArg, String> {
        /** Serial version uid. */
        private static final long serialVersionUID = 0L;
