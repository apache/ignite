...
public abstract class PagesList extends DataStructure {
        ...
        if (metaPageId != 0L) {
            if (initNew)
                ...
                while (nextId != 0) {
                    ...
                    final long page = acquirePage(pageId, GridIoStatManager.NO_OP_STATISTIC_HOLDER);
    ...
    public void saveMetadata() throws IgniteCheckedException {
                    ...
                    while (tailIdx < tails.length) {
                        ...
                        if (written == 0) {
                            if (nextPageId == 0L) {
                                ...
                                curId = nextPageId;
                                curPage = acquirePage(curId, GridIoStatManager.NO_OP_STATISTIC_HOLDER);
        ...
        while (nextPageId != 0L) {
            ...
            long page = acquirePage(pageId, GridIoStatManager.NO_OP_STATISTIC_HOLDER);
            try {
