 ...
 *
 */
public class PagesListRemoveLastPageRecord extends PageDeltaRecord {
    /**
     * @param cacheId Cache ID.
     * @param pageId Page ID.
     */
    public PagesListRemoveLastPageRecord(int cacheId, long pageId) {
    ...
    @Override public void applyDelta(GridCacheContext<?, ?> cctx, ByteBuffer buf) throws IgniteCheckedException {
        ...
        long pageId = io.takeAnyPage(buf);
    ...
    @Override public RecordType type() {
        return RecordType.PAGES_LIST_REMOVE_LAST_PAGE;
    }
}
