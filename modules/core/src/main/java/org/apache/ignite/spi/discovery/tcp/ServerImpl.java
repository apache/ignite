...
import org.apache.ignite.internal.managers.discovery.KernalContextAwareDiscoverySpiCustomMessage;
        ...
        private void processCustomMessage(TcpDiscoveryCustomEventMessage msg) {
            if (isLocalNodeCoordinator()) {
                ...
                if (!msg.verified()) {
                    ...
                    if (msgObj != null) {
                        if (msgObj instanceof KernalContextAwareDiscoverySpiCustomMessage)
                            ((KernalContextAwareDiscoverySpiCustomMessage) msgObj)
