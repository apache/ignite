 ...
 */
public interface HadoopJobInfoEx extends HadoopJobInfo {
    /**
     * Creates new job instance for the given ID.
     * {@link HadoopJobInfoEx} is reusable for multiple jobs while {@link HadoopJobEx} is for one job execution.
