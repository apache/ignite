 ...
 */
public class MvccPartitionUpdateCounter implements PartitionUpdateCounter {
    /** */
     ...
     * @param log Logger.
     */
    MvccPartitionUpdateCounter(IgniteLogger log) {
        this.log = log;
    }
    ...
    @Override public long maxUpdateCounter() {
        return 0;
    }

    @Override public long updateCounterGap() {
        return 0;
    }
