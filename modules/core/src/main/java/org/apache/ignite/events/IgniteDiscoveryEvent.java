...
public class IgniteDiscoveryEvent extends GridEventAdapter {
     ...
     */
    public IgniteDiscoveryEvent(ClusterNode node, String msg, int type, ClusterNode evtNode) {
        super(node, msg, type);
    ...
    @Override public String toString() {
        return S.toString(IgniteDiscoveryEvent.class, this,
