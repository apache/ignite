...
public class PartitionDestroyRequest {
     ...
     */
    public PartitionDestroyRequest(int grpId, int partId) {
        this.grpId = grpId;
        this.partId = partId;
    }
    ...
    @Override public boolean equals(Object o) {
        ...
        PartitionDestroyRequest req = (PartitionDestroyRequest)o;

        return partId == req.partId && grpId == req.grpId;
    }
}
