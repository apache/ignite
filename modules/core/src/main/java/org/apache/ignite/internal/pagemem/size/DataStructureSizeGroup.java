...
public class DataStructureSizeGroup implements DataStructureSizeContext<String, DataStructureSizePartition> {
    ...
    public DataStructureSizeGroup(DataStructureSizeContext parent, String name, int pageSize) {
