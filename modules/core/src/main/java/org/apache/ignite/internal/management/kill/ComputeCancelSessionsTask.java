...
public class ComputeCancelSessionsTask extends VisorOneNodeTask<ComputeCancelSessionsTaskArg, Void> {
    /** */
    private static final long serialVersionUID = 0L;

    /** {@inheritDoc} */
    @Override protected VisorComputeCancelSessionsJob job(ComputeCancelSessionsTaskArg arg) {
     ...
     */
    private static class VisorComputeCancelSessionsJob extends VisorJob<ComputeCancelSessionsTaskArg, Void> {
        /** */
        private static final long serialVersionUID = 0L;
         ...
         */
        private VisorComputeCancelSessionsJob(ComputeCancelSessionsTaskArg arg, boolean debug) {
            super(arg, debug);
        }

        /** {@inheritDoc} */
        @Override protected Void run(ComputeCancelSessionsTaskArg arg) {
