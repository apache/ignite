...
public class ClusterCachesInfo {
    ...
    private void registerReceivedCacheGroups(CacheNodeCommonDiscoveryData cachesData,
        ...
        registerClusterCacheGroupRecoveryData(cachesData.clusterCacheGroupRecoveryData());
    }
    ...
    /** */
    public void registerClusterCacheGroupRecoveryData(ClusterCacheGroupRecoveryData data) {
