...
public class ClusterCachesInfo {
    ...
    private void registerReceivedCaches(CacheNodeCommonDiscoveryData cachesData) {
        ...
        for (CacheData cacheData : cachesData.caches().values()) {
            ...
            Collection<QueryEntity> locQueryEntities = getLocalQueryEntities(cfg.getName());

            QuerySchemaPatch schemaPatch = desc.makeSchemaPatch(locQueryEntities);
            ...
            else if (!GridFunc.eqNotOrdered(desc.schema().entities(), locQueryEntities))
