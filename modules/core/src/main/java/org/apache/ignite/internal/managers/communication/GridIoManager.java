...
public class GridIoManager extends GridManagerAdapter<CommunicationSpi<Object>> {
    ...
    private void onChannelOpened0(UUID rmtNodeId, GridIoMessage initMsg, Channel channel) {
        ...
        try {
            ...
            MessageWire.fromWireNio(initMsg, ctx);

            pools.poolForPolicy(plc).execute(new Runnable() {
                @Override public void run() {
                    try {
                        MessageWire.fromWire(initMsg, ctx);
    ...
    private void onMessage0(UUID nodeId, GridIoMessage msg, IgniteRunnable msgC) {
        ...
        try {
            ...
            MessageWire.fromWireNio(msg, ctx);
    ...
    private void unmarshalPayload(GridIoMessage msg) {
        ...
        try {
            MessageWire.fromWire(msg.message(), ctx);
        }
        catch (IgniteCheckedException e) {
    ...
    private void marshal(GridIoMessage ioMsg) throws IgniteCheckedException {
        ...
        MessageWire.toWire(ioMsg, ctx, null);
