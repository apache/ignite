 ...
 */
public class GridIoManager extends GridManagerAdapter<CommunicationSpi<Message>> {
    ...
    private CommunicationListenerEx<Message> commLsnr;
    ...
    @Override public void start() throws IgniteCheckedException {
        ...
        CommunicationSpi<Message> spi = getSpi();
        ...
        getSpi().setListener(commLsnr = new CommunicationListenerEx<Message>() {
