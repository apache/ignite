 ...
 * cache entries based on {@link #onEntryAccessed(boolean, org.apache.ignite.cache.GridCacheEntry)} notifications and
 * whenever an element needs to be evicted, {@link org.apache.ignite.cache.GridCacheEntry#evict()}
 * method should be called. If you need to access the underlying cache directly
 * from this policy, you can get it via {@link org.apache.ignite.cache.GridCacheEntry#projection()} method.
 * <p>
 * GridGain comes with following eviction policies out-of-the-box:
 * <ul>
 * <li>{@link org.apache.ignite.cache.eviction.lru.GridCacheLruEvictionPolicy}</li>
 * <li>{@link org.apache.ignite.cache.eviction.random.GridCacheRandomEvictionPolicy}</li>
 * <li>{@link org.apache.ignite.cache.eviction.fifo.GridCacheFifoEvictionPolicy}</li>
 * </ul>
 * <p>
