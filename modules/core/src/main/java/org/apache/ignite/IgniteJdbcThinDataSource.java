...
public class IgniteJdbcThinDataSource implements DataSource, Serializable {
     ...
     */
    @Nullable public Boolean getDataPageScan() {
        return props.getDataPageScan();
    }
     ...
     */
    public void setDataPageScan(@Nullable Boolean dataPageScan) {
        props.setDataPageScan(dataPageScan);
    }
}