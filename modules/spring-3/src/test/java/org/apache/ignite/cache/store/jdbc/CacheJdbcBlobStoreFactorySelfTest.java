...
public class CacheJdbcBlobStoreFactorySelfTest extends GridCommonAbstractTest {
    ...
    public void testXmlConfiguration() throws Exception {
        try (Ignite ignite = Ignition.start("modules/spring-3/src/test/config/store-cache.xml")) {
            try(Ignite ignite1 = Ignition.start("modules/spring-3/src/test/config/store-cache1.xml")) {
    ...
    public void testIncorrectBeanConfiguration() throws Exception {
        GridTestUtils.assertThrows(log, new Callable<Object>() {
            @Override public Object call() throws Exception {
                try(Ignite ignite = Ignition.start("modules/spring-3/src/test/config/incorrect-store-cache.xml")) {
