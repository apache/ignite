Apache Ignite Compressor Module
--------------------------
...
To enable Compressor module when starting a standalone node, move 'optional/ignite-compressor' folder to
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <dependencies>
        ...
        <dependency>
            ...
            <artifactId>ignite-compressor</artifactId>
