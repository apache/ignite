 ...
 * Statement test
 */
public class JdbcThinStatementFullApiSelfTest extends GridCommonAbstractTest {
    /** IP finder. */
    ...
    public void testMaxFieldSize() throws Exception {
        ...
        checkNotSupported(new JdbcThinStatementSelfTest.RunnableX() {
     ...
     */
    private void checkNotSupported(final JdbcThinStatementSelfTest.RunnableX r) {
        GridTestUtils.assertThrows(log,
            new Callable<Object>() {
                @Override public Object call() throws Exception {
                    r.run();
