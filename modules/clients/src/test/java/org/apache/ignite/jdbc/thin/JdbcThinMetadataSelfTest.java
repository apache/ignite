    ...
    public void testGetAllColumns() throws Exception {
        try (Connection conn = DriverManager.getConnection(URL)) {
            ...
            expectedCols = new HashSet<>(Arrays.asList(
                ...
                "SYS.SQL_QUERY.QUERY_ID.null.2147483647",
                "SYS.SQL_QUERY.SQL.null.2147483647",
                "SYS.SQL_QUERY.SCHEMA_NAME.null.2147483647",
                "SYS.SQL_QUERY.LOCAL.null.1",
                "SYS.SQL_QUERY.START_TIME.null.26.6",
                "SYS.SQL_QUERY.DURATION.null.19",
                "SYS.SQL_QUERY.ORIGIN_NODE_ID.null.2147483647",
