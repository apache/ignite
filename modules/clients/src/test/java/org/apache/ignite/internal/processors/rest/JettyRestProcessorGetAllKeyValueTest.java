...
/** */
public class JettyRestProcessorGetAllKeyValueTest extends JettyRestProcessorCommonSelfTest {
    /** {@inheritDoc} */
    @Override protected void beforeTestsStarted() throws Exception {
        System.setProperty(IGNITE_REST_GETALL_KEY_VALUE, "true");
    ...
    @Override protected void afterTestsStopped() throws Exception {
        ...
        System.clearProperty(IGNITE_REST_GETALL_KEY_VALUE);
    }
