...
import static org.apache.ignite.internal.processors.odbc.ClientListenerProcessor.CLIENT_CONNECTOR_TCP_METRIC_REGISTRY_NAME;
...
public class NodeSslConnectionMetricTest extends GridCommonAbstractTest {
    ...
    public void testSslDisabled() throws Exception {
        ...
        MetricRegistry cliConnReg = mreg(srv, CLIENT_CONNECTOR_TCP_METRIC_REGISTRY_NAME);
    ...
    public void testJdbc() throws Exception {
        MetricRegistry reg = mreg(startClusterNode(0), CLIENT_CONNECTOR_TCP_METRIC_REGISTRY_NAME);
