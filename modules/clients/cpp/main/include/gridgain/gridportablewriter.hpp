...
public:
    ...
    virtual void writeBoolArray(bool* val, int32_t size) = 0;
    ...
    virtual void writeByteArray(int8_t* val, int32_t size) = 0;
    ...
    virtual void writeInt16Array(int16_t* val, int32_t size) = 0;
    ...
    virtual void writeInt32Array(int32_t* val, int32_t size) = 0;
    ...
    virtual void writeInt64Array(int64_t* val, int32_t size) = 0;
    ...
    virtual void writeFloatArray(float* val, int32_t size) = 0;
    ...
    virtual void writeDoubleArray(double* val, int32_t size) = 0;
