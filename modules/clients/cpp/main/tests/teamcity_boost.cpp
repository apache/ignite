...
#define BOOST_TEST_MODULE Suites //should be defined only once per project! Don't include to other tests
...
public:
    ...
    void log_entry_context(std::ostream&, boost::unit_test::const_string) {}
