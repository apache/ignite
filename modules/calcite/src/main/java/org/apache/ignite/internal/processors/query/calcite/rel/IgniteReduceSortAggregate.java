 ...
 *
 */
public class IgniteReduceSortAggregate extends SingleRel implements IgniteRel {
    /** */
    ...
    /** */
    public IgniteReduceSortAggregate(RelOptCluster cluster, RelTraitSet traits, RelNode input, ImmutableBitSet groupSet, List<ImmutableBitSet> groupSets, List<AggregateCall> aggCalls, RelDataType rowType) {
    ...
    @Override public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
        return new IgniteReduceSortAggregate(getCluster(), traitSet, sole(inputs), groupSet, groupSets, aggCalls, rowType);
    }
    ...
    @Override public IgniteRel clone(RelOptCluster cluster, List<IgniteRel> inputs) {
        return new IgniteReduceSortAggregate(cluster, getTraitSet(), sole(inputs),
