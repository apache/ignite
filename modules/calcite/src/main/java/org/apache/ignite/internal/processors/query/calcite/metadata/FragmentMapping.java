...
public class FragmentMapping implements MarshalableMessage {
    ...
    private List<ColocationGroup> collocationGroups;
    ...
    /** */
    private FragmentMapping(ColocationGroup collocationGroup) {
        this(F.asList(collocationGroup));
    }

    /** */
    private FragmentMapping(List<ColocationGroup> collocationGroups) {
    ...
    public FragmentMapping colocate(FragmentMapping other) throws ColocationMappingException {
        ...
        ColocationGroup first = F.first(collocationGroups);
        ColocationGroup second = F.first(other.collocationGroups);
    ...
    public FragmentMapping finalize(Supplier<List<UUID>> nodesSource) {
        ...
        List<ColocationGroup> collocationGroups = this.collocationGroups;

        collocationGroups = Commons.transform(collocationGroups, ColocationGroup::finalaze);
    ...
    public @NotNull ColocationGroup findGroup(long sourceId) {
        List<ColocationGroup> groups = collocationGroups.stream()
