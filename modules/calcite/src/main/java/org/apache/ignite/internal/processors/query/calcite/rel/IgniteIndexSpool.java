...
public class IgniteIndexSpool extends Spool implements IgniteRel {
    ...
    public IgniteIndexSpool(RelInput input) {
        super(
            ...
            changeTraits(input, IgniteConvention.INSTANCE).getEnum("readType", Spool.Type.class),
            changeTraits(input, IgniteConvention.INSTANCE).getEnum("writeType", Spool.Type.class)
        );
    }
    ...
    public IgniteIndexSpool(
        ...
        super(cluster, traits, input, readType, Type.LAZY);
    }
    ...
    @Override protected Spool copy(RelTraitSet traitSet, RelNode input, Type readType, Type writeType) {
        return new IgniteIndexSpool(getCluster(), traitSet, input, readType);
    }
}
