...
public class CalciteSchemaHolder implements SchemaChangeListener {
    ...
    @Override public synchronized void onSqlTypeCreate(String schemaName, GridQueryTypeDescriptor typeDescriptor, GridCacheContextInfo cacheInfo) {
        ...
        schema.createTable(cacheInfo.name(), typeDescriptor.tableName(), type, collation);
    }
    ...
    @Override public synchronized void onIndexCreate(String schemaName, String tblName, String idxName, String indexViewSql, GridQueryIndexDescriptor idxDesc) {
        IgniteSchema schema = schemas.get(schemaName);
        assert schema != null;
    ...
    @Override public synchronized void onIndexDrop() {
        // TODO: CODE: implement.
    }
