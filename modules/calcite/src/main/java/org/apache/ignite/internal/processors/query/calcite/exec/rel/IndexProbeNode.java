...
public class IndexProbeNode<Row> extends AbstractNode<Row> implements Downstream<Row> {
    /** */
    ...
    /** Ctor. */
    public IndexProbeNode(InlineIndex idx, ExecutionContext<Row> ctx, IndexQueryContext qryCtx) {
