 ...
 *
 */
public class IgniteReduceAggregateSort extends IgniteReduceAggregateBase {
    /** Collation. */
    private final RelCollation collation;

    /** */
    public IgniteReduceAggregateSort(
    ...
    /** */
    public IgniteReduceAggregateSort(RelInput input) {
        super(input);
    ...
    @Override public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
        return new IgniteReduceAggregateSort(
            getCluster(),
            traitSet,
            sole(inputs),
            groupSet,
