...
public class AccumulatorsFactory<Row> implements Supplier<List<AccumulatorWrapper<Row>>> {
    ...
    public AccumulatorsFactory(
        ...
        Map<AggregateCall, Comparator<Row>> callCompMap,
        ...
        prototypes = Commons.transform(aggCalls, (call) -> new WrapperPrototype(call, callCompMap.get(call)));
    }
    ...
    private final class WrapperPrototype implements Supplier<AccumulatorWrapper<Row>> {
        ...
        /** */
        private WrapperPrototype(AggregateCall call, Comparator<Row> comp) {
            this.call = call;
            this.comp = comp;
        }
