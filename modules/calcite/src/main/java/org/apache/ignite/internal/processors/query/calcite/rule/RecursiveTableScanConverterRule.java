...
/** Converts a scan of the recursive transient table to a query-local delta scan. */
public class RecursiveTableScanConverterRule extends AbstractIgniteConverterRule<LogicalTableScan> {
    /** Instance. */
    public static final RelOptRule INSTANCE = new RecursiveTableScanConverterRule();
