...
public class DbgTest extends GridCommonAbstractTest {
    /** */
    ...
    /** */
    @Test
    public void dbg() throws InterruptedException {
        ...
        assertQuery("select reverse('NAME') from person").returns(4L).check();
    }
