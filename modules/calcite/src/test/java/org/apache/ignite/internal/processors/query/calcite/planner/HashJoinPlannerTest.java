...
public class HashJoinPlannerTest extends AbstractPlannerTest {
    ...
    public void testHashJoinApplied() throws Exception {
        ...
        List<List<Object>> testParams = F.asList(
            ...
            F.asList("select t1.c1 from t1 %s join t2 ON t1.id is not distinct from t2.c1", false, false),
            ...
            F.asList("select t1.c1 from t1 %s join t2 ON t1.id is not distinct from t2.c1 and t1.c1 > t2.id", false, true),
