...
// TODO: revert the path
@RunWith(ScriptTestRunner.class)
@ScriptRunnerTestsEnvironment(scriptsRoot = "modules/calcite/src/test/sql/subquery", timeout = 180000)
public class SubsAndCorrsScriptTestSuite {
}
