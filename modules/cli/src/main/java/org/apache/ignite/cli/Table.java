...
public class Table {
     ...
     * Creates a new table.
     *
     * @param indent Left-side indentation (i.e. the provided number of spaces will be added to every line in the output).
     ...
     * Adds a row.
     *
     * @param items List of items in the row. Every item is converted to a string and styled based on the provided {@link ColorScheme}. If
