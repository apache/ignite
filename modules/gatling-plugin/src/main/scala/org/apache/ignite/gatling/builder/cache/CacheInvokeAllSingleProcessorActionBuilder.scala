...
case class CacheInvokeAllSingleProcessorActionBuilderBase[K, V, T](cacheName: Expression[String],
...
case class CacheInvokeAllActionBuilderProcessorStep[K, V, T](requestName: Expression[String],
...
case class CacheInvokeAllSingleProcessorActionBuilder[K, V, T](requestName: Expression[String],
                                                               cacheName: Expression[String],
                                                               keys: Expression[Set[K]],
                                                               entryProcessor: CacheEntryProcessor[K, V, T],
                                                               arguments: Seq[Expression[Any]],
                                                               checks: Seq[IgniteCheck[K, EntryProcessorResult[T]]] = Seq.empty) extends IgniteActionBuilder {

  def check(newChecks: IgniteCheck[K, EntryProcessorResult[T]]*): CacheInvokeAllSingleProcessorActionBuilder[K, V, T] = this.copy(checks = newChecks)
...
case class CacheInvokeAllActionBuilderBase[K, V, T](cacheName: Expression[String],
...
case class CacheInvokeAllActionBuilder[K, V, T](requestName: Expression[String],
                                                cacheName: Expression[String],
                                                map: Expression[Map[K, CacheEntryProcessor[K, V, T]]],
                                                arguments: Seq[Expression[Any]],
                                                checks: Seq[IgniteCheck[K, EntryProcessorResult[T]]] = Seq.empty) extends IgniteActionBuilder {
