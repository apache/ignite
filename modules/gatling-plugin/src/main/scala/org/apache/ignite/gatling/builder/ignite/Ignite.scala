...
case class Ignite(requestName: Expression[String]) extends TransactionSupport {
  ...
  implicit def createCacheActionBuilderSimpleConfigStep2CreateCacheActionBuilder[K, V]
  (step: CreateCacheActionBuilderSimpleConfigStep): CreateCacheActionBuilder[K, V] =
