...
object VisorAlertCommand {
    addHelp(
        ...
        args = Seq(
            ...
            "<condition>" -> Seq(
                "Comparison part of the mnemonic predicate:",
                "   eq - Equal '=' to '<num>' number.",
                "   neq - Not equal '!=' to '<num>' number.",
                "   gt - Greater than '>' to '<num>' number.",
                "   gte - Greater than or equal '>=' to '<num>' number.",
                "   lt - Less than '<' to 'NN' number.",
                "   lte - Less than or equal '<=' to '<num>' number."
            )
        ),
        examples = Seq(
            "alert" ->
