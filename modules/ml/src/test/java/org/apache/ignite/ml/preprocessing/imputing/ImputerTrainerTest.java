...
public class ImputerTrainerTest {
    ...
    public void testFit() {
        ...
        data.put(1, Vector.of(1, 2, Double.NaN));
        data.put(2, Vector.of(1, Double.NaN, 22));
        data.put(3, Vector.of(Double.NaN, 10, 100));
        data.put(4, Vector.of(0, 2, 100));
        ...
        assertArrayEquals(new double[] {1, 0, 100}, preprocessor.apply(5, Vector.of(Double.NaN, 0, Double.NaN)).asArray(), 1e-8);
    }
}
