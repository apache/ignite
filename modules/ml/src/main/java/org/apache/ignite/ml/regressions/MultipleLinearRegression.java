 ...
 *  y=X*b+u
 * </pre>
 * where {@code y} is an {@code n-vector} <b>regressand</b>, {@code X} is a {@code [n,k]} matrix whose {@code k}
 * columns are called <b>regressors</b>, {@code b} is {@code k-vector} of <b>regression parameters</b> and {@code u}
 * is an {@code n-vector} of <b>error terms</b> or <b>residuals</b>.
 * <p>
