 ...
 */
public class NewStackedDatasetTrainer<IS, IA, O, AM extends Model<IA, O>, L>
     ...
     */
    public NewStackedDatasetTrainer(DatasetTrainer<AM, L> aggregatorTrainer,
     ...
     * Constructs instance of this class.
     */
    public NewStackedDatasetTrainer() {
     ...
     * @return This object.
     */
    public NewStackedDatasetTrainer<IS, IA, O, AM, L> withOriginalFeaturesKept(
        IgniteFunction<IS, IA> submodelInput2AggregatingInputConverter) {
        this.submodelInput2AggregatingInputConverter = submodelInput2AggregatingInputConverter;
     ...
     * @return This object.
     */
    public NewStackedDatasetTrainer<IS, IA, O, AM, L> withSubmodelOutput2VectorConverter(
        IgniteFunction<IA, Vector> submodelOutput2VectorConverter) {
        this.submodelOutput2VectorConverter = submodelOutput2VectorConverter;
     ...
     * @return This object.
     */
    public NewStackedDatasetTrainer<IS, IA, O, AM, L> withVector2SubmodelInputConverter(
        IgniteFunction<Vector, IS> vector2SubmodelInputConverter) {
        this.vector2SubmodelInputConverter = vector2SubmodelInputConverter;
     ...
     * @return This object.
     */
    public NewStackedDatasetTrainer<IS, IA, O, AM, L> withAggregatorTrainer(DatasetTrainer<AM, L> aggregatorTrainer) {
        this.aggregatorTrainer = aggregatorTrainer;
     ...
     * @return This object.
     */
    public NewStackedDatasetTrainer<IS, IA, O, AM, L> withAggregatorInputMerger(IgniteBinaryOperator<IA> merger) {
    ...
    public <M1 extends Model<IS, IA>> NewStackedDatasetTrainer<IS, IA, O, AM, L> addTrainer(
    ...
    /** {@inheritDoc} */
    @Override public NewStackedDatasetTrainer<IS, IA, O, AM, L> withEnvironmentBuilder(
