...
/** Some commonly used functions for calculations of regions of space which correspond to decision tree leaf ndoes. */
public class RegionCalculators {
    ...
    /** Variance of region. */
    public static final IgniteFunction<DoubleStream, Double> VARIANCE =
        s -> {
            PrimitiveIterator.OfDouble itr = s.iterator();
            int i = 0;
