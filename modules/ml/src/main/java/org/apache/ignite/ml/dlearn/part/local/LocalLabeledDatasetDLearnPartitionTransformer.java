...
package org.apache.ignite.ml.dlearn.part.local;
...
public class LocalLabeledDatasetDLearnPartitionTransformer<V, L>
    ...
    /** */
    public LocalLabeledDatasetDLearnPartitionTransformer(IgniteFunction<V, double[]> extractor,
        IgniteFunction<V, L> lbExtractor) {
        super(extractor);
