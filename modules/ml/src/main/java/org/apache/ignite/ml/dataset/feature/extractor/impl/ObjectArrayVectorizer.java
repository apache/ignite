 ...
 * @param <K> Key type.
 */
public final class ObjectArrayVectorizer<K> extends ExtractionUtils.ArrayLikeObjectLabelVectorizer<K, Object[]>
    ...
    /** {@inheritDoc} */
    @Override protected Serializable feature(Integer coord, K key, Object[] value) {
        return (Serializable)value[coord];
    }

    /** {@inheritDoc} */
    @Override protected int sizeOf(K key, Object[] value) {
        return value.length;
    }
