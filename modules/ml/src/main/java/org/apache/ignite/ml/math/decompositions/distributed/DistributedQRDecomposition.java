...
package org.apache.ignite.ml.math.decompositions.distributed;
...
public class DistributedQRDecomposition implements Destroyable {
     ...
     */
    public DistributedQRDecomposition(Matrix mtx) {
        this(mtx, 0.0);
    }
     ...
     */
    public DistributedQRDecomposition(Matrix mtx, double threshold) {
        assert mtx != null;
