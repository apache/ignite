 ...
 */
public class RandomForestRegressionTrainerOld extends RandomForestTrainerOld {
    /**
     * Constructs new instance of RandomForestRegressionTrainerOld.
     *
     ...
     */
    public RandomForestRegressionTrainerOld(PredictionsAggregator predictionsAggregator,
     ...
     * @param minImpurityDecrease Min impurity decrease.
     */
    public RandomForestRegressionTrainerOld(int featureVectorSize,
        int maximumFeaturesCntPerMdl,
        int ensembleSize,
        double samplePartSizePerMdl,
        int maxDeep,
     ...
     */
    public RandomForestRegressionTrainerOld withUseIndex(boolean useIndex) {
