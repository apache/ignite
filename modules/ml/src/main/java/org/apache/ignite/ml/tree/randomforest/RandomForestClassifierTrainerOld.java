 ...
 */
public class RandomForestClassifierTrainerOld extends RandomForestTrainerOld {
    /**
     * Constructs new instance of RandomForestClassifierTrainerOld.
     *
     ...
     */
    public RandomForestClassifierTrainerOld(PredictionsAggregator predictionsAggregator,
     ...
     * @param minImpurityDecrease Min impurity decrease.
     */
    public RandomForestClassifierTrainerOld(int featureVectorSize,
        int maximumFeaturesCntPerMdl,
        int ensembleSize,
        double samplePartSizePerMdl,
     ...
     */
    public RandomForestClassifierTrainerOld withUseIndex(boolean useIndex) {
