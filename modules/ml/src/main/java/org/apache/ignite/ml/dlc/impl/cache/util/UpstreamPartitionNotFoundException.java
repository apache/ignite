 ...
 * consistency.
 */
public class UpstreamPartitionNotFoundException extends IgniteException implements Serializable {
    /** */
     ...
     */
    public UpstreamPartitionNotFoundException(String cacheName, UUID nodeId, int partIdx) {
