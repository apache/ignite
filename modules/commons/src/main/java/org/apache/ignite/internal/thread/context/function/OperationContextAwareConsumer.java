...
/** */
public class OperationContextAwareConsumer<T> extends OperationContextAwareWrapper<Consumer<T>> implements Consumer<T> {
    /** */
    public OperationContextAwareConsumer(Consumer<T> delegate, OperationContextSnapshot snapshot) {
