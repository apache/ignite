...
public abstract class OperationContextAwareExecutorService<E extends ExecutorService> implements ExecutorService {
    ...
    @Override public <T> Future<T> submit(Callable<T> task) {
        return delegate.submit(OperationContextAwareCallable.wrapIfContextNotEmpty(task));
    }

    /** {@inheritDoc} */
    @Override public <T> Future<T> submit(Runnable task, T result) {
        return delegate.submit(OperationContextAwareRunnable.wrapIfContextNotEmpty(task), result);
    }

    /** {@inheritDoc} */
    @Override public Future<?> submit(Runnable task) {
        return delegate.submit(OperationContextAwareRunnable.wrapIfContextNotEmpty(task));
    }

    /** {@inheritDoc} */
    @Override public <T> List<Future<T>> invokeAll(Collection<? extends Callable<T>> tasks) throws InterruptedException {
        return delegate.invokeAll(OperationContextAwareCallable.wrapIfContextNotEmpty(tasks));
    }
    ...
    @Override public <T> List<Future<T>> invokeAll(
        ...
        return delegate.invokeAll(OperationContextAwareCallable.wrapIfContextNotEmpty(tasks), timeout, unit);
    }

    /** {@inheritDoc} */
    @Override public <T> T invokeAny(Collection<? extends Callable<T>> tasks) throws InterruptedException, ExecutionException {
        return delegate.invokeAny(OperationContextAwareCallable.wrapIfContextNotEmpty(tasks));
    }
    ...
    @Override public <T> T invokeAny(
        ...
        return delegate.invokeAny(OperationContextAwareCallable.wrapIfContextNotEmpty(tasks), timeout, unit);
    }

    /** {@inheritDoc} */
    @Override public void execute(Runnable command) {
        delegate.execute(OperationContextAwareRunnable.wrapIfContextNotEmpty(command));
    }
}
