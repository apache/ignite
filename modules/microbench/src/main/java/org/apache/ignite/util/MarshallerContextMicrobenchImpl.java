 ...
 */
public class MarshallerContextMicrobenchImpl extends MarshallerContextAdapter {
    /** */
    private final static ConcurrentMap<Integer, String> map = new ConcurrentHashMap8<Integer, String>();
     ...
     */
    public MarshallerContextMicrobenchImpl(List<PluginProvider> plugins) {
        super(plugins);
    }
     ...
     * Initializes context.
     */
    public MarshallerContextMicrobenchImpl() {
        super(null);
    }
