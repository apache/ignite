 ...
 *
 */
public class IgniteAwareApplicationUtil {
    /** Logger. */
    private static final Logger log = LogManager.getLogger(IgniteAwareApplicationUtil.class.getName());

    /**
     * @param args Args.
     */
    public static void main(String[] args) throws Exception {
        log.info("Starting Application Util... [params=" + args[0] + "]");
