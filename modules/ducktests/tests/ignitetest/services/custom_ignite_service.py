...
class MultiNodeService(IgniteAwareService):
    """
    Ignite node service.
    """
    ...
    def __init__(self, context, config, java_class_name, num_nodes, params="", timeout_sec=60, modules=None,
                 servicejava_class_name=APP_SERVICE_CLASS, jvm_opts=None):
        super().__init__(context, config, num_nodes, modules=modules, servicejava_class_name=servicejava_class_name,
                         java_class_name=java_class_name, params=params, jvm_opts=jvm_opts)
