...
class BaseIgniteService(IgniteAwareService):
    """
    Ignite node service.
    """
    APP_SERVICE_CLASS = "org.apache.ignite.internal.ducktest.utils.IgniteAwareApplicationService"

    # pylint: disable=R0913
    def __init__(self, context, config, java_class_name, num_nodes, params="", timeout_sec=60, modules=None,
                 servicejava_class_name=APP_SERVICE_CLASS, jvm_opts=None, start_ignite=True):
    ...
    def stop_async(self, clean_shutdown=True):
        ...
        self.nodes[0].account.kill_java_processes(self.java_class_name, clean_shutdown=clean_shutdown,
                                                  allow_fail=True)
