...
IGNITE_SERVICE_ALIAS = 'server'
IGNITE_APPLICATION_SERVICE_ALIAS = 'client'
CONTROL_UTILITY_ALIAS = 'admin'

default_credentials = {
    IGNITE_SERVICE_ALIAS: (DEFAULT_AUTH_USERNAME, DEFAULT_AUTH_PASSWORD),
    IGNITE_APPLICATION_SERVICE_ALIAS: (DEFAULT_AUTH_USERNAME, DEFAULT_AUTH_PASSWORD),
    CONTROL_UTILITY_ALIAS: (DEFAULT_AUTH_USERNAME, DEFAULT_AUTH_PASSWORD)
}
