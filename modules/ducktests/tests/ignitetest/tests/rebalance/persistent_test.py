...
from ignitetest.tests.rebalance.util import NUM_NODES, TriggerEvent, \
    get_result, check_type_of_rebalancing, await_rebalance_start, start_ignite, RebalanceParams
...
class RebalancePersistentTest(IgniteTest):
    ...
    def node_join_historical_test(self, ignite_version, backups, cache_count, entry_count, entry_size, preloaders,
        ...
        loader.load_data(ignites, from_key=0, to_key=min(10_000, data_load_params.entry_count))
