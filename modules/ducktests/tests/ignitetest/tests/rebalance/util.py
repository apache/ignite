...
from ignitetest.utils.data_loader.data_loader import DataLoader
...
def start_ignite(test_context, ignite_version: str, rebalance_params: RebalanceParams,
                 loader: DataLoader) -> IgniteService:
    """
    Start IgniteService:
    ...
    """
    node_count = len(test_context.cluster) - loader.data_load_params.preloaders
    if rebalance_params.trigger_event == TriggerEvent.NODE_JOIN:
    ...
    ignites = loader.start_ignite(node_config, node_count, rebalance_params.jvm_opts)
