...
class DiscoveryTest(IgniteTest):
    ...
    def test_tcp(self, ignite_version, kill_coordinator, nodes_to_kill, with_load):
        ...
        return self.__simulate_nodes_failure(ignite_version, self.__properties(), kill_coordinator, nodes_to_kill,
                                             with_load)
    ...
    def __simulate_nodes_failure(self, version, properties, kill_coordinator=False, nodes_to_kill=1, with_load=False):
        ...
        if with_load:
            self.__start_loading(version, properties, random.randint(1, 5))
    ...
    def __start_loading(self, ignite_version, properties, wait_sec=0):
