...
class CheckJVMSettings:
    ...
    def check_deduplication(self):
        """
        Checks priority of JVM settings.
        """
        ...
        jvm_settings = merge_jvm_settings(jvm_settings, additionals="-XX:ParallelGCThreads=1024M")

        assert "-XX:ParallelGCThreads=1024M" in jvm_settings
