...
public class JmhSequenceBenchmark extends JmhAbstractBenchmark {
    ...
    private static final String PROP_PERCENTAGE = "ignite.jmh.sequence.percentage";
     ...
     * @throws Exception If failed.
     */
    private static void run(boolean client, int dataNodes, int batchSize, int percentage) throws Exception {
