...
def scan(
    client: Client, cache: Union[str, int], page_size: int,
...
def scan_cursor_get_page(
    client: Client, cursor: int, query_id=None,
) -> APIResult:
    """
...
def sql(
    client: Client, cache: Union[str, int],
...
def sql_fields_cursor_get_page(
    client: Client, cursor: int, field_count: int, query_id=None,
) -> APIResult:
    """
...
def resource_close(client: Client, cursor: int, query_id=None) -> APIResult:
    """
