...
def cache_get_configuration(
    client: Client, cache: Union[str, int], flags: int=0, query_id=None,
) -> APIResult:
    """
...
def cache_create(client: Client, name: str, query_id=None, ) -> APIResult:
    """
...
def cache_get_or_create(client: Client, name: str, query_id=None, ) -> APIResult:
    """
...
def cache_destroy(
    client: Client, cache: Union[str, int], query_id=None,
) -> APIResult:
    """
...
def cache_get_names(client: Client, query_id=None) -> APIResult:
    """
...
def cache_create_with_config(
    client: Client, cache_props: dict, query_id=None,
) -> APIResult:
    """
