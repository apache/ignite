...
PROP_IS_ONHEAPCACHE_ENABLED = 101

PROP_QUERY_ENTITIES = 200
PROP_QUERY_PARALLELISM = 201
PROP_QUERY_DETAIL_METRICS_SIZE = 202
PROP_SQL_SCHEMA = 203
...
# read-only cache config property codes (can not be set, but only retrieved)
PROP_INVALIDATE = -1
PROP_IS_ONHEAP_CACHE_ENABLED = -2
PROP_QUERY_DETAIL_METRIC_SIZE = -3
