...
namespace Apache.Ignite.Core.Transactions
{
    ...
    public class TransactionOptimisticException : IgniteException
    {
        ...
        public TransactionOptimisticException(string message, string javaStackTrace) : base(message, javaStackTrace)
        {
            // No-op.
        }
        ...
        /// <param name="javaStackTrace">The Java stack trace.</param>
        /// <param name="cause">The cause.</param>
        public TransactionOptimisticException(string message, string javaStackTrace, Exception cause) 
