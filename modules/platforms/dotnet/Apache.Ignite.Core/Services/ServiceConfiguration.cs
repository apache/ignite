...
namespace Apache.Ignite.Core.Services
{
    ...
    public class ServiceConfiguration 
    {
        ...
        internal ServiceConfiguration(IBinaryRawReader r)
        {
            ...
            {
                // ignored, could be generated by Service itself (if it fails its own binary deserialization) 
            }
            ...
            {
                // ignored, could be generated by Node filter itself (if it fails its own binary deserialization) 
            }
        }
    }
}