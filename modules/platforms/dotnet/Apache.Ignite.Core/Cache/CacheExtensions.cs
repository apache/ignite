...
namespace Apache.Ignite.Core.Cache
{
    ...
    public static class CacheExtensions
    {
        ...
        /// </returns> 
        /// <exception cref="CacheEntryProcessorException">If an exception has occured during processing.</exception> 
        public static Task<IDictionary<TK, ICacheEntryProcessorResult<TR>>> InvokeAllAsync<TK, TV, TR, TA>(
            this ICache<TK, TV> cache, IEnumerable<TK> keys, Func<IMutableCacheEntry<TK, TV>, TA, TR> processor, TA arg)
        {
            AC.NotNull(cache, "cache");
            AC.NotNull(processor, "processor");

            return cache.InvokeAllAsync(keys, new CacheEntryDelegateProcessor<TK, TV, TA, TR>(processor), arg);
        }
        ...
        /// <returns>Result of the processing.</returns> 
        /// <exception cref="CacheEntryProcessorException">If an exception has occured during processing.</exception> 
        public static Task<TR> InvokeAsync<TK, TV, TR, TA>(this ICache<TK, TV> cache, TK key, 
            Func<IMutableCacheEntry<TK, TV>, TA, TR> processor, TA arg)
        {
            AC.NotNull(cache, "cache");
            AC.NotNull(processor, "processor");

            return cache.InvokeAsync(key, new CacheEntryDelegateProcessor<TK, TV, TA, TR>(processor), arg);
        }
        ...
        /// Optional user arguments to be passed into <see cref="ICacheStore.LoadCache" />. 
        /// </param> 
        public static Task LocalLoadCacheAsync<TK, TV>(this ICache<TK, TV> cache, Func<ICacheEntry<TK, TV>, bool> filter, 
            params object[] args)
        {
            AC.NotNull(cache, "cache");
            ...
            return cache.LocalLoadCacheAsync(filter0, args);
        }
        ...
        /// Optional user arguments to be passed into <see cref="ICacheStore.LoadCache" />. 
        /// </param> 
        public static Task LoadCacheAsync<TK, TV>(this ICache<TK, TV> cache, Func<ICacheEntry<TK, TV>, bool> filter, 
            params object[] args)
        {
            AC.NotNull(cache, "cache");
            ...
            return cache.LoadCacheAsync(filter0, args);
        }
