...
namespace Apache.Ignite.Examples.Datagrid
{
    ...
    /// Apache.Ignite.exe -IgniteHome="%IGNITE_HOME%" -springConfigUrl=modules\platforms\dotnet\examples\config\example-cache.xml -assembly=[path_to_Apache.Ignite.ExamplesDll.dll]
    /// 2) Start example.
    /// </summary>
    public class DataStreamerExample
    {
        ...
        public static void Main()
        {
            ...
            {
                SpringConfigUrl = @"modules\platforms\dotnet\examples\config\example-cache.xml",
