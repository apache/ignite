...
namespace Apache.Ignite.Examples.Compute
{
    ...
    /// Apache.Ignite.exe -IgniteHome="%IGNITE_HOME%" -springConfigUrl=modules\platforms\dotnet\examples\config\example-compute.xml -assembly=[path_to_Apache.Ignite.ExamplesDll.dll]
    /// 2) Start example.
    /// </summary>
