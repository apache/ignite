    ...
    public class BinaryReaderWriterTest
    {
        ...
        private class ReadWriteAll : IBinarizable
        {
            ...
            public void WriteBinary(IBinaryWriter writer)
            {
                ...
                // writer.WriteEnumArray("EnumArray", new[] {MyEnum.Foo});
                writer.WriteObject("Test", new MyClass(MyEnum.Foo, 1));
                ...
                // raw.WriteEnumArray(new[] {MyEnum.Foo});
                raw.WriteObject(new MyClass(MyEnum.Foo, 1));
            }
            ...
            public void ReadBinary(IBinaryReader reader)
            {
                ...
                // Assert.AreEqual(new[] {MyEnum.Foo}, reader.ReadEnumArray<MyEnum>("EnumArray"));
                Assert.AreEqual(new MyClass(MyEnum.Foo, 1), reader.ReadObject<MyClass>("Test"));
                ...
                // Assert.AreEqual(new[] { MyEnum.Foo }, raw.ReadEnumArray<MyEnum>());
                Assert.AreEqual(new MyClass(MyEnum.Foo, 1), raw.ReadObject<MyClass>());
            }
        }

        private enum MyEnum
        {
            Bar, Foo, ANother, Unknown
        }
        
        private class MyClass : IEquatable<MyClass>
        {
            public MyClass(Enum enm, int ival)
            {
                Enm = enm;
                IVal = ival;
            }
            ...
            public bool Equals(MyClass other)
            {
                ...
                return Equals(Enm, other.Enm) && IVal == other.IVal;
            }
            ...
            public override int GetHashCode()
            {
                unchecked
                {
                    return ((Enm != null ? Enm.GetHashCode() : 0) * 397) ^ IVal;
                }
            }
        }
    }
