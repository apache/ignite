...
const PROP_TYPES = Object.freeze({
    ...
    [PROP_ATOMICITY_MODE]: internal_1.BinaryUtils.TYPE_CODE.INTEGER,
    [PROP_BACKUPS]: internal_1.BinaryUtils.TYPE_CODE.INTEGER,
    [PROP_WRITE_SYNCHRONIZATION_MODE]: internal_1.BinaryUtils.TYPE_CODE.INTEGER,
    [PROP_COPY_ON_READ]: internal_1.BinaryUtils.TYPE_CODE.BOOLEAN,
    [PROP_READ_FROM_BACKUP]: internal_1.BinaryUtils.TYPE_CODE.BOOLEAN,
    [PROP_DATA_REGION_NAME]: internal_1.BinaryUtils.TYPE_CODE.STRING,
    [PROP_IS_ONHEAP_CACHE_ENABLED]: internal_1.BinaryUtils.TYPE_CODE.BOOLEAN,
    [PROP_QUERY_ENTITY]: new internal_1.ObjectArrayType(new internal_1.ComplexObjectType(new QueryEntity())),
    [PROP_QUERY_PARALLELISM]: internal_1.BinaryUtils.TYPE_CODE.INTEGER,
    [PROP_QUERY_DETAIL_METRICS_SIZE]: internal_1.BinaryUtils.TYPE_CODE.INTEGER,
    [PROP_SQL_SCHEMA]: internal_1.BinaryUtils.TYPE_CODE.STRING,
    [PROP_SQL_INDEX_INLINE_MAX_SIZE]: internal_1.BinaryUtils.TYPE_CODE.INTEGER,
    [PROP_SQL_ESCAPE_ALL]: internal_1.BinaryUtils.TYPE_CODE.BOOLEAN,
    [PROP_MAX_QUERY_ITERATORS]: internal_1.BinaryUtils.TYPE_CODE.INTEGER,
    [PROP_REBALANCE_MODE]: internal_1.BinaryUtils.TYPE_CODE.INTEGER,
    [PROP_REBALANCE_DELAY]: internal_1.BinaryUtils.TYPE_CODE.LONG,
    [PROP_REBALANCE_TIMEOUT]: internal_1.BinaryUtils.TYPE_CODE.LONG,
    [PROP_REBALANCE_BATCH_SIZE]: internal_1.BinaryUtils.TYPE_CODE.INTEGER,
    [PROP_REBALANCE_BATCHES_PREFETCH_COUNT]: internal_1.BinaryUtils.TYPE_CODE.LONG,
    [PROP_REBALANCE_ORDER]: internal_1.BinaryUtils.TYPE_CODE.INTEGER,
    [PROP_REBALANCE_THROTTLE]: internal_1.BinaryUtils.TYPE_CODE.LONG,
    [PROP_GROUP_NAME]: internal_1.BinaryUtils.TYPE_CODE.STRING,
    [PROP_CACHE_KEY_CONFIGURATION]: new internal_1.ObjectArrayType(new internal_1.ComplexObjectType(new CacheKeyConfiguration())),
    [PROP_DEFAULT_LOCK_TIMEOUT]: internal_1.BinaryUtils.TYPE_CODE.LONG,
    [PROP_MAX_CONCURRENT_ASYNC_OPS]: internal_1.BinaryUtils.TYPE_CODE.INTEGER,
