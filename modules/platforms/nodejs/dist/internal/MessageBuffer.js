...
class MessageBuffer {
    ...
    writeByte(value) {
        this.writeNumber(value, internal_1.BinaryUtils.TYPE_CODE.BYTE);
    }
    writeShort(value) {
        this.writeNumber(value, internal_1.BinaryUtils.TYPE_CODE.SHORT);
    }
    writeInteger(value) {
        this.writeNumber(value, internal_1.BinaryUtils.TYPE_CODE.INTEGER);
    }
    writeLong(value) {
        try {
            ...
            throw internal_1.Errors.IgniteClientError.valueCastError(value, internal_1.BinaryUtils.TYPE_CODE.LONG);
        }
        const buffer = Buffer.from(value.toBytesLE());
        this.writeBuffer(buffer);
    }
    writeFloat(value) {
        this.writeNumber(value, internal_1.BinaryUtils.TYPE_CODE.FLOAT);
    }
    writeDouble(value) {
        this.writeNumber(value, internal_1.BinaryUtils.TYPE_CODE.DOUBLE);
    }
    writeNumber(value, type, signed = true) {
        const size = internal_1.BinaryUtils.getSize(type);
        ...
        try {
            ...
            throw internal_1.Errors.IgniteClientError.valueCastError(value, type);
        }
        this._position += size;
    }
    writeBoolean(value) {
    ...
    writeString(value) {
        const buffer = Buffer.from(value, internal_1.BinaryUtils.ENCODING);
    ...
    readByte() {
        return this.readNumber(internal_1.BinaryUtils.TYPE_CODE.BYTE);
    }
    readShort() {
        return this.readNumber(internal_1.BinaryUtils.TYPE_CODE.SHORT);
    }
    readInteger() {
        return this.readNumber(internal_1.BinaryUtils.TYPE_CODE.INTEGER);
    }
    readLong() {
    ...
    readFloat() {
        return this.readNumber(internal_1.BinaryUtils.TYPE_CODE.FLOAT);
    }
    readDouble() {
        return this.readNumber(internal_1.BinaryUtils.TYPE_CODE.DOUBLE);
    }
    ...
    readString() {
        ...
        const result = this._buffer.toString(internal_1.BinaryUtils.ENCODING, this._position, this._position + bytesCount);
    ...
    _ensureSize(size) {
        if (this._position + size > this._length) {
            throw internal_1.Errors.IgniteClientError.internalError('Unexpected format of response');
        }
    }
