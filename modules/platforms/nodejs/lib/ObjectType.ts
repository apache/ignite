...
import { ArgumentChecker, BinaryUtils, Errors } from './internal';
...
export class ObjectType {
    ...
    public get typeCode(): any { return this._typeCode; }

    public static get PRIMITIVE_TYPE() {
        return PRIMITIVE_TYPE;
    }

    public static get COMPOSITE_TYPE() {
...
export class ObjectArrayType extends CompositeType {
    ...
    public get elementType(): any { return this._elementType; }
...
export class ComplexObjectType extends CompositeType {
    ...
    private _objectConstructor: any;
