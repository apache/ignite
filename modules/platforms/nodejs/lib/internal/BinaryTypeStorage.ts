...
import { BinaryUtils, BinaryCommunicator, BinaryType, Errors } from '../internal';

export class BinaryTypeStorage {
    private _communicator: BinaryCommunicator;
    private _types: Map<any, any>;

    private static _complexObjectTypes: Map<any, any>;
