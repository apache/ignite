...
namespace ignite
{
    namespace impl
    {
        namespace binary
        {
            ...
            void BinaryReaderImpl::SkipTopObject()
            {
                ...
                switch (hdr)
                {
                    ...
                    {
                        stream->ReadInt64(); // First part
                        stream->ReadInt64(); // Second part
                    ...
                    case IGNITE_TYPE_ARRAY_INT:
                    {
                        ...
                        stream->Position(stream->Position() + len * 4);
                    ...
                    case IGNITE_TYPE_ARRAY_LONG:
                    {
                        ...
                        stream->Position(stream->Position() + len * 8);
                    ...
                    case IGNITE_TYPE_ARRAY_DECIMAL:
                    {
                        ...
                        for (int32_t i = 0; i < len; ++i) {
                            stream->ReadInt8(); //header
                            stream->ReadInt32(); //scale

                            int32_t objlen = stream->ReadInt32();

                            stream->Position(stream->Position() + objlen);
                        }
                    ...
                    case IGNITE_TYPE_ARRAY_UUID:
                    {
                        ...
                        stream->Position(stream->Position() + len * 17);
                    ...
                    case IGNITE_TYPE_ARRAY_DATE:
                    {
                        ...
                        stream->Position(stream->Position() + len * 9);

                        break;
                    }

                    case IGNITE_TYPE_TIMESTAMP_ARRAY:
                    {
                        int32_t len = stream->ReadInt32();

                        stream->Position(stream->Position() + len * 13);
                    ...
                    {
                        int32_t len = stream->ReadInt32();
                        stream->ReadInt8(); // collection type
                    ...
                    case IGNITE_HDR_FULL:
                    {
                        ...
                        stream->ReadInt32(); // typeId
                        stream->ReadInt32(); // hashCode
