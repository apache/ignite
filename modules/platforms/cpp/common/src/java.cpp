...
namespace ignite
{
    namespace common
    {
        namespace java
        {
            ...
            JniMethod M_PLATFORM_CACHE_WITH_KEEP_BINATY = JniMethod("withKeepBinary", "()Lorg/apache/ignite/internal/processors/platform/cache/PlatformCache;", false);
			...
			JniMethod M_PLATFORM_SERVICES_WITH_SERVER_KEEP_BINATY = JniMethod("withServerKeepBinary", "()Lorg/apache/ignite/internal/processors/platform/services/PlatformServices;", false);
            ...
            void JniMembers::Initialize(JNIEnv* env) {
                ...
                m_PlatformCache_withKeepBinary = FindMethod(env, c_PlatformCache, M_PLATFORM_CACHE_WITH_KEEP_BINATY);
				...
				m_PlatformServices_withServerKeepBinary = FindMethod(env, c_PlatformServices, M_PLATFORM_SERVICES_WITH_SERVER_KEEP_BINATY);
