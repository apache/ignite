...
namespace ignite
{
    namespace jni
    {
        namespace java
        {
            ...
            JniMethod M_PLATFORM_PROCESSOR_PLUGIN_TARGET = JniMethod("pluginTarget", "(Ljava/lang/String;)Lorg/apache/ignite/internal/processors/platform/PlatformTarget;", false);
            ...
            void JniMembers::Initialize(JNIEnv* env) {
                ...
                m_PlatformProcessor_pluginTarget = FindMethod(env, c_PlatformProcessor, M_PLATFORM_PROCESSOR_PLUGIN_TARGET);
            ...
            jobject JniContext::ProcessorPluginTarget(jobject obj, char* name)
            {
                JNIEnv* env = Attach();

                jstring name0 = name != NULL ? env->NewStringUTF(name) : NULL;

                jobject res = env->CallObjectMethod(obj, jvm->GetMembers().m_PlatformProcessor_pluginTarget, name0);
