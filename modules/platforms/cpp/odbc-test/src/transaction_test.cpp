...
BOOST_AUTO_TEST_CASE(TestTransactionConnectionRollbackSeveralOperations1)
{
    Connect("DRIVER={Apache Ignite};address=127.0.0.1:11110;schema=cache");
...
BOOST_AUTO_TEST_CASE(TestTransactionConnectionRollbackSeveralOperations2)
{
    Connect("DRIVER={Apache Ignite};address=127.0.0.1:11110;schema=cache");
...
BOOST_AUTO_TEST_CASE(TestTransactionConnectionRollbackSeveralOperations3)
{
    Connect("DRIVER={Apache Ignite};address=127.0.0.1:11110;schema=cache");
...
BOOST_AUTO_TEST_CASE(TestTransactionConnectionRollbackSeveralOperations4)
{
    Connect("DRIVER={Apache Ignite};address=127.0.0.1:11110;schema=cache");
