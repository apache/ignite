...
namespace
{
    ...
    const int32_t testFetchPageSize = 4321;
...
void CheckConnectionConfig(const Configuration& cfg)
{
    ...
    BOOST_CHECK_EQUAL(cfg.GetFetchPageSize(), testFetchPageSize);
    ...
    constructor << "address=" << testAddress << ';'
                ...
                << "fetch_page_size=" << testFetchPageSize << ';';
...
void CheckDsnConfig(const Configuration& cfg)
{
    ...
    BOOST_CHECK_EQUAL(cfg.GetFetchPageSize(), Configuration::DefaultValue::fetchPageSize);
}
...
BOOST_AUTO_TEST_CASE(CheckTestValuesNotEquealDefault)
{
    ...
    BOOST_CHECK_NE(testFetchPageSize, Configuration::DefaultValue::fetchPageSize);
}
