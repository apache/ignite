...
public class IgniteS3TestSuite extends TestSuite {
    ...
    public static TestSuite suite() {
        ...
        // S3 Encryption tests.
        suite.addTestSuite(MockEncryptionServiceTest.class);
        suite.addTestSuite(AwsKmsEncryptionServiceTest.class);
        suite.addTestSuite(SymmetricKeyEncryptionServiceTest.class);
        suite.addTestSuite(AsymmetricKeyEncryptionServiceTest.class);
        ...
        suite.addTestSuite(TcpDiscoveryS3IpFinderClientSideEncryptionSelfTest.class);
