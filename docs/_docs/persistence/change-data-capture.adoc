...
So when enabled there will be gap between segments: `0000000000000002.bin`, `0000000000000010.bin`, `0000000000000011.bin`, for example.

WARNING: All changes in skipped segments will be lost!

The CDC application fails if found missing segments.

The link:tools/control-script[Control Script] script provides the ability to delete lost segments before a last gap in segments:
