...
| EventsConsumptionTime | Time of WAL segment events processing by a CDC consumer, in nanoseconds.
| EventsConsumptionTimeTotal | Total time of events processing by a CDC consumer, in nanoseconds.
|===
