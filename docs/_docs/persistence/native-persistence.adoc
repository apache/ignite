...
NOTE: For more information on Native Persistence, watch link:https://www.youtube.com/watch?v=6Yg5QW-XFVc&list=PLMc7NR20hA-KF8c_hVICKpzKnWkjzfC2V&index=19[the architectural deep dive] on the internals of the Ignite storage engine.
