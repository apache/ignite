...
====
[discrete]
=== Ignite-Log4j Deprecation
Log4j 1.x had reached end of life and contains critical vulnerabilities. See
link:https://blogs.apache.org/foundation/entry/apache_logging_services_project_announces[the announcement]
