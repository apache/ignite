...
by other SQL operators. Custom SQL function is also a public static method marked by the same `@QuerySqlFunction`
annotation with additional parameters `tableColumnTypes` and optionally `tableColumnNames`.
