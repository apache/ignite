...
class TestObjectField implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return intFld == that.intFld && !(strFld != null ? !strFld.equals(that.strFld) : that.strFld != null);
    }
...
testObj.objVal = new TestObjectField(100, "Some");
...
stmt.setObject(1, new TestObjectField(100, "Some"));
