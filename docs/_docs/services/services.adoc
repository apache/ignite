...
For link:thin-clients/java-thin-client#java_thin_client[Java Thin Client] you can activate Service Awareness.
To do that, enable link:thin-clients/java-thin-client#partition_awareness[Partition Awareness].
...
link:monitoring-metrics/system-views[system views], and in JMX.
