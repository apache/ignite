...
--
+
If any of the mapped Compute Jobs threw a user exception, the entire Compute Task immediately fails and all remaining Compute Jobs are stopped asynchronously.
