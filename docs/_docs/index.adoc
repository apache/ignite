...
* link:https://github.com/apache/ignite-python-thin-client/tree/master/examples[Python^]
* link:https://github.com/apache/ignite-php-thin-client/tree/master/examples[Node.JS^]
* link:https://github.com/apache/ignite-nodejs-thin-client/tree/master/examples[PHP^]
