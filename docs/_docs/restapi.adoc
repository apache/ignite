...
On the server side, JSON text will be converted to link:/docs/data-modeling/data-modeling#binary-object-format[binary object], field types are resolved in the following order:
...
* Otherwise, the fields will be stored according to regular JSON types.
