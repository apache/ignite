...
== Configuring Rebalancing Properties

Rebalancing is configured per ignite cluster configuration.
...
[source,xml]
----
include::{xmlFile}[tags=!*;ignite-config;timeout;order;delay;indent=0]
----
tab:Java[]
[source,java]
----
include::{javaFile}[tags=!*;ignite-config;timeout;order;delay;indent=0;]
----
tab:C#/.NET[]
[source,csharp]
----
include::code-snippets/dotnet/DataRebalancing.cs[tag=RebalanceProperty,indent=0]
----
tab:C++[unsupported]
--
