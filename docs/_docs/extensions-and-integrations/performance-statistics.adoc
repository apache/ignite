...
image:../../assets/images/integrations/performance-statistics/perf_stat_2.png[]
tab:Transactions[]
image:../../assets/images/integrations/performance-statistics/perf_stat_3.png[]
tab:Queries[]
image:../../assets/images/integrations/performance-statistics/perf_stat_4.png[]
tab:Compute[]
image:../../assets/images/integrations/performance-statistics/perf_stat_5.png[]
tab:Cluster info[]
image:../../assets/images/integrations/performance-statistics/perf_stat_1.png[]
--
