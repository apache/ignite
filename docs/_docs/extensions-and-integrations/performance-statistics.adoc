...
image:{perf_stat_url}/perf_stat_2.png[link="{perf_stat_url}/perf_stat_2.png",window=_blank]
tab:Transactions[]
image:{perf_stat_url}/perf_stat_3.png[link="{perf_stat_url}/perf_stat_3.png",window=_blank]
tab:Queries[]
image:{perf_stat_url}/perf_stat_4.png[link="{perf_stat_url}/perf_stat_4.png",window=_blank]
tab:Compute[]
image:{perf_stat_url}/perf_stat_5.png[link="{perf_stat_url}/perf_stat_5.png",window=_blank]
tab:Cluster info[]
image:{perf_stat_url}/perf_stat_1.png[link="{perf_stat_url}/perf_stat_1.png",window=_blank]
--
