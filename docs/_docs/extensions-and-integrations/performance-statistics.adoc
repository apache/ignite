...
image:../../assets/images/integrations/performance-statistics/perf_stat_2.png[link="../../assets/images/integrations/performance-statistics/perf_stat_2.png",window=_blank]
tab:Transactions[]
image:../../assets/images/integrations/performance-statistics/perf_stat_3.png[link="../../assets/images/integrations/performance-statistics/perf_stat_3.png",window=_blank]
tab:Queries[]
image:../../assets/images/integrations/performance-statistics/perf_stat_4.png[link="../../assets/images/integrations/performance-statistics/perf_stat_4.png",window=_blank]
tab:Compute[]
image:../../assets/images/integrations/performance-statistics/perf_stat_5.png[link="../../assets/images/integrations/performance-statistics/perf_stat_5.png",window=_blank]
tab:Cluster info[]
image:../../assets/images/integrations/performance-statistics/perf_stat_1.png[link="../../assets/images/integrations/performance-statistics/perf_stat_1.png",window=_blank]
--
