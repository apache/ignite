...
* **Create** - Creating a full or incremental snapshot                                                                                                                                                                                                        │
* **Restore** - Restoring cache groups from a snapshot                                                                                                                                                                                                        │
* **Check** - Verifying snapshot consistency (can run in parallel for multiple snapshots)                                                                                                                                                                     │
