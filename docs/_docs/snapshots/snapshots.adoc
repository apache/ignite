...
* Concurrent updates from link:../data-streaming.adoc#_limitations[DataStreamer] with default 'allowOverwrite'
setting (false) into a persistent caches can cause that load won't be restorable.
