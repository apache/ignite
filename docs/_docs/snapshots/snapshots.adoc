...
* Concurrent updates from link:../data-streaming.adoc#_limitations[DataStreamer] with default 'allowOverwrite' setting (false) can cause the caches under streaming load won't be restorable.
