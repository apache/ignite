...
[source,shell]
----
# Start restoring all user-created cache groups from the snapshot "snapshot_09062021" in the bacgrkound.
...
# Start restoring only "cache-group1" and "cache-group2" from the snapshot "snapshot_09062021" in the bacgrkound.
