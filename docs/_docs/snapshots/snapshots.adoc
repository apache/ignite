...
control.(sh|bat) --snapshot cancel --id 9ec229f1-e0df-41ff-9434-6f08ba7d05bd

# Kill a running snapshot operation with ID "9ec229f1-e0df-41ff-9434-6f08ba7d05bd":
control.(sh|bat) --kill SNAPSHOT 9ec229f1-e0df-41ff-9434-6f08ba7d05bd
----
...
# Cancel the restore operation with ID "a691f153-bd6f-4c20-9a58-4a21c7194e60".
control.(sh|bat) --snapshot cancel --id a691f153-bd6f-4c20-9a58-4a21c7194e60
----
