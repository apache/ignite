...
== Limitations
Certain behaviour of Ignite Data Streamer is defined by <<receivers>> In general, DataStreamer doesn't guarantee:
[]
...
- Data consistency until finished;
