...
Nodes in this mode do not join the cluster and remain isolated until maintenance task has been completed.
...
More detailed information about this procedure can be found in the "link:data-rebalancing[Data Rebalancing]".
