...
Refer to link:net-specific/net-deployment-options[Deployment] section for more details. ASP.NET/IIS scenarios require additional steps.
...
See link:net-specific/net-standalone-nodes#load-user-assemblies[Standalone Nodes: Loading User Assemblies] for details.
...
link:distributed-computing/distributed-computing[Compute] `ExecuteJavaTask` API.
