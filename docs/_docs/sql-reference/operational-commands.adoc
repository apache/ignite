...
[NOTE]
====
Setting streaming on uses link:../data-streaming.adoc#_limitations[DataStreamer] which doesn't guarantie data consistency until successfully finished by default.
====
