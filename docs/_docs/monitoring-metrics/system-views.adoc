...
| NODE_ID | VARCHAR | Node consistent ID.
| BASELINE_NODE_ID | VARCHAR | Baseline node consistent ID.
| CACHE_GROUP | VARCHAR | Name of cache group.
| LOCAL_PARTITIONS | VARCHAR | Partition numbers of the cache group stored in the snapshot.
