...
The LOCAL_CACHE_GROUPS_IO view contains information about local node IO statistics for cache groups.
...
|CACHE_GROUP_ID|int | The ID of the cache group.
|CACHE_GROUP_NAME | string | The name of the cache group.
