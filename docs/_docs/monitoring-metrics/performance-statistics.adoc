...
You can use the following tools to start and stop statistics collecting:

* link:#jmx[JMX interface]
...
Ignite ships the link:tools/control-script[Control Script] that supports performance statistics commands listed below:
