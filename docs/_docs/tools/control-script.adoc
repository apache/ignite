...
For example, link:SQL/sql-statistics[SQL statistics,window=_blank] use `ON|OFF|NO_UPDATE`, while link:control-script.adoc#managing-cluster-connection-properties[connection properties,window=_blank]
use `true|false`.
