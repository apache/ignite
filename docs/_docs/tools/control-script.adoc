...
[source,shell]
----
control.sh --cache indexes_force_rebuild --node-ids nodeId1,...nodeIdN|--node-id nodeId --cache-names cacheName1,...cacheNameN|--group-names groupName1,...groupNameN
----
tab:Window[]
[source,shell]
----
control.bat --cache indexes_force_rebuild --node-ids nodeId1,...nodeIdN|--node-id nodeId --cache-names cacheName1,...cacheNameN|--group-names groupName1,...groupNameN
----
--
