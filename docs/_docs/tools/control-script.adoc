...
The control utility provides commands to enable events, disable events, check the status of events on all server nodes.

=== Enable/disable events

To eneble or disable events on all server nodes, use the `--event enable/disable` command.
