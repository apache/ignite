...
[source,shell]
----
control.sh --enable-experimental --consistency repair -c cache-name -p partition -s strategy
...
[source,shell]
----
control.bat --enable-experimental --consistency repair -c cache-name -p partition -s strategy
